...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@pdf-lib/fontkit", "./PDFCreator", "pdf-lib"], factory);
    }
})(function (require, exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PDFCreator_pdf_lib = void 0;
    /*
      This module contains a class that provides an interface to the pdf_lib PDF library.
    ...
    */
    ...
    //--------------------------------------------------------------------------------------------------------------------//
    class PDFCreator_pdf_lib extends PDFCreator.PDFCreator {
        constructor() {
        ...
        addPage() {
            super.addPage();
            this.pdfPage = this.pdfDoc.addPage(this.pageOptions.pageType === PDFCreator.EPageType.A4 ? pdfLib.PageSizes.A4 : pdfLib.PageSizes.Letter);
    ...
    exports.PDFCreator_pdf_lib = PDFCreator_pdf_lib;
});
