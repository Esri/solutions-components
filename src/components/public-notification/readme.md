...
| `enableLayerFeaturesOnLoad`  | `enable-layer-features-on-load`  | boolean: When true the use features from a layer options will be enabled when the component loads                                                                                                                                                                                                                                                                                                           | `boolean`                                       | `true`                |
...
| `enableSearchDistanceOnLoad` | `enable-search-distance-on-load` | boolean: When true the serach distance options will be enabled when the component loads                                                                                                                                                                                                                                                                                                                     | `boolean`                                       | `true`                |
