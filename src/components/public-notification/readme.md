...
| `defaultExportTitle`         | `default-export-title`           | string: The default value to use for the export title                                                                                                                                                                                                                                                                                                                                                       | `string`                                        | `""`                  |
| `defaultNumLabelsPerPage`    | `default-num-labels-per-page`    | number: The default number of labels per page to export                                                                                                                                                                                                                                                                                                                                                     | `number`                                        | `6`                   |
| `enableLayerFeatures`        | `enable-layer-features`          | boolean: When true users will be allowed to optionally use features from a layer as the selection geometry                                                                                                                                                                                                                                                                                                  | `boolean`                                       | `true`                |
| `enableLayerFeaturesOnLoad`  | `enable-layer-features-on-load`  | boolean: When true the use features from a layer options will be enabled when the component loads                                                                                                                                                                                                                                                                                                           | `boolean`                                       | `false`               |
| `enableSearchDistance`       | `enable-search-distance`         | boolean: When true users will be allowed to optionally create a buffer around the selection geometry                                                                                                                                                                                                                                                                                                        | `boolean`                                       | `true`                |
| `enableSearchDistanceOnLoad` | `enable-search-distance-on-load` | boolean: When true the serach distance options will be enabled when the component loads                                                                                                                                                                                                                                                                                                                     | `boolean`                                       | `false`               |
