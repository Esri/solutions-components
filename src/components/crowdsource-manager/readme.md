...
| --------------------------- | ------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- | ------------- |
| `appLayout`                 | `app-layout`                    | AppLayout: The type of layout the application should use. Valid values: "mapView" or "tableView" or "splitView"                                                                                                                                                                                    | `"mapView" \| "splitView" \| "tableView"` | `'splitView'` |
