 ...
 */
@Component({
  tag: 'solution-accordion-item',
  styleUrl: 'solution-accordion-item.scss',
  shadow: true,
})
export class SolutionAccordionItem implements ConditionalSlotComponent {
  //--------------------------------------------------------------------------
  //
  //  Element
  //
  ...
  @Element() el: HTMLSolutionAccordionItemElement;
