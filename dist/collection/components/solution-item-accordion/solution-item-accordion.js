...
export class SolutionItemAccordion {
    ...
    static get is() { return "solution-item-accordion"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() {
        return {
            "$": ["solution-item-accordion.css"]
        };
    }
    ...
    static get properties() {
        return {
            "templateInfos": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "ITemplateInfo[]",
                    "resolved": "ITemplateInfo[]",
                    "references": {
                        "ITemplateInfo": {
                            "location": "import",
                            "path": "../../utils/interfaces",
                            "id": "src/utils/interfaces.ts::ITemplateInfo"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "ITemplateInfo[]: Collection of template infos"
                },
                "defaultValue": "[]"
            }
        };
