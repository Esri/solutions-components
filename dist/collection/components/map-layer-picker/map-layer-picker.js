...
export class MapLayerPicker {
    ...
    static get properties() {
        return {
            ...
            "showTablesDisabled": {
                ...
                "docs": {
                    "tags": [],
                    "text": "boolean: when true table will shown as disabled"
                },
                "attribute": "show-tables-disabled",
                "reflect": false
            },
    ...
    static get events() {
        return [{
                ...
                "docs": {
                    "tags": [],
                    "text": "Emitted on demand when valid layers are found"
                },
                "complexType": {
