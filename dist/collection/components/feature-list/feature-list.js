...
export class FeatureList {
    ...
    static get methods() {
        return {
            "refresh": {
                "complexType": {
                    "signature": "(maintainPageState?: boolean) => Promise<void>",
                    "parameters": [{
                            "name": "maintainPageState",
                            "type": "boolean",
                            "docs": "If true feature list page state will be maintained"
                        }],
                    "references": {
                        "Promise": {
                            "location": "global",
                ...
                "docs": {
                    ...
                    "tags": [{
                            "name": "param",
                            "text": "maintainPageState If true feature list page state will be maintained"
                        }, {
                            "name": "returns",
