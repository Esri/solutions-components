...
export class SolutionItemIcon {
  ...
  static get is() { return "solution-item-icon"; }
  static get originalStyleUrls() {
    return {
      "$": ["solution-item-icon.scss"]
    };
  }
  static get styleUrls() {
    return {
      "$": ["solution-item-icon.css"]
    };
  }
  ...
  static get properties() {
    return {
      "isPortal": {
        ...
        "docs": {
          "tags": [],
          "text": "Indicate if this is portal"
        },
        "attribute": "is-portal",
        "reflect": false,
        "defaultValue": "false"
      ...
      "typeKeywords": {
        ...
        "docs": {
          "tags": [],
          "text": "The typeKeywords for the item"
        },
        "defaultValue": "[]"
      }
    };
