    ...
    */
    ...
    static get properties() {
        return {
            ...
            "selectedFeature": {
                ...
                "docs": {
                    "tags": [],
                    "text": "__esri.Graphic: https://developers.arcgis.com/javascript/latest/api-reference/esri-Graphic.html"
                }
            },
            "customizeSubmit": {
                "type": "boolean",
    ...
    static get events() {
        return [{
                ...
                "docs": {
                    "tags": [],
                    "text": "Emitted on demand when the comment is submitted successfully"
                },
                "complexType": {
                    "original": "void",
                    "resolved": "void",
                ...
                "docs": {
                    "tags": [],
                    "text": "Emitted on demand when the comment submission is failed"
                },
                "complexType": {
                    "original": "Error",
                    "resolved": "Error",
                ...
                "docs": {
                    "tags": [],
                    "text": "Emitted on demand when any action is pending or completed"
                },
                "complexType": {
                    "original": "boolean",
                    "resolved": "boolean",
