...
import { 
//EUpdateType,
CSpatialRefCustomizingPrefix } from "../utils/interfaces";
import { getProp, getPropWithDefault } from "@esri/solution-common";
//--------------------------------------------------------------------------
//
//  Public Functions
//
 ...
 */
export function getFeatureServices(templates) {
 ...
 */
export function getModels(templates) {
    const ids = [];
    const models = {};
 ...
 */
export function getSpatialReferenceInfo(services, data) {
