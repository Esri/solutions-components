...
declare module "preact/src/jsx" {
  namespace JSXInternal {
    interface IntrinsicElements {
      ...
      "calcite-chip": Omit<JSX.SolutionsChip, "onCalciteChipClose" | "onCalciteChipSelect" | "onCalciteInternalChipKeyEvent"> & JSXInternal.HTMLAttributes<HTMLSolutionsChipElement> & {
      ...
      "solution-spatial-ref": Omit<JSX.SolutionsSolutionSpatialRef, "onFeatureServiceSpatialReferenceChange" | "onLockedSpatialReferenceChange"> & JSXInternal.HTMLAttributes<HTMLSolutionsSolutionSpatialRefElement> & {
        "onfeatureServiceSpatialReferenceChange"?: (event: CustomEvent<any>) => void;
        "onlockedSpatialReferenceChange"?: (event: CustomEvent<any>) => void;
      }
