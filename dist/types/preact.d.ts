...
declare module "preact/src/jsx" {
  namespace JSXInternal {
    interface IntrinsicElements {
      ...
      "calcite-time-picker": Omit<JSX.SolutionsTimePicker, "onCalciteInternalTimePickerChange"> & JSXInternal.HTMLAttributes<HTMLSolutionsTimePickerElement> & {
      ...
      "card-manager": Omit<JSX.SolutionsCardManager, "onCreateWorkFlowStarted" | "onBackFromCreateWorkFlow" | "onFeatureOrRecordSubmitted"> & JSXInternal.HTMLAttributes<HTMLSolutionsCardManagerElement> & {
        "oncreateWorkFlowStarted"?: (event: CustomEvent<any>) => void;
        "onbackFromCreateWorkFlow"?: (event: CustomEvent<any>) => void;
        "onfeatureOrRecordSubmitted"?: (event: CustomEvent<any>) => void;
      }
      ...
      "delete-dialog": Omit<JSX.SolutionsDeleteDialog, "onEditsComplete" | "onDeleteDialogClose"> & JSXInternal.HTMLAttributes<HTMLSolutionsDeleteDialogElement> & {
        "oneditsComplete"?: (event: CustomEvent<any>) => void;
        "ondeleteDialogClose"?: (event: CustomEvent<any>) => void;
      }
      ...
      "feature-details": Omit<JSX.SolutionsFeatureDetails, "onLoadingStatus" | "onCommentSelect" | "onAddComment" | "onLikeOrDislikeClicked" | "onFeatureSelectionChange"> & JSXInternal.HTMLAttributes<HTMLSolutionsFeatureDetailsElement> & {
        ...
        "onlikeOrDislikeClicked"?: (event: CustomEvent<any>) => void;
