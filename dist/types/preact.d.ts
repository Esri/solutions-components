...
declare module "preact/src/jsx" {
  namespace JSXInternal {
    interface IntrinsicElements {
      ...
      "map-select-tools": Omit<JSX.SolutionsMapSelectTools, "onSelectionLoadingChange" | "onSelectionSetChange" | "onSketchTypeChange" | "onWorkflowTypeChange"> & JSXInternal.HTMLAttributes<HTMLSolutionsMapSelectToolsElement> & {
      ...
      "refine-selection-tools": Omit<JSX.SolutionsRefineSelectionTools, "onSelectionLoadingChange" | "onRefineSelectionGraphicsChange" | "onRefineSelectionIdsChange"> & JSXInternal.HTMLAttributes<HTMLSolutionsRefineSelectionToolsElement> & {
        "onselectionLoadingChange"?: (event: CustomEvent<any>) => void;
