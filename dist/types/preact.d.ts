...
declare module "preact/src/jsx" {
  namespace JSXInternal {
    interface IntrinsicElements {
      ...
      "map-select-tools": Omit<JSX.SolutionsMapSelectTools, "onSelectionLoading" | "onSelectionSetChange" | "onSketchTypeChange" | "onWorkflowTypeChange"> & JSXInternal.HTMLAttributes<HTMLSolutionsMapSelectToolsElement> & {
        "onselectionLoading"?: (event: CustomEvent<any>) => void;
      ...
      "refine-selection-tools": Omit<JSX.SolutionsRefineSelectionTools, "onSelectionLoading" | "onRefineSelectionGraphicsChange" | "onRefineSelectionIdsChange"> & JSXInternal.HTMLAttributes<HTMLSolutionsRefineSelectionToolsElement> & {
        "onselectionLoading"?: (event: CustomEvent<any>) => void;
