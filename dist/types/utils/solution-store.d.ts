...
declare class SolutionStore {
     ...
     * @protected
     */
    protected _getSpatialReferenceInfo(services: any[], defaultWkid: string): ISolutionSpatialReferenceInfo;
    /**
     ...
     * @protected
     */
    protected _updateFSSpatialReferenceInfoInTemplates(featureServices: IFeatureServiceEnabledStatus[], templates: IItemTemplateEdit[]): void;
    /**
