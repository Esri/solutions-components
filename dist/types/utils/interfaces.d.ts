...
export declare enum EImageDisplayType {
    GRID = "GRID",
    GALLERY = "GALLERY"
}
...
export declare enum ESelectionType {
    POINT = "POINT",
    LINE = "LINE",
    POLY = "POLY",
    RECT = "RECT"
}
export declare enum EWorkflowType {
    SEARCH = "SEARCH",
    SELECT = "SELECT",
    SKETCH = "SKETCH",
    REFINE = "REFINE"
...
export declare const CSpatialRefCustomizingPrefix = "{{params.wkid||";
export declare const CSpatialRefCustomizingSuffix = "}}";
export type ValidSize = 6 | 10 | 14 | 20 | 30 | 60 | 80;
export type DistanceUnit = "feet" | "meters" | "miles" | "kilometers";
export type theme = "light" | "dark";
export type TooltipPlacement = "auto" | "top" | "right" | "bottom" | "left" | "top-start" | "top-end" | "right-start" | "right-end" | "bottom-start" | "bottom-end" | "left-start" | "left-end" | "auto-start" | "auto-end" | "leading-start" | "leading" | "leading-end" | "trailing-end" | "trailing" | "trailing-start";
