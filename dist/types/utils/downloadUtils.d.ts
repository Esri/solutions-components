 ...
 */
export declare function consolidateLabels(webmap: __esri.Map, exportInfos: IExportInfos, formatUsingLayerPopup?: boolean, includeHeaderNames?: boolean, isCSVExport?: boolean, fields?: any[], useFieldAliasNames?: boolean): Promise<string[][]>;
/**
 ...
 */
export declare function downloadCSV(webmap: __esri.Map, exportInfos: IExportInfos, formatUsingLayerPopup: boolean, removeDuplicates?: boolean, addColumnTitle?: boolean, fields?: any[], useFieldAliasNames?: boolean): Promise<void>;
/**
 * Downloads csv of mailing labels for the provided list of ids
 *
 * @param webmap Webmap containing layer
 ...
 * @returns Promise resolving when function is done
 */
export declare function _prepareLabels(webmap: __esri.Map, layer: __esri.FeatureLayer, ids: number[], formatUsingLayerPopup?: boolean, includeHeaderNames?: boolean, fields?: any[], useFieldAliasNames?: boolean): Promise<string[][]>;
/**
