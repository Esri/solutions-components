...
export declare class LayerTable {
     ...
     */
    _sortActiveWatchHandler(): Promise<void>;
    /**
     ...
     */
    protected _getAction(active: boolean, icon: string, indicator: boolean, label: string, func: any, disabled: boolean, slot?: string): VNode;
    /**
