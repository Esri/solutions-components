 ...
 */
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, a as getAssetPath } from './p-4e6eb06e.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './p-5e25a0b8.js';
import { s as slotChangeHasAssignedElement, f as focusFirstTabbable, o as getSlotted, t as toAriaBoolean } from './p-621ad249.js';
import { u as updateHostInteraction, I as InteractiveContainer } from './p-d6902512.js';
import { c as connectLocalized, d as disconnectLocalized, g as getSupportedLocale, n as numberStringFormatter, a as getDateTimeFormat, f as getDateFormatSupportedLocale, b as getSupportedNumberingSystem } from './p-895e7b9c.js';
...
import { d as defaultEndMenuPlacement, f as filterValidFlipPlacements, c as connectFloatingUI, a as defaultMenuPlacement, r as reposition, b as disconnectFloatingUI, F as FloatingCSS } from './p-f746ec20.js';
import { d as dateFromISO, g as getDaysDiff, a as dateToISO, b as dateFromRange, s as setEndOfDay, c as datePartsFromISO, e as datePartsFromLocalizedString, f as dateFromLocalizedString, i as inRange } from './p-5d2cd0a4.js';
import { i as isBrowser } from './p-4f82eb55.js';
import { s as submitForm, c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './p-6adaac20.js';
import { n as numberKeys } from './p-233f219c.js';
import { c as connectLabel, d as disconnectLabel } from './p-d25fc2c2.js';
import { c as connectFocusTrap, d as deactivateFocusTrap, a as activateFocusTrap } from './p-4253e9f1.js';
...
const Block = class {
    ...
    render() {
        ...
        const headerContent = (h("header", { key: '439d2866f9c5f13cfd8020812203a6cdf86c964f', class: { [CSS$3.header]: true, [CSS$3.headerHasText]: !!(heading || description) }, id: IDS$1.header }, this.renderIcon("start"), this.renderContentStart(), this.renderLoaderStatusIcon(), this.renderTitle()));
        const hasControl = !!getSlotted(el, SLOTS.control);
        const hasMenuActions = !!getSlotted(el, SLOTS.headerMenuActions);
        const collapseIcon = open ? ICONS.opened : ICONS.closed;
        const headerNode = (h("div", { key: 'a9721a9e145db53a215262190d2f7e46472edec6', class: CSS$3.headerContainer }, this.dragHandle ? h("calcite-handle", { label: heading }) : null, collapsible ? (h("button", { "aria-controls": IDS$1.content, "aria-describedby": IDS$1.header, "aria-expanded": collapsible ? toAriaBoolean(open) : null, class: CSS$3.toggle, id: IDS$1.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent, h("div", { class: CSS$3.iconEndContainer }, this.renderIcon("end"), h("calcite-icon", { class: CSS$3.toggleIcon, icon: collapseIcon, scale: "s" })))) : this.iconEnd ? (h("div", null, headerContent, h("div", { class: CSS$3.iconEndContainer }, this.renderIcon("end")))) : (headerContent), hasControl ? (h("div", { "aria-labelledby": IDS$1.header, class: CSS$3.controlContainer }, h("slot", { name: SLOTS.control }))) : null, hasMenuActions ? (h("calcite-action-menu", { flipPlacements: menuFlipPlacements ?? ["top", "bottom"], label: messages.options, overlayPositioning: this.overlayPositioning, placement: menuPlacement }, h("slot", { name: SLOTS.headerMenuActions }))) : null, this.renderActionsEnd()));
        return (h(Host, { key: 'cdf7c69cc630466cfd4fb0078735f1e685fde512' }, h(InteractiveContainer, { key: 'ae5b2a044fb337bb2c5c12bee2c9ed4b10e5c373', disabled: this.disabled }, h("article", { key: '01c5c5499d62361cfe26d8b6a878034f0805787b', "aria-busy": toAriaBoolean(loading), class: {
            ...
            } }, headerNode, h("section", { key: 'e72271e369055329e4447d15c2deec25599332ec', "aria-labelledby": IDS$1.toggle, class: CSS$3.content, hidden: !open, id: IDS$1.content }, this.renderScrim())))));
    }
...
const InputDatePicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'b31ae837415083aa63451c5f32b78253b1d6af1e', onBlur: this.blurHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: '7315a0e5773a1ef96c00b48b138c8afd50aca28a', disabled: this.disabled }, this.localeData && (h("div", { key: '022f86001938e2994ab523b30a2e3cb379a550b4', class: CSS$2.inputContainer }, h("div", { key: '4a3add7824ea7ec41b75ddd5e9b847afa1ca0708', class: CSS$2.inputWrapper, "data-position": "start", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown, ref: this.setStartWrapper }, h("calcite-input-text", { key: 'd415c8d890333f76793fc5f804111c0a72f4d3c8', "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-describedby": this.placeholderTextId, "aria-errormessage": IDS.validationMessage, "aria-expanded": toAriaBoolean(this.open), "aria-haspopup": "dialog", "aria-invalid": toAriaBoolean(this.status === "invalid"), class: {
                [CSS$2.input]: true,
            ...
            }, ref: this.setTransitionEl }, h("calcite-date-picker", { key: '35aa39e5552eff762bb58368b4cbe1069692ee38', activeDate: this.datePickerActiveDate, activeRange: this.focusedInput, headingLevel: this.headingLevel, max: this.max, maxAsDate: this.maxAsDate, messageOverrides: this.messageOverrides, min: this.min, minAsDate: this.minAsDate, numberingSystem: numberingSystem, onCalciteDatePickerChange: this.handleDateChange, onCalciteDatePickerRangeChange: this.handleDateRangeChange, proximitySelectionDisabled: this.proximitySelectionDisabled, range: this.range, ref: this.setDatePickerRef, scale: this.scale, tabIndex: this.open ? undefined : -1, valueAsDate: this.valueAsDate }))), this.range && this.layout === "horizontal" && (h("div", { key: '386b0a687fc16a4f96ef9cc199aca653ab90071b', class: CSS$2.horizontalArrowContainer }, h("calcite-icon", { key: '65b1d5b9e7b77f524ef40cd1f0efda3776db33e1', flipRtl: true, icon: "arrow-right", scale: getIconScale(this.scale) }))), this.range && this.layout === "vertical" && this.scale !== "s" && (h("div", { key: '50b0b98f4d51c5866557ab5691692a42704d08f2', class: CSS$2.verticalArrowContainer }, h("calcite-icon", { key: '48758a61b800c61109b492d77ca468519ad65227', icon: "arrow-down", scale: getIconScale(this.scale) }))), this.range && (h("div", { key: 'af12058d6a8d299fd988ae4ac7fc0422d05342c6', class: CSS$2.inputWrapper, "data-position": "end", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown, ref: this.setEndWrapper }, h("calcite-input-text", { key: '38c68e0df3d516ea5b840a1a937d1af6d1c971b0', "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-errormessage": IDS.validationMessage, "aria-expanded": toAriaBoolean(this.open), "aria-haspopup": "dialog", "aria-invalid": toAriaBoolean(this.status === "invalid"), class: {
                [CSS$2.input]: true,
...
const InstantAppsSocialShare = class {
    ...
    render() {
        ...
        const dialogContent = (h("div", { key: 'b23e14b1ba2ca6f64137f676aae9f19fde42260d', ref: el => (this.dialogContentRef = el), class: `${CSS.dialog}${layoutClass}${mode}` }, content));
        const defaultOffset = 6;
        const offsetDistance = this.removePopoverOffset ? 0 : defaultOffset;
        return (h(Host, { key: '5143e472b8381d068e6cc6f155b5c65d3aaf4c53' }, this.mode === 'popover'
            ? [
