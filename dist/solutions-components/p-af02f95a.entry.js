 ...
 */
import { r as registerInstance, c as createEvent, h, H as Host, F as Fragment, g as getElement } from './p-6eb37ed2.js';
import { g as getMessages, a as generateUIData, s as store, E as EIcons, b as getLocales, l as languageTranslatorState, c as getUIDataKeys } from './p-6070857c.js';
import { l as loadModules } from './p-4cd4cb85.js';
import { c as getComponentClosestLanguage } from './p-7bfecd07.js';
...
const InstantAppsLanguageTranslator = class {
    ...
    render() {
        return (h(Host, { key: '2c017345058f822812f4f26d7360e40fa8a4cab1' }, this.renderModal(), this.renderPopoverTip()));
    }
    renderModal() {
