 ...
 */
import { r as registerInstance, h as h$7, H as Host, g as getElement, c as createEvent } from './p-c2f00d41.js';
...
import { l as loadModules } from './p-4557725d.js';
...
import { g as getLocaleComponentStrings } from './p-4aaa2132.js';
...
const InputMessage = class {
  ...
  render() {
    ...
    return (h$7(Host, { "calcite-hydrated-hidden": hidden }, this.renderIcon(this.requestedIcon), h$7("slot", null)));
  }
  //--------------------------------------------------------------------------
  //
  //  Private Methods
  ...
  renderIcon(iconName) {
    if (iconName) {
      return h$7("calcite-icon", { class: "calcite-input-message-icon", icon: iconName, scale: "s" });
    }
  }
...
const Notice = class {
  ...
  render() {
    const { el } = this;
    const closeButton = (h$7("button", { "aria-label": this.intlClose, class: CSS.close, onClick: this.close, ref: (el) => (this.closeButton = el) }, h$7("calcite-icon", { icon: "x", scale: this.scale === "l" ? "m" : "s" })));
    const hasActionEnd = getSlotted(el, SLOTS.actionsEnd);
    return (h$7("div", { class: CSS.container }, this.requestedIcon ? (h$7("div", { class: CSS.icon }, h$7("calcite-icon", { icon: this.requestedIcon, scale: this.scale === "l" ? "m" : "s" }))) : null, h$7("div", { class: CSS.content }, h$7("slot", { name: SLOTS.title }), h$7("slot", { name: SLOTS.message }), h$7("slot", { name: SLOTS.link })), hasActionEnd ? (h$7("div", { class: CSS.actionsEnd }, h$7("slot", { name: SLOTS.actionsEnd }))) : null, this.closable ? closeButton : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
const MapSelectTools = class {
  ...
  render() {
    ...
    return (h$7(Host, null, h$7("div", { class: "padding-bottom-1" }, h$7("calcite-radio-group", { class: "w-100", onCalciteRadioGroupChange: (evt) => this._workflowChange(evt) }, h$7("calcite-radio-group-item", { checked: searchEnabled, class: "w-50 end-border", value: EWorkflowType.SEARCH }, this._translations.search), h$7("calcite-radio-group-item", { checked: drawEnabled, class: "w-50", value: EWorkflowType.SKETCH }, this._translations.sketch))), h$7("div", { class: showSearchClass }, h$7("div", { class: "search-widget", ref: (el) => { this._searchElement = el; } })), h$7("div", { class: showLayerChoiceClass }, h$7("calcite-label", { layout: "inline" }, h$7("calcite-checkbox", { onCalciteCheckboxChange: () => this._layerSelectChanged(), ref: (el) => this._selectFromLayerElement = el }), "Use layer features")), h$7("div", { class: useDrawClass }, h$7("map-draw-tools", { active: true, border: true, mapView: this.mapView, ref: (el) => { this._drawTools = el; } })), h$7("div", { class: useSelectClass }, h$7("refine-selection-tools", { active: true, border: true, enabledLayerIds: this.enabledLayerIds, layerViews: this._refineSelectLayers, mapView: this.mapView, mode: ESelectionMode.ADD, ref: (el) => { this._refineTools = el; }, refineMode: ERefineMode.SUBSET })), h$7("calcite-label", { class: showBufferToolsClass }, this._translations.searchDistance, h$7("buffer-tools", { distance: ((_a = this.selectionSet) === null || _a === void 0 ? void 0 : _a.distance) || this.defaultBufferDistance, geometries: this.geometries, onBufferComplete: (evt) => this._bufferComplete(evt), ref: (el) => this._bufferTools = el, unit: ((_b = this.selectionSet) === null || _b === void 0 ? void 0 : _b.unit) || this.defaultBufferUnit })), h$7("slot", null)));
  }
  //--------------------------------------------------------------------------
  //
  //  Functions (protected)
...
* Tue Jan 24 2023 10:01:06 GMT-0800 (Pacific Standard Time)
*/
    ...
    */
    ...
    class PDFCreator_jsPDF extends PDFCreator.PDFCreator {
        ...
        drawLine(options) {
            ...
            console.log("before super", JSON.stringify(this.lineOptions.lineProperties, null, 2)); //???
            super.drawLine(options);
            //PDFCreator.PDFCreator.prototype.drawLine.call(this, options);
            //PDFCreator.PDFCreator.prototype.drawLine(options);
            console.log("after super", JSON.stringify(this.lineOptions.lineProperties, null, 2)); //???
...
const PDFCreator_jsPDF = /*#__PURE__*/Object.freeze({
  __proto__: null
});
...
const RefineSelection = class {
   ...
   */
  render() {
    return (h$7(Host, null, h$7("div", { class: "padding-1" }, h$7("div", null, h$7("calcite-radio-group", { class: "w-100", onCalciteRadioGroupChange: (evt) => this._modeChanged(evt) }, h$7("calcite-radio-group-item", { checked: this._addEnabled, class: "w-50", onClick: () => this._setSelectionMode(ESelectionMode.ADD), value: ESelectionMode.ADD }, this._translations.add), h$7("calcite-radio-group-item", { checked: !this._addEnabled, class: "w-50", onClick: () => this._setSelectionMode(ESelectionMode.REMOVE), value: ESelectionMode.REMOVE }, this._translations.remove)), h$7("refine-selection-tools", { border: true, enabledLayerIds: this.enabledLayerIds, ids: getSelectionIds(this.selectionSets), layerViews: [this.addresseeLayer], mapView: this.mapView, mode: this._addEnabled ? ESelectionMode.ADD : ESelectionMode.REMOVE, ref: (el) => { this._refineTools = el; }, useLayerPicker: false })), h$7("br", null), (h$7("calcite-list", { class: "list-border" }, this._getRefineSelectionSetList())))));
  }
  //--------------------------------------------------------------------------
  //
  //  Functions (protected)
  ...
  _getRefineSelectionSetList() {
    ...
    return [(h$7("calcite-list-item", { label: this._translations.featuresAdded.replace("{{n}}", numAdded.toString()) })), (h$7("calcite-list-item", { label: this._translations.featuresRemoved.replace("{{n}}", numRemoved.toString()) })), (h$7("calcite-list-item", { label: this._translations.totalSelected.replace("{{n}}", total.toString()) }))];
  }
  /**
...
export { Notice as $, A$2 as A, s$4 as B, C$1 as C, i$8 as D, E$1 as E, s$1 as F, p$2 as G, y as H, j$1 as I, D$2 as J, v$1 as K, p$1 as L, z$1 as M, N$1 as N, L as O, I$1 as P, Q$1 as Q, t$1 as R, s$6 as S, F$1 as T, U, J$1 as V, t$5 as W, Bt as X, n as Y, Z, InputMessage as _, s$5 as a, MapSelectTools as a0, PdfDownload as a1, RefineSelection as a2, x$2 as b, b$3 as c, d$4 as d, e$9 as e, r$3 as f, s$b as g, has as h, h$6 as i, j$4 as j, a$5 as k, j$2 as l, a as m, x$1 as n, o$6 as o, b$1 as p, s$8 as q, r$6 as r, s$3 as s, t$7 as t, u$2 as u, e as v, w$1 as w, x$3 as x, y$1 as y, r$2 as z };

//# sourceMappingURL=p-3179d66b.js.map