 ...
 */
import { h, r as registerInstance, c as createEvent, H as Host, g as getElement } from './p-6eb37ed2.js';
import { d as calciteSize48 } from './p-e3196917.js';
import { f as filter, e as escapeRegExp } from './p-3eff6da3.js';
import { D as getElementWidth, E as getTextWidth, t as toAriaBoolean } from './p-68ec5c15.js';
import { d as defaultMenuPlacement, f as filterValidFlipPlacements, c as connectFloatingUI, r as reposition, a as disconnectFloatingUI, F as FloatingCSS } from './p-a5609b81.js';
import { s as submitForm, c as connectForm, a as afterConnectDefaultValueSet, d as disconnectForm, H as HiddenFormInputSlot } from './p-9f63a45c.js';
...
import { b as componentLoaded, c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './p-18f18ab3.js';
...
import { D as DEBOUNCE } from './p-b39c5275.js';
import { c as connectMessages, s as setUpMessages, d as disconnectMessages, u as updateMessages } from './p-1a9a47a0.js';
import { g as getIconScale, c as componentOnReady } from './p-d559f79c.js';
import { V as Validation } from './p-40724bfb.js';
import { i as isSingleLike, h as hasActiveChildren, C as CSS$1, b as ComboboxChildSelector, c as getLabel, d as getItemAncestors, e as getItemChildren, f as ComboboxItem, j as ComboboxItemGroup, I as IDS } from './p-8f0ee4b0.js';
import { d as debounce } from './p-c8d3207e.js';
import { C as CSS$2 } from './p-dc7710b5.js';
import { g as getLocaleComponentStrings } from './p-2058b5d9.js';
import { d as getMapLayerHash, p as getMapTableHash } from './p-eb483242.js';
...
const XButton = ({ disabled, key, label, onClick, ref, scale, }) => (h("button", { "aria-label": label, class: CSS.button, disabled: disabled, key: key, onClick: onClick, ref: ref, tabIndex: -1, type: "button" }, h("calcite-icon", { icon: "x", scale: getIconScale(scale) })));
