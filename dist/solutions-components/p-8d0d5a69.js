...
import { n as numberStringFormatter, g as getSupportedLocale, c as connectLocalized, d as disconnectLocalized } from './p-895e7b9c.js';
import { a as activateFocusTrap, d as deactivateFocusTrap, c as connectFocusTrap } from './p-4253e9f1.js';
import { l as localizeTimeString, t as toISOTimeString, i as isValidTime, f as formatTimeString, a as formatTimePart } from './p-27a4a537.js';
import { u as updateMessages, c as connectMessages, s as setUpMessages, d as disconnectMessages } from './p-efaa77a0.js';
import { d as decimalPlaces } from './p-61aebbb5.js';
import { g as getIconScale } from './p-4a291f79.js';
import { V as Validation } from './p-745efeab.js';
import { f as focusFirstTabbable, t as toAriaBoolean } from './p-621ad249.js';
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
    ["ar", () => import('./p-16f52a67.js')],
    ["bg", () => import('./p-9ff02b5e.js')],
    ["bs", () => import('./p-319f79c2.js')],
    ["ca", () => import('./p-cf4273a0.js')],
    ["cs", () => import('./p-c0c6f4b2.js')],
    ["da", () => import('./p-5f6d9950.js')],
    ["de", () => import('./p-1726f46c.js')],
    ["de-at", () => import('./p-5d8592e0.js')],
    ["de-ch", () => import('./p-347fa724.js')],
    ["el", () => import('./p-daff208e.js')],
    ["en", () => Promise.resolve().then(function () { return en$1; })],
    ["en-au", () => import('./p-b658f264.js')],
    ["en-ca", () => import('./p-017f63c5.js')],
    ["en-gb", () => import('./p-ec56afaa.js')],
    ["es", () => import('./p-3c775d00.js')],
    ["es-mx", () => import('./p-89334c32.js')],
    ["et", () => import('./p-086f8bbb.js')],
    ["fi", () => import('./p-296bd1c0.js')],
    ["fr", () => import('./p-144b7a4d.js')],
    ["fr-ch", () => import('./p-efe845d9.js')],
    ["he", () => import('./p-49fbb67d.js')],
    ["hi", () => import('./p-f76d3cfe.js')],
    ["hr", () => import('./p-713949f2.js')],
    ["hu", () => import('./p-904a670f.js')],
    ["id", () => import('./p-fb4f7ace.js')],
    ["it", () => import('./p-b3e498bd.js')],
    ["it-ch", () => import('./p-866cc732.js')],
    ["ja", () => import('./p-60412359.js')],
    ["ko", () => import('./p-8d48a13f.js')],
    ["lt", () => import('./p-13d2e3cb.js')],
    ["lv", () => import('./p-d4f16e41.js')],
    ["mk", () => import('./p-685091db.js')],
    ["nl", () => import('./p-54a3d9b8.js')],
    ["nb", () => import('./p-da2fd30a.js')],
    ["pl", () => import('./p-7cc351f6.js')],
    ["pt", () => import('./p-b5ddeee9.js')],
    ["pt-br", () => import('./p-a584543f.js')],
    ["ro", () => import('./p-471c6630.js')],
    ["ru", () => import('./p-7fdb374f.js')],
    ["sk", () => import('./p-fdbb52ca.js')],
    ["sl", () => import('./p-dac93fa8.js')],
    ["sr", () => import('./p-9e862c85.js')],
    ["sv", () => import('./p-0374291c.js')],
    ["th", () => import('./p-39678a7e.js')],
    ["tr", () => import('./p-ea822f6e.js')],
    ["uk", () => import('./p-e799935e.js')],
    ["vi", () => import('./p-bf187297.js')],
    ["zh-cn", () => import('./p-5949dd38.js')],
    ["zh-hk", () => import('./p-f62b8031.js')],
    ["zh-tw", () => import('./p-efdd44e3.js')],
]);
