...
import { g as getMessages } from './p-6070857c.js';
import { l as loadModules } from './p-4cd4cb85.js';
import { a as getDefaultLanguage } from './p-7bfecd07.js';
...
const InstantAppsLanguageSwitcher = class {
    ...
    render() {
        ...
        return (h("calcite-dropdown", { key: 'ced0c98bd69889c1c8c655425a495da4a1bf7ab1', onCalciteDropdownBeforeOpen: () => (this.trigger.iconEnd = 'chevron-up'), onCalciteDropdownBeforeClose: () => (this.trigger.iconEnd = 'chevron-down'), "width-scale": "m" }, trigger, defaultLocale, dropdown));
    }
    renderDefaultLocale() {
