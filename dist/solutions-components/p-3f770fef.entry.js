...
import { u as updateHostInteraction, I as InteractiveContainer } from './p-415cf05e.js';
import { a as getDateTimeFormat, c as connectLocalized, d as disconnectLocalized } from './p-939bc1b4.js';
...
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
    if (mode === "name") {
        const { groupByName } = await import('./p-2c423f9c.js');
    ...
    if (mode === "region") {
        const [{ groupByRegion }, { getCountry }] = await Promise.all([
            import('./p-5ee4ba5c.js'),
            import('./p-f69ca69c.js'),
        ]);
    ...
    const [{ groupByOffset }, { DateEngine }] = await Promise.all([
        import('./p-70b46ea4.js'),
        import('./p-fc17754b.js'),
    ]);
