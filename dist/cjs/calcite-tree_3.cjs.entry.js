...
const SolutionItemIcon = class {
     ...
     */
    render() {
        return index.h("div", { key: 'cec4024779fdca31fe170a0aa469094024aa040d', title: this.type }, index.h("img", { key: '6a70335c018a04592e47b58dbd10737a8771fb87', class: "item-type-icon item-type-icon-margin", height: "16", src: this._getIconUrl(this.type, this.typeKeywords), width: "16" }));
    }
    //--------------------------------------------------------------------------
    //
