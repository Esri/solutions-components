...
const BasemapGallery = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '1f8be0f65a784ffaac49b8a5a15ebd6fb72d6643' }, index.h("div", { key: '2c1bde6c0624b476f6c34302ea843da195f535cb', ref: (el) => { this._basemapElement = el; } })));
    }
    /**
...
const FloorFilter = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '7890927db517fe8e1133fce3e0fe977a441f2abf' }, index.h("div", { key: '34ad695eb04dd20a0b9893817a33df5020de7da1', ref: (el) => { this._floorFilterElement = el; } })));
    }
    /**
...
const MapFullscreen = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '350ebb01c52631c9441b6554f5b8e26f8ca1418e' }, index.h("div", { key: 'b09344b721da2cc18b74fb21f8017446ba5baa03', class: "fullscreen-widget", ref: (el) => { this._fullscreenElement = el; } })));
    }
    /**
...
const MapLegend = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '2c5cfbfd4048347ace5ff3cf17d411e85454be7a' }, index.h("div", { key: '3927ef8af3a4a93fbd558480a96f982ca5b477a2', ref: (el) => { this._legendElement = el; } })));
    }
    /**
     * StencilJS: Called once just after the component is fully loaded and the first render() occurs.
     */
...
const MapPicker = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '84cc43e195045e28fe01e35fe2f6f06cbe28fefd' }, this._getToolbar(), this._getMapNameList(this._mapListExpanded)));
    }
    /**
...
const MapSearch = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '482d8d891f8c6905eefee8b26f0837a4c7c2e525' }, index.h("div", { key: '9a3993ab8a7506299cf2bdbfab23b47ac7fe3037', class: "search-widget", ref: (el) => { this._searchElement = el; } })));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
...
const MapTools = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '224b99c53e7f8ac9c072efbd2c2093c6c9684a9a' }, index.h("div", { key: 'ead56063c6aa28146d4c50044b6e7c98fd2ed1ab', class: containerClass }, this.enableSingleExpand ? (index.h("div", { class: "box-shadow" }, this._getActionGroup(toggleIcon, false, expandTip, () => this._toggleTools()))) : undefined, index.h("div", { key: '3fd7a2bd6225c10b89e282d4521486ad7eb5802a', class: `${toolMarginClass} ${shadowClass} ${toolsClass}` }, this._getMapWidgets(toolOrder))), index.h("basemap-gallery", { key: '43063099ee4b3a72d96b2ae6e4ca750dff109ae2', basemapConfig: this.basemapConfig, class: basemapClass, mapView: this.mapView, ref: (el) => { this._basemapElement = el; } }), index.h("map-search", { key: '5c149ea67f2a2450864e968a50acce565d95e0b6', class: searchClass, mapView: this.mapView, ref: (el) => { this._searchElement = el; }, resultGraphicEnabled: true, searchConfiguration: this.searchConfiguration }), index.h("map-legend", { key: 'd3add3a5f820c5d654fec793d3e6e46b6a8919a3', class: legendClass, mapView: this.mapView, ref: (el) => { this._legendElement = el; } }), index.h("map-fullscreen", { key: 'e18a3a5d021d76e7c8fa9ecf3903105d5a43bed2', class: fullscreenClass, mapView: this.mapView, onFullscreenStateChange: (evt) => this._fullscreenStateChange(evt.detail), ref: (el) => { this._fullscreenElement = el; } }), index.h("floor-filter", { key: 'cb5d92e503248818e9627ba4ee8d70c81495599d', class: floorFilterClass, enabled: this.enableFloorFilter, mapView: this.mapView, ref: (el) => { this._floorFilterElement = el; } })));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
