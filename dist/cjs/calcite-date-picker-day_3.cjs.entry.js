...
const DatePickerMonth = class {
     ...
     * @param key
     */
    renderDateDay({ active, currentMonth, date: date$1, day, dayInWeek, ref }, key) {
        const isFocusedOnStart = this.isFocusedOnStart();
        const isHoverInRange = this.isHoverInRange() ||
            (!this.endDate && this.hoverRange && date.sameDate(this.hoverRange?.end, this.startDate));
