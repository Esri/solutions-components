...
const DatePickerMonth = class {
     ...
     * @param active.ref
     */
    renderDateDay({ active, currentMonth, date: date$1, day, dayInWeek, ref }) {
        var _a;
        ...
        return (index.h("div", { class: "day", key: date$1.toDateString(), role: "gridcell" }, index.h("calcite-date-picker-day", { active: active, class: {
                "hover--inside-range": this.startDate && isHoverInRange,
                "hover--outside-range": this.startDate && !isHoverInRange,
                "focused--start": isFocusedOnStart,
                "focused--end": !isFocusedOnStart,
            }, currentMonth: currentMonth, dateTimeFormat: this.dateTimeFormat, day: day, disabled: !date.inRange(date$1, this.min, this.max), endOfRange: this.isEndOfRange(date$1), highlighted: this.betweenSelectedRange(date$1), onCalciteDaySelect: this.daySelect, onCalciteInternalDayHover: this.dayHover, range: !!this.startDate && !!this.endDate && !date.sameDate(this.startDate, this.endDate), rangeEdge: dayInWeek === 0 ? "start" : dayInWeek === 6 ? "end" : undefined, rangeHover: this.isRangeHover(date$1), scale: this.scale, selected: this.isSelected(date$1), startOfRange: this.isStartOfRange(date$1), value: date$1,
...
const DatePickerMonthHeader = class {
    ...
    formatCalendarYear(year) {
        return locale.numberStringFormatter.localize(`${date.formatCalendarYear(year, this.localeData)}`);
    }
    parseCalendarYear(year) {
        return locale.numberStringFormatter.localize(`${date.parseCalendarYear(Number(locale.numberStringFormatter.delocalize(year)), this.localeData)}`);
    }
