...
const downloadUtils = require('./downloadUtils-e6e2f8c4.js');
...
const MapSelectTools = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c7606df019ee2db799fc4aeaef1c01222db71bac' }, this._getMapLayerPicker(), index.h("div", { key: 'ceb755c17dc275ee210092ecf314f320f02db15d', class: "border-bottom" }), index.h("div", { key: '796f8a3ee14624651ce1aa79ba90ec102a0c7665', class: "padding-top-sides-1" }, index.h("div", { key: '3c1241f2716f1b35f33a48117ea7f048988cdc86', class: "search-widget", ref: (el) => { this._searchElement = el; } }), index.h("div", { key: '45e381d6047836af0f7b1ee27b2d8aba47d0ae08', class: mapToolsContainerClass }, index.h("map-draw-tools", { key: '6a0abe2d63967396f1d4d1aabc26707df994fc9a', active: true, class: mapToolsClass, editGraphicsEnabled: !this._useLayerFeaturesEnabled, graphics: this._graphics, mapView: this.mapView, onSketchGraphicsChange: (evt) => void this._sketchGraphicsChanged(evt), pointSymbol: this.sketchPointSymbol, polygonSymbol: this.sketchPolygonSymbol, polylineSymbol: this.sketchLineSymbol, ref: (el) => { this._drawTools = el; } })), this.enableSearchDistance ? this._getBufferOptions() : undefined, this.enableLayerFeatures ? this._getUseLayerFeaturesOptions() : undefined, this._getNumSelected()), index.h("div", { key: '1570dfce246c2faf09fbe31fb6b55f44eb370d3c', class: "border-bottom" }), this._getNameInput()));
    }
    /**
...
const PdfDownload = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: 'a419c7cae9b09d545b027c3e2f0a30c40c7882b7' }, index.h("calcite-select", { key: '2da2a45b186f8338950d2bfa9b517248318bb7be', disabled: this.disabled, label: "", ref: (el) => { this._labelInfoElement = el; } })));
    }
    componentDidLoad() {
     ...
     */
    async _initModules() {
        const [intl] = await locale.loadModules([
            "esri/intl"
        ]);
        this._intl = intl;
    }
...
const RefineSelection = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '891f59d0930d1104e43135416cef20d7ee4092db' }, index.h("div", { key: '838032e366d6a4ea89151797ea7894188105f690', class: layerPickerClass + " padding-top-sides-1" }, index.h("div", { key: '0d65c8a0161f12945f4ea9b845bb7a06504fa7c2', class: "display-flex" }, index.h("calcite-label", { key: 'eb05f217b0d8ad29c87c99263013be83be6cf173', class: "font-bold width-full label-margin-0" }, index.h("div", { key: '762206308778b186839f245c826f07bf9c7a397c', class: "display-flex" }, this._translations.inputLayer, index.h("calcite-icon", { key: '21addd4ed3117be18efda73e1546feb172532722', class: "padding-start-1-2 icon", flipRtl: !(this.locale?.toLowerCase() === "he"), icon: "question", id: "refine-input-layer", scale: "s" })), index.h("map-layer-picker", { key: '75243a29bab56fd2026fcdebf8b94481c02e88a2', enabledLayerIds: this._enabledLayerIds, mapView: this.mapView, onLayerSelectionChange: (evt) => { void this._layerSelectionChange(evt); }, ref: (el) => { this._layerPicker = el; }, selectedIds: [this._refineLayer.layer.id], showTables: false })), index.h("calcite-popover", { key: 'a813219e87e96129431d0c0763e6098a0df804b4', closable: true, label: "", referenceElement: "refine-input-layer" }, index.h("span", { key: '21c4273d5e6b28138ab21508597d61d9ec0425a1', class: "tooltip-message" }, this._translations.inputLayerTip)))), index.h("div", { key: '896e292c0107f68aec5d15930a933a4279996a99', class: "padding-1" }, index.h("div", { key: 'adfc6e908486ae6ab5c79a5a4050dcba7af7fb9a', class: "padding-bottom-1" }, index.h("calcite-segmented-control", { key: '6d312353c67adf26da3a2cb84b1770241e91150a', class: "w-100", width: "full" }, index.h("calcite-segmented-control-item", { key: '2c718bfefcc53fa5d81667c929b5447e5da3dc07', checked: this._addEnabled, class: "w-50 word-wrap-anywhere", onClick: () => this._setSelectionMode(interfaces.ESelectionMode.ADD), value: interfaces.ESelectionMode.ADD }, index.h("span", { key: '84a6579324cb06258ee7fdaf976c6b6260d7592a', class: "font-weight-500" }, this._translations.add)), index.h("calcite-segmented-control-item", { key: '0d87e796ee942a53784e937b8d9ebf56992ee39e', checked: !this._addEnabled, class: "w-50 word-wrap-anywhere", onClick: () => this._setSelectionMode(interfaces.ESelectionMode.REMOVE), value: interfaces.ESelectionMode.REMOVE }, index.h("span", { key: '8e57009f82a04cc48fd13ec8361d26c14a3fd5db', class: "font-weight-500" }, this._translations.remove)))), index.h("div", { key: '71af92470bd7053644cd13bd7178a3dc8f10632a' }, index.h("map-draw-tools", { key: 'ce331d40f5647c1f411c71640324fd33fd7579c6', active: true, drawMode: interfaces.EDrawMode.REFINE, mapView: this.mapView, onDrawRedo: () => this._redo(), onDrawUndo: () => this._undo(), onSketchGraphicsChange: (evt) => this._sketchGraphicsChanged(evt), pointSymbol: this.sketchPointSymbol, polygonSymbol: this.sketchPolygonSymbol, polylineSymbol: this.sketchLineSymbol, redoEnabled: this._refineSelectionSet?.redoStack.length > 0, ref: (el) => { this._drawTools = el; }, undoEnabled: this._refineSelectionSet?.undoStack.length > 0 })), index.h("br", { key: '6abfaf8746acc94db02289de8a67fc7d6d1a0ccd' }), (index.h("calcite-list", { key: 'c154a70d6523e0fc6582539b9a4c8b8f2a3791ae', class: "list-border" }, this._getRefineSelectionSetList())))));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
    ...
    async _selectFeatures(geom) {
        ...
        const response = await mapViewUtils.queryFeaturesByGeometry(0, this._refineLayer?.layer, geom, this._featuresCollection);
