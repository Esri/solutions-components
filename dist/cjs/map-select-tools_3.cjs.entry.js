...
const PdfDownload = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: 'a2a528f3bb24b8ea11bac5e4e7bfcc87ba81a794' }, index.h("calcite-select", { key: '65188bbe9f8c18e5fde98a2f2dd96961a2354d61', disabled: this.disabled, label: "", ref: (el) => { this._labelInfoElement = el; } })));
    }
    componentDidLoad() {
...
const RefineSelection = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6ca10ddfe06214aa74a308661290a08147587e5b' }, index.h("div", { key: 'ecad97854aadc69766dd182c385ba2f5a7447121', class: layerPickerClass + " padding-top-sides-1" }, index.h("div", { key: 'b68331dcf8ae4a36fbd57494e2b9f8daf92906ed', class: "display-flex" }, index.h("calcite-label", { key: '31c0fea32fd5fb0c380ab1e561a7f4d9057e06f6', class: "font-bold width-full label-margin-0" }, index.h("div", { key: 'f3e92e9d216e5ff4c14490e2b0278b88807b9762', class: "display-flex" }, this._translations.inputLayer, index.h("calcite-icon", { key: 'b1a75c06d01eeb7840be6eeb303f403ebd924454', class: "padding-start-1-2 icon", flipRtl: !(this.locale?.toLowerCase() === "he"), icon: "question", id: "refine-input-layer", scale: "s" })), index.h("map-layer-picker", { key: '27f7e489caf763d87cf4ccf6200f471cb3ae8363', enabledLayerIds: this._enabledLayerIds, mapView: this.mapView, onLayerSelectionChange: (evt) => { void this._layerSelectionChange(evt); }, ref: (el) => { this._layerPicker = el; }, selectedIds: [this._refineLayer.layer.id], showTables: false })), index.h("calcite-popover", { key: 'c469bcb0fbbfbc08797541043b0c9130e453737f', closable: true, label: "", referenceElement: "refine-input-layer" }, index.h("span", { key: '2b3ea14d98fd5f699581fc2d3b1bad6b7c114f0e', class: "tooltip-message" }, this._translations.inputLayerTip)))), index.h("div", { key: '3a73cbd44600beca829f63939777be13ccd22fb3', class: "padding-1" }, index.h("div", { key: '6be9c1a327b1d8ca01f44884faf4ae6f509387da', class: "padding-bottom-1" }, index.h("calcite-segmented-control", { key: 'e2115941df58eac148aaf0f21022844ee1ec92a1', class: "w-100", width: "full" }, index.h("calcite-segmented-control-item", { key: 'f554b5def04c12fd529eadcdf34df2e702b72f14', checked: this._addEnabled, class: "w-50 word-wrap-anywhere", onClick: () => this._setSelectionMode(interfaces.ESelectionMode.ADD), value: interfaces.ESelectionMode.ADD }, index.h("span", { key: '4436d09c76c7e1baba359ebb04def82ea873b541', class: "font-weight-500" }, this._translations.add)), index.h("calcite-segmented-control-item", { key: '62e865762305dae22aa39fa9811e40649c4f6538', checked: !this._addEnabled, class: "w-50 word-wrap-anywhere", onClick: () => this._setSelectionMode(interfaces.ESelectionMode.REMOVE), value: interfaces.ESelectionMode.REMOVE }, index.h("span", { key: '7dc24184ac22a73d96f9894941dc1ef2628903f3', class: "font-weight-500" }, this._translations.remove)))), index.h("div", { key: 'd0830d20118aa73b3ddee7f92365fa8fb13c238f' }, index.h("map-draw-tools", { key: 'e956f1711607967919c3ede794f0e51e8e3f69d0', active: true, drawMode: interfaces.EDrawMode.REFINE, mapView: this.mapView, onDrawRedo: () => this._redo(), onDrawUndo: () => this._undo(), onSketchGraphicsChange: (evt) => this._sketchGraphicsChanged(evt), pointSymbol: this.sketchPointSymbol, polygonSymbol: this.sketchPolygonSymbol, polylineSymbol: this.sketchLineSymbol, redoEnabled: this._refineSelectionSet?.redoStack.length > 0, ref: (el) => { this._drawTools = el; }, undoEnabled: this._refineSelectionSet?.undoStack.length > 0 })), index.h("br", { key: '6290a4690597648838ca68d347a827b42c6b75ff' }), (index.h("calcite-list", { key: '90a1b32598473fe55861bbce63d77f5481b88194', class: "list-border" }, this._getRefineSelectionSetList())))));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
