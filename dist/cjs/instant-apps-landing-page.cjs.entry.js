...
const InstantAppsLandingPage = class {
    constructor(hostRef) {
        ...
        this.landingPageOpen = index.createEvent(this, "landingPageOpen", 7);
        this.landingPageClose = index.createEvent(this, "landingPageClose", 7);
    ...
    render() {
        ...
        return index.h(index.Host, { key: '0e372fb26b6581751f19368cd778a05c22f04587' }, content);
    }
    renderLandingPageContent() {
        ...
        return (index.h("div", { style: style, class: `${CSS.BASE}${alignmentClass}${closed}${removeTransition}` }, index.h("div", { class: CSS.contentContainer }, this.renderIconImage(), this.renderTitleText(), this.renderSubtitleText(), this.renderDescriptionText()), this.renderEntryButtonContainer()));
    }
    renderEntryButtonContainer() {
        return this.enableSignIn ? (this.renderLandingPageSignIn()) : (index.h("div", { class: CSS.buttonContainer }, this.renderEntryButton(), index.h("slot", { name: "secondary-action" })));
    }
    renderLandingPageSignIn() {
        return (index.h("instant-apps-sign-in", { type: "landingPage", landingPage: true, portal: this.portal, oauthappid: this.oauthappid, titleText: this.titleText, subtitleText: this.subtitleText, descriptionText: this.descriptionText, closeLandingPage: this.closeLandingPage.bind(this) }));
    }
    renderIconImage() {
    ...
    renderTitleText() {
        return index.h("h1", { class: CSS.titleText }, this.titleText);
    }
    renderSubtitleText() {
        return index.h("span", { class: CSS.subtitleText }, this.subtitleText);
    }
...
exports.instant_apps_landing_page = InstantAppsLandingPage;
