...
const TileGroup = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: 'b6652c98d563b78b3eda1dfffb61efdbbfbbae58', disabled: this.disabled }, index.h("div", { key: 'e708dc17cf003fd7799f3f510f2dd76bb236a418', "aria-label": this.label, class: CSS.container, role: role }, index.h("slot", { key: 'e3fa46a38e975d2c45371fc9b5c1a89d271143e3', onSlotchange: this.updateTiles, ref: this.setSlotEl }))));
    }
