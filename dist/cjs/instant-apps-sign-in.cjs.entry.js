...
const InstantAppsSignIn = class {
    ...
    render() {
        ...
        return index.h(index.Host, { key: 'af7ff807a996fd2dbbc647988fc24e5a122c4efe' }, signIn);
    }
    renderContent() {
    ...
    renderSignInDropdown() {
        ...
        return (index.h("calcite-dropdown", { placement: "bottom-end", scale: dropdownScale }, this.type === 'navigation' ? (index.h("calcite-navigation-user", { slot: "trigger", thumbnail: (_a = this.user) === null || _a === void 0 ? void 0 : _a.thumbnailUrl, "full-name": (_b = this.user) === null || _b === void 0 ? void 0 : _b.fullName, username: (_c = this.user) === null || _c === void 0 ? void 0 : _c.username, textDisabled: true })) : (index.h("button", { slot: "trigger" }, index.h("calcite-avatar", { thumbnail: (_d = this.user) === null || _d === void 0 ? void 0 : _d.thumbnailUrl, "full-name": (_e = this.user) === null || _e === void 0 ? void 0 : _e.fullName, username: (_f = this.user) === null || _f === void 0 ? void 0 : _f.username }))), index.h("slot", { name: "sign-in-dropdown-top" }), index.h("calcite-dropdown-group", { "selection-mode": "none" }, (_g = this.signInDropdownItems) === null || _g === void 0 ? void 0 :
            _g.map(item => index.h("calcite-dropdown-item", { onClick: item.onClick }, item.label)), index.h("calcite-dropdown-item", { onClick: this.signOut.bind(this) }, (_h = this.messages) === null || _h === void 0 ? void 0 : _h.signOut))));
    }
    renderSignInButton() {
        var _a;
    ...
    renderLandingPageSignIn() {
        var _a, _b;
        return (index.h("div", { class: CSS.buttonContainer }, index.h("calcite-button", { class: CSS.entryButton, scale: "l", appearance: "outline-fill", width: "half", onClick: this.landingPageSignIn.bind(this) }, (_a = this.messages) === null || _a === void 0 ? void 0 : _a.signIn), index.h("calcite-button", { class: CSS.entryButton, scale: "l", appearance: "outline-fill", width: "half", onClick: this.guestOnClick.bind(this) }, (_b = this.messages) === null || _b === void 0 ? void 0 : _b.continueAsGuest)));
    }
    async initSignIn() {
