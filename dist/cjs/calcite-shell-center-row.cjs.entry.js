...
const ShellCenterRow = class {
    ...
    render() {
        const { el } = this;
        const contentNode = (index.h("div", { key: '7c40a32627154faa3cbb1caa515f156481b79a7a', class: CSS.content }, index.h("slot", { key: 'fe29fde212e5e65a0e0baf633a086dd8e30b5eb8' })));
