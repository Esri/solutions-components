...
const InputMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4abc6b1bd6e85531a00bd92de1c18c6b9c27375b', "calcite-hydrated-hidden": hidden }, this.renderIcon(this.requestedIcon), index.h("slot", { key: 'f357f91ba9e220ea524c4aa14bf2b0c09b1c7064' })));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
...
const MapDrawTools = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c7f1873f30064fb688eef5fc1ee14903782d23ec' }, index.h("div", { key: '56235f613c9a96894030cf64e3ad9bdba951e2a0', class: containerClass }, index.h("div", { key: 'dd8cf1aff624670920b65e7ec0cfeba409039f4b', ref: (el) => { this._sketchElement = el; } }), index.h("div", { key: 'e88eb83e81301befa1e26d5aab46c0f2dc1286d0', class: undoRedoClass }, index.h("calcite-action", { key: '7eaeca49d89dcda98965b45864c7b1a91f8e500e', disabled: !this.undoEnabled, icon: "undo", onClick: () => this._undo(), scale: "s", text: this._translations.undo }), index.h("calcite-action", { key: '8b6fa842d86a17345d5dc6aa11900f94896a60e3', disabled: !this.redoEnabled, icon: "redo", onClick: () => this._redo(), scale: "s", text: this._translations.redo })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
