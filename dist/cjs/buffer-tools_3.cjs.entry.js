...
const MapDrawTools = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '29a6976363bf4d6d256a80235fddc4d9f29d3314' }, index.h("div", { key: 'a377200e030bf41964215c4d456f1aabb3ce0fa1', class: containerClass }, index.h("div", { key: 'de5b692eaa3d529099e1515daad6345393200039', ref: (el) => { this._sketchElement = el; } }), index.h("div", { key: '8a710aface1f6c50cb124b0e0a740ae7ba6822be', class: undoRedoClass }, index.h("calcite-action", { key: '259c132f9b45e9442f9c8060c7ebbeb1ce614e58', disabled: !this.undoEnabled, icon: "undo", onClick: () => this._undo(), scale: "s", text: this._translations.undo }), index.h("calcite-action", { key: '3a9f249a0f601e1975f73dcd05f53ab768e5f4e2', disabled: !this.redoEnabled, icon: "redo", onClick: () => this._redo(), scale: "s", text: this._translations.redo })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
