...
const BufferTools = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: 'fe60961aabf178fd32c4c85e8d52b9bc61a349d0' }, this.appearance === "text" ? this._getTextBoxDisplay() : this._getSliderDisplay()));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
...
const InputMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c7d1b37721cec28dee1020b81ff66dee7fc8bc44', "calcite-hydrated-hidden": hidden }, this.renderIcon(this.requestedIcon), index.h("slot", { key: '7147d81e906765c154b4a61e31706a72c1ef3ae0' })));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
...
const MapDrawTools = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c6717ea80242f622168f49efeaf2cebf497ca09e' }, index.h("div", { key: '2dd805c704381cb411d69b757072371d91fb243d', class: containerClass }, index.h("div", { key: '28b81cb37f3e11f66656195fc10b4c170f8d8fe9', ref: (el) => { this._sketchElement = el; } }), index.h("div", { key: 'a6de7ee6dbf4f02eb355c032c7bd9bf4ec4426e9', class: undoRedoClass }, index.h("calcite-action", { key: '2efeab5db057e1657c3639a39ae4d4150d331776', disabled: !this.undoEnabled, icon: "undo", onClick: () => this._undo(), scale: "s", text: this._translations.undo }), index.h("calcite-action", { key: '770693e30a6cfb58f593bb471342ea34556fc8d4', disabled: !this.redoEnabled, icon: "redo", onClick: () => this._redo(), scale: "s", text: this._translations.redo })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
