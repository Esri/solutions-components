...
var maquette_umd = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const InstantAppsInteractiveLegendClassic = class {
    ...
    async createDataForLayer(fLayer) {
        ...
        if (!dataForLayer && acl) {
            const dataForLayer = (await helpers.createInteractiveLegendDataForLayer(this.legendvm, acl, this.reactiveUtils));
