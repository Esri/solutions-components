...
const locale$1 = require('./locale-3e33f44c.js');
...
require('./languageUtil-9bd00bad.js');
...
const InputDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { onBlur: this.blurHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { disabled: this.disabled }, this.localeData && (index.h("div", { class: CSS$2.inputContainer }, index.h("div", { class: CSS$2.inputWrapper, "data-position": "start", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown,
            ...
            this.renderToggleIcon(this.open && this.focusedInput === "start"), index.h("span", { "aria-hidden": "true", class: CSS$2.assistiveText, id: this.placeholderTextId }, "Date Format: ", (_b = this.localeData) === null || _b === void 0 ? void 0 : _b.placeholder)), index.h("div", { "aria-hidden": dom.toAriaBoolean(!this.open), "aria-label": messages.chooseDate, "aria-live": "polite", "aria-modal": "true", class: {
                [CSS$2.menu]: true,
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setDatePickerRef }))), this.range && this.layout === "horizontal" && (index.h("div", { class: CSS$2.horizontalArrowContainer }, index.h("calcite-icon", { flipRtl: true, icon: "arrow-right", scale: component.getIconScale(this.scale) }))), this.range && this.layout === "vertical" && this.scale !== "s" && (index.h("div", { class: CSS$2.verticalArrowContainer }, index.h("calcite-icon", { icon: "arrow-down", scale: component.getIconScale(this.scale) }))), this.range && (index.h("div", { class: CSS$2.inputWrapper, "data-position": "end", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ...
            this.renderToggleIcon(this.open && this.focusedInput === "end"))))), index.h(form.HiddenFormInputSlot, { component: this }), this.validationMessage ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    renderToggleIcon(open) {
        return (
        // we set tab index to -1 to prevent delegatesFocus from stealing focus before we can set it
        index.h("span", { class: CSS$2.toggleIcon, tabIndex: -1 }, index.h("calcite-icon", { icon: open ? "chevron-up" : "chevron-down", scale: component.getIconScale(this.scale) })));
    }
    setReferenceEl() {
    ...
    localizeInputValues() {
        ...
        const localizedDate = date$1 && date$1.toLocaleDateString(this.effectiveLocale, formattingOptions);
...
const InstantAppsFilterList = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("calcite-panel", { class: this.baseClass, ref: el => (this.panelEl = el) }, index.h("slot", { slot: "header-content", name: "filter-header-content" }), index.h("slot", { slot: "header-actions-end", name: "filter-header-actions-end" }), index.h("div", { key: "filter-container", class: CSS$1.filterContainer }, filterConfig, footer))));
    }
    renderLoading() {
