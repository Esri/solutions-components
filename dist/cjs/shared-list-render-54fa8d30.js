...
const List = ({ props: { disabled, loading, filterEnabled, dataForFilter, handleFilterEvent, filterPlaceholder, filterText, setFilterEl, dragEnabled, storeAssistiveEl, }, ...rest }) => {
    ...
    return (index.h(index.Host, { "aria-busy": dom.toAriaBoolean(loading), role: "menu", ...rest }, index.h(interactive.InteractiveContainer, { disabled: disabled }, index.h("section", null, dragEnabled ? (index.h("span", { "aria-live": "assertive", class: "assistive-text", ref: storeAssistiveEl })) : null, index.h("header", { class: { [resources$1.CSS.sticky]: true } }, filterEnabled ? (index.h("calcite-filter", { "aria-label": filterPlaceholder, disabled: disabled, items: dataForFilter, onCalciteFilterChange: handleFilterEvent, placeholder: filterPlaceholder, ref: setFilterEl, value: filterText })) : null, index.h("slot", { name: resources$1.SLOTS.menuActions })), loading ? index.h("calcite-scrim", { loading: loading }) : null, defaultSlot))));
};
