...
const InstantAppsCkeditorWrapper = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4a000cee4310d40e940c97d16f24c78415083f1b' }, index.h("div", { key: '55b2e7ddd6b259b58e19f8946d2198df1fd7b579' })));
    }
    init() {
        this.applyStyles();
        this.initEditor();
...
const InstantAppsLanguageTranslatorSearch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '71fa373371b7b33faa8f3d91959dc50b1e3b0f34' }, this.renderSearchInput(), this.renderSuggestions()));
    }
    renderSearchInput() {
