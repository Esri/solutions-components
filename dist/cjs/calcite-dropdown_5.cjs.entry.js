...
const DropdownItem = class {
  ...
  render() {
    ...
    const iconStartEl = (index.h("calcite-icon", { class: CSS$1.iconStart, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: scale === "l" ? "m" : "s" }));
    const contentNode = (index.h("span", { class: CSS$1.itemContent }, index.h("slot", null)));
    const iconEndEl = (index.h("calcite-icon", { class: CSS$1.iconEnd, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: scale === "l" ? "m" : "s" }));
    const slottedContent = this.iconStart && this.iconEnd
      ...
      : this.iconStart
        ...
        : this.iconEnd
          ...
          : contentNode;
    const contentEl = !this.href ? (slottedContent) : (index.h("a", { "aria-label": this.label, class: CSS$1.link, href: this.href, rel: this.rel, tabIndex: -1, target: this.target,
      // eslint-disable-next-line react/jsx-sort-props
    ...
    return (index.h(index.Host, { "aria-checked": itemAria, role: itemRole, tabindex: "0" }, index.h("div", { class: {
      ...
      } }, this.selectionMode !== "none" ? (index.h("calcite-icon", { class: CSS$1.icon, icon: this.selectionMode === "multiple" ? "check" : "bullet-point", scale: scale === "l" ? "m" : "s" })) : null, contentEl)));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
...
const EditRecordModal = class {
   ...
   */
  render() {
    return (index.h(index.Host, null, index.h("div", null, index.h("calcite-modal", { open: this.open, width: "s" }, index.h("div", { class: "font-500", slot: "header" }, this._translations.editMultiple), index.h("div", { slot: "content" }, index.h("calcite-label", { class: "font-italic" }, this._translations.infoMessage), this._getFieldInputs()), index.h("calcite-button", { appearance: "outline", onClick: () => this._cancel(), slot: "secondary", width: "full" }, this._translations.cancel), index.h("calcite-button", { appearance: "solid", onClick: () => this._save(), slot: "primary", width: "full" }, this._translations.save)))));
  }
  //--------------------------------------------------------------------------
  //
  //  Functions (protected)
  ...
  _getFieldInputs() {
    ...
    return labels.map(label => {
      return (index.h("div", { class: "padding-bottom-1" }, index.h("calcite-label", { class: "font-bold" }, label, index.h("calcite-input", { placeholder: this._translations.textField, type: "text" }))));
    });
  }
  _cancel() {
    this.open = false;
