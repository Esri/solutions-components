...
const LayerTable = class {
   ...
   */
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bf3550621554a425226ef1b9d41f3cb1ae8691bf' }, index.h("calcite-shell", { key: '286e94a267d352c202c48ac946dba00c0d530e65' }, this._getTableControlRow("header"), index.h("div", { key: 'bd41989fb4957479c9841ee9aae12a462090178b', class: `width-full ${tableHeightClass}` }, index.h("calcite-panel", { key: 'd5ed0b971fed25592064e0b0601c7e1c3a760246', class: "height-full width-full" }, index.h("calcite-loader", { key: '91cea660ef303345e8c64e8b50456283b28cf7d9', class: loadingClass, label: this._translations.fetchingData, scale: "l" }), index.h("div", { key: '7a61c51f748667a4f55882008c781c2f491184d3', class: tableNodeClass, ref: this.onTableNodeCreate })), !this.isMobile ? (index.h("div", { class: "bottom-left text-color height-19" }, this._translations.recordsSelected
            .replace("{{total}}", total)
...
const MapCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '31938d03953ffbb7d1156bd4f8136836e2c29a6a' }, index.h("div", { key: 'c298d792ed46da31300944e7dedacf1f0c971cdb', class: `${mapContainerClass}` }, index.h("map-picker", { key: '10a9995b86c8f3ce04dca4046354e3db3446c5cb', class: mapPickerClass, isMapLayout: this.isMapLayout, mapInfos: this.mapInfos, ref: (el) => this._mapPicker = el }), index.h("div", { key: '2e1b4ef40137122977f67bab1ebed51e27f3b0f8', class: `mapView-header display-flex ${headerElements}` }, index.h("div", { key: '982cd5b0077463609757b3eb4682e3b9482c8242', class: `border-end ${containerClass} ${mobileClass}`, id: "solutions-map-layer-picker-container" }, this.mapView && index.h("map-layer-picker", { key: '7bdce958962fe21a52dc2a3d41f0fdaa15863737', appearance: "transparent", defaultLayerId: this.defaultLayerId, display: "inline-flex", height: 50, isMobile: this.isMobile, mapView: this.mapView, onlyShowUpdatableLayers: this.onlyShowUpdatableLayers, placeholderIcon: "layers", scale: "l", selectedIds: this.selectedLayer ? [this.selectedLayer.id] : [], showSingleLayerAsLabel: true, showTables: true, type: "dropdown" })), this._getDropDownItem())), index.h("div", { key: '40a50c92853ab910a5a38c896e704a0acc6ced73', class: `${mapHeightClass} ${mapClass}`, ref: (el) => (this._mapDiv = el) }), index.h("map-tools", { key: 'f9219fcb363250623183df8fdf8c329b567ca7a6', basemapConfig: this.basemapConfig, class: `box-shadow ${themeClass}`, enableBasemap: this.enableBasemap, enableFloorFilter: this.enableFloorFilter, enableFullscreen: this.enableFullscreen, enableHome: this.enableHome, enableLegend: this.enableLegend, enableSearch: this.enableSearch, enableSingleExpand: this.enableSingleExpand, homeZoomToolsSize: this.homeZoomToolsSize, mapView: this.mapView, mapWidgetsSize: this.mapWidgetsSize, position: this.mapWidgetsPosition, ref: (el) => this._mapTools = el, searchConfiguration: this._searchConfiguration, stackTools: this.stackTools, toolOrder: this.toolOrder })));
    }
    /**
