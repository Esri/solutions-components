...
const InputText = class {
  ...
  render() {
    ...
    const inputClearButton = (index.h("button", { "aria-label": this.intlClear || TEXT.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputTextValue, tabIndex: -1, type: "button" }, index.h("calcite-icon", { icon: "x", scale: "s" })));
    ...
    const childEl = (index.h("input", { "aria-label": label.getLabelText(this), autofocus: this.autofocus ? true : null, class: {
