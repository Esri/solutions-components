...
const Modal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6b1abce9182df0c80157f4f798b358f06d31fdc1', "aria-describedby": this.contentId, "aria-labelledby": this.titleId, "aria-modal": "true", role: "dialog" }, index.h("div", { key: '59d9ef441e5e197d7db2111792e25e0289ace99c', class: {
                [CSS.container]: true,
                [CSS.containerOpen]: this.opened,
                [CSS.containerEmbedded]: this.embedded,
            } }, index.h("calcite-scrim", { key: '2cf489713f2081385f7fee5565e3233581035742', class: CSS.scrim, onClick: this.handleOutsideClose }), this.renderStyle(), index.h("div", { key: 'ca86b8febb8762415ca063efd03071dc3d44736b', class: {
                [CSS.modal]: true,
            }, ref: this.setTransitionEl }, index.h("div", { key: 'e3063610d77f9d9c40da02ec994a5bf23ae01643', class: CSS.header }, this.renderCloseButton(), index.h("header", { key: '0194a0c4cb6209898df8e80f3943321578d4b375', class: CSS.title }, index.h("slot", { key: 'e93887817a45273cc103b216bed848f339454e35', name: CSS.header }))), this.renderContentTop(), index.h("div", { key: 'afe9b18883ed572c37568cc2224747055f7ad0a5', class: {
                [CSS.content]: true,
                [CSS.contentNoFooter]: !this.hasFooter,
            }, ref: (el) => (this.modalContent = el) }, index.h("slot", { key: 'deb96aba4ac030e7fbbdad1115e1a801f1545917', name: SLOTS.content })), this.renderContentBottom(), this.renderFooter()))));
    }
    renderFooter() {
