...
const ConsentManager = class {
     ...
     */
    render() {
        return this._shouldRender ? (index.h(index.Host, null, index.h("calcite-panel", { class: "consent-panel calcite-mode-dark", id: "cookie-policy" }, index.h("div", { class: "cookie-consent-popup-container" }, index.h("div", { id: "cookie-policy-description-top", tabindex: "-1" }, index.h("p", null, this._translations.dearVisitor), index.h("p", null, this._translations.useAnalytics)), index.h("div", { class: "button-container" }, index.h("calcite-button", { appearance: "solid", class: "padding-end-1", kind: "brand", onClick: () => this._refuse() }, this._translations.refuseAnalytics), index.h("calcite-button", { appearance: "solid", kind: "brand", onClick: () => this._accept() }, this._translations.acceptAnalytics)), index.h("div", null, index.h("p", null, this._translations.moreInfo, "\u00A0", index.h("calcite-link", { class: "link-text", href: "https://www.europarl.europa.eu/privacy-policy/en/data-protection", rel: "noopener noreferrer", target: "_blank" }, this._translations.protectionPolicy), this._translations.our, "\u00A0", index.h("calcite-link", { class: "link-text", href: "https://www.europarl.europa.eu/privacy-policy/en/cookies-policy", rel: "noopener noreferrer", target: "_blank" }, this._translations.cookiePolicy), this._translations.andOur, "\u00A0", index.h("calcite-link", { class: "link-text", href: "https://www.europarl.europa.eu/privacy-policy/en/cookies-inventory", rel: "noopener noreferrer", target: "_blank" }, this._translations.cookiesInventory))))))) : undefined;
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
