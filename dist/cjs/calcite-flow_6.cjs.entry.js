...
const CreateFeature = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd201ad6280a9fb3a566d54685a3c59daa5f1aea1' }, index.h("div", { key: '3451399636e1d088091db6547d3cc96948cd0d34', id: "feature-form" })));
    }
    async initModules() {
        const [Editor, reactiveUtils, MapView] = await locale$1.loadModules([
            "esri/widgets/Editor",
   ...
   */
    ...
    */
    ...
    render() {
        ...
        return (index.h("calcite-loader", { key: '58e20b0723d76b27652f655c598628b43dde70e3', class: loaderClass, label: "", scale: "s" }));
    }
    /**
...
const FeatureDetails = class {
    ...
    render() {
        ...
        return (index.h("calcite-panel", { key: 'edc14da0a332fe605f7e2c661343811e294a12c3', "full-height": true }, index.h("info-card", { key: 'dd4fd2623c7b2d55b41bfe2381280b0d8b0f3ad4', allowEditing: false, graphics: this.graphics, highlightEnabled: false, isLoading: false, isMobile: false, mapView: this.mapView, onSelectionChanged: (e) => { this.featureSelectionChange.emit(e.detail); }, paginationEnabled: false, position: "relative", ref: el => this._infoCard = el }), (this._likeFieldAvailable || this._dislikeFieldAvailable || this._commentsAvailable) &&
            index.h("div", { key: '9593936d247998e41a7eb22c6741108e27f2af48', class: "buttons-container" }, this._commentsAvailable &&
                index.h("div", { key: 'e167be0c9ab27b53d8533249e4cee883e2df889b', class: "comment-btn" }, index.h("span", { key: 'd33eab166fc98a9121de8354f90087f312c09a5c' }, this._relatedFeaturesOIDs.length), index.h("calcite-icon", { key: '4393f5e2d961b8190d2e25203f15b178ec6a4ab2', icon: "speech-bubble", scale: 's' })), this._likeFieldAvailable &&
                index.h("calcite-button", { key: 'fc42846216ec819152fa2fde02266ff1bcb51538', appearance: "transparent", iconEnd: "thumbs-up", kind: this._isLikeBtnClicked ? "brand" : "neutral", loading: this._updating, onClick: this.onLikeButtonClick.bind(this), scale: 'm' }, this._likeCount ?? this._selectedGraphic.attributes[this._likeField] ?? 0), this._dislikeFieldAvailable &&
                index.h("calcite-button", { key: '6afae4e0599735fef2a348d87b23476c598e3216', appearance: "transparent", iconEnd: "thumbs-down", kind: this._isDislikeBtnClicked ? "brand" : "neutral", loading: this._updating, onClick: this.onDislikeButtonClick.bind(this), scale: 'm' }, this._disLikeCount ?? this._selectedGraphic.attributes[this._dislikeField] ?? 0)), this.relatedTableId && this._commentsAvailable &&
            index.h("feature-list", { key: '0bc1416ccf4b14138c336723d163250550f87ec5', class: "height-full", mapView: this.mapView, onFeatureSelect: (e) => { this.commentSelect.emit(e.detail); }, pageSize: 5, ref: el => this._commentsList = el, selectedLayerId: this.relatedTableId, showErrorWhenNoFeatures: false, showInitialLoading: false, showUserImageInList: this.showUserImageInCommentsList, textSize: "small", whereClause: commentsListWhereClause })));
    }
    /**
     * Load esri javascript api modules
     *
