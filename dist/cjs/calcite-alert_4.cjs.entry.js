...
const EditCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ecd0ae5acb55f80e38b300a302fd474d62bce73b' }, index.h("div", { key: 'e59f4e45adf3556abdb9f208ba0493cc3b7c92f0', class: "position-absolute" }, editDisabled ? (index.h("calcite-notice", { kind: "warning", open: true, slot: "content-top", width: "full" }, index.h("div", { slot: "message" }, this._translations.enableEditing))) : undefined, index.h("div", { key: '1253b4804e854c4be2ad7dc97536b7cccfce6356', class: "position-absolute" }, index.h("div", { key: '85679b611a6e4850a4fbcb5f1f627992bfb50577', class: tableNodeClass, id: "feature-form", ref: (el) => this._editContainer = el }), index.h("calcite-loader", { key: '99aa1d51bb7dd4cdcc3a6adb20586fbf94e049a2', class: loadingClass, label: "", scale: "s" })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
...
const InfoCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f49f0c0745fd3541dbf865188a71035fc51d4dfa' }, index.h("calcite-shell", { key: 'a2b62b1342c6802d949c425033540a7a8acca09b', style: { position: this.position } }, this._getHeader(), index.h("calcite-loader", { key: '507cbc82433990b522801a2468c8eacb07d9b21a', class: loadingClass, label: this._translations.fetchingData }), index.h("div", { key: '5604b842602c063903ba9273935864c28b8d33d1', class: "esri-widget feature-node " + featureNodeClass, id: this._featuresNodeId }), index.h("div", { key: '04e505abc60fd41c25f184d6e274eab5e4ea9143', class: `${editButtonClass} width-100`, slot: "footer" }, this.allowEditing &&
            index.h("div", { key: '95c15c913b0ee0204ef3ae8b7d726a3d958533cb', class: "display-flex top-border padding-1-2" }, index.h("calcite-button", { key: '6849fcb8f0d4d7faca8dd5df14a470681644c605', appearance: "solid", id: "solutions-edit", onClick: () => this._openEditRecord(), width: "full" }, this._translations.edit), this.isMobile && deleteEnabled ? (index.h("delete-button", { class: "padding-inline-start-1 width-100", id: "solutions-delete", ids: ids, layer: this._layer, onEditsComplete: () => this._closePopup() })) : undefined, index.h("calcite-tooltip", { key: '5299159da515d3dfeea8a2b96f00a480add44e68', placement: "bottom", "reference-element": "solutions-edit" }, index.h("span", { key: '2394000279a4c5323dae441ef0d085bf504cd43b' }, this._translations.edit)), this.isMobile ? (index.h("calcite-tooltip", { placement: "bottom", "reference-element": "solutions-delete" }, index.h("span", null, this._translations.delete))) : undefined), this.paginationEnabled && !nextBackDisabled && index.h("div", { key: 'c3989c069f1460456c1ba745cc9137f3067ec20b', class: `display-flex padding-1-2 button-container top-border ${nextBackClass}` }, index.h("div", { key: 'eec3e070058d6133c0b18ecdf5c5888fa996dd99' }, index.h("calcite-button", { key: '50140a970e2bf9419eeac0b548b6426f9259aa2b', appearance: 'transparent', disabled: nextBackDisabled, iconStart: "chevron-left", id: "solutions-back", onClick: () => this._back(), width: "full" }), index.h("calcite-tooltip", { key: 'f4c1a5dbdd14128eb32cc1bfb829454dbfb587f1', placement: "top", "reference-element": "solutions-back" }, index.h("span", { key: 'be7f0ec5313be495c757fa46bbd79553b5faef52' }, this._translations.back))), index.h("calcite-action", { key: 'b0995b0c426c7fa4e142cd7a6adf09e2747c373a', class: 'pagination-action', onClick: () => this._toggleListView(), scale: "s", text: "", textEnabled: true }, index.h("span", { key: '06a73fd05527242a5b4c6cf1fb834dcbc7056064', class: "pagination-count" }, this._count)), index.h("div", { key: 'fdb20624043a32aff228d3365b7cf97623a629ba' }, index.h("calcite-button", { key: 'aef88f3c93736060a653c93a1da0b28d2acb5dba', appearance: "transparent", disabled: nextBackDisabled, iconStart: "chevron-right", id: "solutions-next", onClick: () => this._next(), width: "full" }), index.h("calcite-tooltip", { key: 'f63b2d5cbf74ff1daec3b328e2704d4e3414ba50', placement: "top", "reference-element": "solutions-next" }, index.h("span", { key: '518767650ad30f4d43dd9393bf7f13836859bdb1' }, this._translations.next))))), index.h("edit-card", { key: '5d97a81be1945d42a190a71c4aa69fc5e62ca19b', class: editClass, enableEditGeometry: this.enableEditGeometry, graphicIndex: this._features?.selectedFeatureIndex, graphics: this.graphics, mapView: this.mapView, open: this._editRecordOpen }), index.h("calcite-alert", { key: '0a79e1ef678ad3cbaa8b88635e7aa06a34bef54f', icon: "layer-broken", kind: "warning", label: "", onCalciteAlertClose: () => this._alertClosed(), open: this._alertOpen, placement: "top" }, index.h("div", { key: '4c3601a39a322c39737ad006519a312e64137a71', slot: "title" }, this._translations.editDisabled), index.h("div", { key: '909211d332d5f663da0c581a02b800ac1950b684', slot: "message" }, this._translations.enableEditing)))));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
