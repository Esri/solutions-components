...
const CrowdsourceReporter = class {
    ...
    */
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '19f101c9528b57020239bb58ca68e6342948c753' }, this._reportSubmitted && index.h("calcite-alert", { key: 'e67c67c3dd8e125845a3c03142eb2cd898dda06d', "auto-close": true, class: themeClass + " report-submitted-msg", icon: "check-circle", kind: "success", label: "", onCalciteAlertClose: () => { this._reportSubmitted = false; }, open: true, placement: "top" }, index.h("div", { key: '5c5a46635f75aecd66c308272bbd906aa852b787', slot: "message" }, this.reportSubmittedMessage ? this.reportSubmittedMessage : this._translations.submitMsg)), this._featureCreationFailedErrorMsg && index.h("calcite-alert", { key: '54e5f763587e5e2af5b2ad7655f6214367c3948b', "auto-close": true, class: themeClass, icon: "x-octagon", kind: "danger", label: "", onCalciteAlertClose: () => { this._featureCreationFailedErrorMsg = ""; }, open: true, placement: "top" }, index.h("div", { key: 'a5d85b1906df763dad176cf43c1b9cb1f844bd0c', slot: "title" }, this._translations.error), index.h("div", { key: 'b8b29d8f517a21b9dcd3f762daa19e16182eb17d', slot: "message" }, this._featureCreationFailedErrorMsg)), this._commentSubmitted && index.h("calcite-alert", { key: '9b145bb3d14dd4f3a0c42fa1471e94a3d48662e3', "auto-close": true, class: 'report-submitted ' + themeClass, icon: "check-circle", kind: "success", label: "", onCalciteAlertClose: () => { this._commentSubmitted = false; }, open: true, placement: "top" }, index.h("div", { key: '6521601364864d6ae04d5165f784bcb8a51d4e07', slot: "message" }, this._translations.commentSubmittedMsg)), this._addingCommentFailed && index.h("calcite-alert", { key: '33f5503ae9829974be54d141513cedfee67648f4', "auto-close": true, class: themeClass, icon: "x-octagon", kind: "danger", label: "", onCalciteAlertClose: () => { this._addingCommentFailed = false; }, open: true, placement: "top" }, index.h("div", { key: '4800252ca2eca61601353dccbe2b710fed08671d', slot: "title" }, this._translations.error), index.h("div", { key: '38b2edc164a3a2bb197903fdb2c64440886e530c', slot: "message" }, this._translations.addingCommentFailedMsg)), index.h("div", { key: 'e8950bc3733837550b56073090cf618f2eeea605' }, index.h("calcite-shell", { key: '1fc2d22bad79beac75441c8d10920818d28058f4', "content-behind": true }, this._getReporter()))));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
    ...
    async getRelatedTable() {
        ...
        const relatedTable = allTables.filter((table) => selectedLayer.url === table.url && relatedTableIdFromRelnship === table.layerId);
