...
const InstantAppsInteractiveLegendGroupLegendElement = class {
    ...
    render() {
        return (index.h("div", { key: 'ab9a4911afa5f1021f3270c4fec409a708e2ec51', style: {
                borderLeft: '1px solid var(--calcite-color-border-3)',
            }, class: `${CSS$4.service} ${CSS$4.groupLayer}` }, index.h("instant-apps-interactive-legend-layer-element-caption", { key: 'bc80abe473c1b47920a78b072033d5b214f7822c', ref: node => (this.layerCaption = node), class: helpers.getTheme(this.el), legendvm: this.legendvm, "feature-count": this.featureCount, activeLayerInfo: this.activeLayerInfo, messages: this.messages, isChild: this.isChild }), index.h("div", { key: 'cf6dc1620eb0a95430129b9d414a9f6b893b61c2', class: `${CSS$4.groupContent} ${this.expanded === false ? 'hide' : 'show'}` }, index.h("slot", { key: 'f346b52020e3cf4e3a072fdfa17a3762676aba53', name: "content" }))));
    }
...
const InstantAppsInteractiveLegendLayerElement = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '45305a415db8ba0a08ab69de820ff6b8711e1cee', style: {
                borderLeft: '1px solid var(--calcite-color-border-3)',
            }, class: `${CSS$3.service}${layerClasses}`, tabIndex: 0 }, index.h("instant-apps-interactive-legend-layer-element-caption", { key: '7babce8571540883bca9e0ff07c0a152cbb30fbb', ref: node => (this.layerCaption = node), legendvm: this.legendvm, "feature-count": this.featureCount, activeLayerInfo: this.activeLayerInfo, messages: this.messages, isChild: !!this.isChild, class: helpers.getTheme(this.el) }), index.h("div", { key: 'c021d9c441c407d5fac6f246eb9f4b6ce76bcaa5', id: `${(_b = (_a = this.activeLayerInfo) === null || _a === void 0 ? void 0 : _a.layer) === null || _b === void 0 ? void 0 : _b.id}-legend-layer`, class: `${CSS$3.layer}${this.expanded === false ? ' hide' : ' show'}` }, index.h("slot", { key: '761834066d924654c87a39601c1670625c88d863', name: "content" }))));
    }
    get el() { return index.getElement(this); }
};
...
const InstantAppsInteractiveLegendLegendElement = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'cd76a15dfd77c630708e61535a4d22d66385a4bf', class: `${tableClass}${tableClasses}${nonInteractiveClass}${nestedUniqueSymbolClass}` }, index.h("div", { key: '24eb28f5fa505d1d4471a750b5273b34af2f3428', id: `${(_g = (_f = this.activeLayerInfo) === null || _f === void 0 ? void 0 : _f.layer) === null || _g === void 0 ? void 0 : _g.id}-legend-element-caption`, class: `${this.isRelationshipRamp || (!this.titleText && !this.zoomTo && singleSymbol) ? 'hide' : 'show'}` }, index.h("instant-apps-interactive-legend-legend-element-caption", { key: '5ffd04439d1c99251e358afcf077628a780c8e40', ref: node => (this.legendLayerCaption = node), legendvm: this.legendvm, activeLayerInfo: this.activeLayerInfo, layer: this.activeLayerInfo.layer, titleText: this.titleText, legendElement: this.legendElement, legendElementIndex: this.legendElementIndex, zoomTo: this.zoomTo, isInteractive: this.isInteractive, messages: this.messages })), index.h("div", { key: "content", id: `${(_j = (_h = this.activeLayerInfo) === null || _h === void 0 ? void 0 : _h.layer) === null || _j === void 0 ? void 0 : _j.id}-legend-element-content-${this.legendElementIndex}`, class: `${expanded === false ? 'hide' : 'show'}` }, index.h("slot", { key: 'c95e14737a003f85f7c494e6d30d9f946bef464a', name: "content" }))));
    }
};
...
const InstantAppsInteractiveLegendRelationship = class {
    ...
    render() {
        var _a, _b;
        return (index.h("div", { key: '8b7054296e51e501b5378804dc6055acd113fbfa', ref: (node) => {
          ...
          `;
            ...
            } }, index.h("span", { key: '7cd336ef09492b5fc016657a61991f2f255a0b4a', class: CSS.instructionalText }, (_b = (_a = this.messages) === null || _a === void 0 ? void 0 : _a.relationship) === null || _b === void 0 ? void 0 : _b.instructionalText), this.renderRelationshipRamp()));
    }
