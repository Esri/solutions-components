...
const helpers = require('./helpers-981dd775.js');
...
InstantAppsInteractiveLegendGroupLegendElement.style = instantAppsInteractiveLegendGroupLegendElementCss;
...
InstantAppsInteractiveLegendLayerElement.style = instantAppsInteractiveLegendLayerElementCss;
...
const InstantAppsInteractiveLegendLegendElement = class {
    ...
    render() {
        ...
        return (index.h("div", { class: `${tableClass}${tableClasses}${nonInteractiveClass}${nestedUniqueSymbolClass}` }, index.h("div", { id: `${(_g = (_f = this.activeLayerInfo) === null || _f === void 0 ? void 0 : _f.layer) === null || _g === void 0 ? void 0 : _g.id}-legend-element-caption`, class: `${this.isRelationshipRamp || (!this.titleText && !this.zoomTo && singleSymbol) ? 'hide' : 'show'}` }, index.h("instant-apps-interactive-legend-legend-element-caption", { ref: node => (this.legendLayerCaption = node), legendvm: this.legendvm, activeLayerInfo: this.activeLayerInfo, layer: this.activeLayerInfo.layer, titleText: this.titleText, legendElement: this.legendElement, legendElementIndex: this.legendElementIndex, zoomTo: this.zoomTo, isInteractive: this.isInteractive, messages: this.messages })), index.h("div", { key: "content", id: `${(_j = (_h = this.activeLayerInfo) === null || _h === void 0 ? void 0 : _h.layer) === null || _j === void 0 ? void 0 : _j.id}-legend-element-content-${this.legendElementIndex}`, class: `${expanded === false ? 'hide' : 'show'}` }, index.h("slot", { name: "content" }))));
    }
};
    ...
    render() {
        ...
        return (index.h("div", { ref: (node) => {
          ...
          `;
            ...
            } }, index.h("span", { class: CSS.instructionalText }, (_b = (_a = this.messages) === null || _a === void 0 ? void 0 : _a.relationship) === null || _b === void 0 ? void 0 : _b.instructionalText), this.renderRelationshipRamp()));
    }
...
InstantAppsInteractiveLegendRelationship.style = instantAppsInteractiveLegendRelationshipCss;
