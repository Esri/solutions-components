...
const InstantAppsInteractiveLegendGroupLegendElement = class {
    ...
    render() {
        return (index.h("div", { key: '5294fd647e506c8fb1c10bc39178dd1701df0a13', style: {
                borderLeft: '1px solid var(--calcite-color-border-3)',
            }, class: `${CSS$4.service} ${CSS$4.groupLayer}` }, index.h("instant-apps-interactive-legend-layer-element-caption", { key: '5fa320a7a12179a85e157ccbabb5ff0d3fb75ea2', ref: node => (this.layerCaption = node), class: helpers.getTheme(this.el), legendvm: this.legendvm, "feature-count": this.featureCount, activeLayerInfo: this.activeLayerInfo, messages: this.messages, isChild: this.isChild }), index.h("div", { key: '68f702a841bf7a89a0534a252465b742c872aa94', class: `${CSS$4.groupContent} ${this.expanded === false ? 'hide' : 'show'}` }, index.h("slot", { key: '7b632a4264a3aead0f53949b972169827b11a4c0', name: "content" }))));
    }
...
const InstantAppsInteractiveLegendLayerElement = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '14f04807f3c36d4ef8dc2337d126b9657fc8edec', style: {
                borderLeft: '1px solid var(--calcite-color-border-3)',
            }, class: `${CSS$3.service}${layerClasses}`, tabIndex: 0 }, index.h("instant-apps-interactive-legend-layer-element-caption", { key: '3917bafae2f4c5d5050d402ab2a3e9257ecfc678', ref: node => (this.layerCaption = node), legendvm: this.legendvm, "feature-count": this.featureCount, activeLayerInfo: this.activeLayerInfo, messages: this.messages, isChild: !!this.isChild, class: helpers.getTheme(this.el) }), index.h("div", { key: '8eb250a7a3404561a5ab349406fbfce8dac00608', id: `${(_b = (_a = this.activeLayerInfo) === null || _a === void 0 ? void 0 : _a.layer) === null || _b === void 0 ? void 0 : _b.id}-legend-layer`, class: `${CSS$3.layer}${this.expanded === false ? ' hide' : ' show'}` }, index.h("slot", { key: '94f10f632b9409a25f6f5eaf65c7a2e50ecedc29', name: "content" }))));
    }
    get el() { return index.getElement(this); }
};
...
const InstantAppsInteractiveLegendLegendElement = class {
    ...
    render() {
        ...
        const nestedUniqueSymbolClass = helpers.checkNestedUniqueSymbolLegendElement(this.activeLayerInfo) ? ` ${CSS$2.nestedUniqueSymbol}` : '';
        let expanded = singleSymbol && !this.expanded && !this.zoomTo ? true : this.expanded;
        if (this.isRelationshipRamp) {
            const relationshipRampExpandStates = helpers.store.get('relationshipRampExpandStates');
            const expandState = relationshipRampExpandStates[this.activeLayerInfo.layer.id];
            expanded = expandState;
        }
        return (index.h("div", { key: '4c84ceeed6021b53975ce59397b7942efe0fd861', class: `${tableClass}${tableClasses}${nonInteractiveClass}${nestedUniqueSymbolClass}` }, index.h("div", { key: '71a9a54047a3880f8a800b5c5ada44bd44ddcd37', id: `${(_g = (_f = this.activeLayerInfo) === null || _f === void 0 ? void 0 : _f.layer) === null || _g === void 0 ? void 0 : _g.id}-legend-element-caption`, class: `${this.isRelationshipRamp || (!this.titleText && !this.zoomTo && singleSymbol) ? 'hide' : 'show'}` }, index.h("instant-apps-interactive-legend-legend-element-caption", { key: '3f4dedbe202011c88d80269e877de1a137985b04', ref: node => (this.legendLayerCaption = node), legendvm: this.legendvm, activeLayerInfo: this.activeLayerInfo, layer: this.activeLayerInfo.layer, titleText: this.titleText, legendElement: this.legendElement, legendElementIndex: this.legendElementIndex, zoomTo: this.zoomTo, isInteractive: this.isInteractive, messages: this.messages })), index.h("div", { key: "content", id: `${(_j = (_h = this.activeLayerInfo) === null || _h === void 0 ? void 0 : _h.layer) === null || _j === void 0 ? void 0 : _j.id}-legend-element-content-${this.legendElementIndex}`, class: `${expanded === false ? 'hide' : 'show'}` }, index.h("slot", { key: '8b402e2c6dbf5e657cb4518c95bb43220de0a68d', name: "content" }))));
    }
};
...
const InstantAppsInteractiveLegendLegendElementCaption = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.showAllSelectedEvent = index.createEvent(this, "showAllSelected", 7);
        this.legendLayerExpandUpdatedEvent = index.createEvent(this, "legendLayerExpandUpdated", 7);
        this.legendvm = undefined;
        this.activeLayerInfo = undefined;
    ...
    toggleExpanded() {
        return () => {
            ...
            if (relationshipRampElements.length > 0) {
                helpers.store.set('relationshipRampExpandStates', Object.assign(Object.assign({}, helpers.interactiveLegendState.relationshipRampExpandStates), { [this.activeLayerInfo.layer.id]: this.expanded }));
            }
        };
    }
    handleZoomTo() {
        return () => {
            const data = helpers.getIntLegendLayerData(this.layer);
            const nestedCategory = helpers.getParentLegendElementInfoData(data, this.legendElement);
            helpers.zoomTo(data, this.legendvm.view, nestedCategory);
        };
    }
    handleShowAll() {
        return () => {
            ...
            const handleNestedCategory = () => {
                const layerData = helpers.showAllNestedUniqueSymbol(data, this.legendElement.title);
                helpers.updateStore({ intLegendLayerData: layerData, layerId: this.layer.id });
            };
            const handleCategory = () => {
                const layerData = helpers.showAll(data);
                helpers.updateStore({ intLegendLayerData: layerData, layerId: this.layer.id });
            };
            const data = (_a = helpers.interactiveLegendState.data) === null || _a === void 0 ? void 0 : _a[(_b = this.layer) === null || _b === void 0 ? void 0 : _b.id];
            const nestedCategory = helpers.getParentLegendElementInfoData(data, this.legendElement);
            if (nestedCategory) {
...
const InstantAppsInteractiveLegendRelationship = class {
    ...
    showAllSelectedEmitted() {
        const cleared = helpers.interactiveLegendState.data[this.activeLayerInfo.layer.id].queryExpressions.length === 0;
    ...
    render() {
        var _a, _b;
        return (index.h("div", { key: '1f7588d95a9f87cd0d1574d2c8823e4fec7ff20a', ref: (node) => {
          ...
          `;
            ...
            } }, index.h("span", { key: 'a5c554b5bda46d827f60aba19f0e74ce5a81efe5', class: CSS.instructionalText }, (_b = (_a = this.messages) === null || _a === void 0 ? void 0 : _a.relationship) === null || _b === void 0 ? void 0 : _b.instructionalText), this.renderRelationshipRamp()));
    }
    renderRelationshipRamp() {
        ...
        return (index.h("div", { ref: (node) => {
                this.relationshipRamp = node;
                this.applyRelationshipRampInteractivity();
            }, key: "relationship-ramp-diamond", innerHTML: `${outerHTML}` }));
    }
    applyRelationshipRampInteractivity() {
        if (!this.relationshipRamp || !this.activeLayerInfo || !this.legendElement || !helpers.interactiveLegendState.data)
            return;
    ...
    async handleFilter(i, j, focus) {
        ...
        const { queryExpressions, fLayerView } = helpers.interactiveLegendState.data[this.activeLayerInfo.layer.id];
        if (this.legendElement.type === 'relationship-ramp' && authoringInfo && field1 && field2) {
            ...
            if (((_c = this.filterMode) === null || _c === void 0 ? void 0 : _c.type) === 'filter') {
                ...
                const mergedExcludedEffect = await helpers.getMergedEffect(excludedEffect, fLayerView, 'excludedEffect');
                const mergedIncludedEffect = await helpers.getMergedEffect(includedEffect, fLayerView, 'includedEffect');
...
exports.instant_apps_interactive_legend_group_legend_element = InstantAppsInteractiveLegendGroupLegendElement;
exports.instant_apps_interactive_legend_layer_element = InstantAppsInteractiveLegendLayerElement;
exports.instant_apps_interactive_legend_legend_element = InstantAppsInteractiveLegendLegendElement;
exports.instant_apps_interactive_legend_legend_element_caption = InstantAppsInteractiveLegendLegendElementCaption;
exports.instant_apps_interactive_legend_relationship = InstantAppsInteractiveLegendRelationship;
