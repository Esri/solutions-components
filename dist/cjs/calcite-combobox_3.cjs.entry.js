...
const resources$1 = require('./resources-eeda5acf.js');
...
const XButton = ({ disabled, key, label, scale, }) => (index.h("button", { "aria-label": label, class: CSS.button, disabled: disabled, key: key, tabIndex: -1, type: "button" }, index.h("calcite-icon", { icon: "x", scale: component.getIconScale(scale) })));
...
const Combobox = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7ff11391145f9d35bb29b79668ba4c71383399cb', onClick: this.comboboxFocusHandler }, index.h(interactive.InteractiveContainer, { key: '0f933e31620dcb729c99290edfa9c0d48ed8f3d0', disabled: this.disabled }, index.h("div", { key: '8b50c921f9f45393064744fa38874de7de82a228', "aria-live": "polite", class: {
                wrapper: true,
        ...
        ], index.h("label", { key: '07bc9e86da71217b892740f0748117f5bf1eacb3', class: "screen-readers-only", htmlFor: `${inputUidPrefix}${guid}`, id: `${labelUidPrefix}${guid}` }, label), this.renderInput()), !readOnly && isClearable ? (index.h(XButton, { disabled: this.disabled, key: "close-button", label: this.messages.clear, scale: this.scale })) : null, !readOnly && this.renderChevronIcon()), index.h("ul", { key: '5f367649d90d63c5cf88d097786c849430dc1e49', "aria-labelledby": `${labelUidPrefix}${guid}`, "aria-multiselectable": "true", class: "screen-readers-only", id: `${listboxUidPrefix}${guid}`, role: "listbox", tabIndex: -1 }, this.renderListBoxOptions()), this.renderFloatingUIContainer(), index.h(form.HiddenFormInputSlot, { key: '97f799527df82ab6def23e012663050e0156626a', component: this }), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, id: utils.IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
...
const DropdownGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f41943751aefdb17d4f5d5bd8778c219cfd01a00', "aria-label": this.groupTitle, role: "group" }, index.h("div", { key: '87b78040b93c06081ca8282a785d466ed8fcf334', class: {
                [resources$1.CSS.container]: true,
            } }, dropdownSeparator, groupTitle, index.h("slot", { key: 'f635a5bdbe439315eba6292a4858cbd8519d23d1' }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const MapLayerPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a876ec719aede5ec43af1b40f09e4c9e6b693f34' }, index.h("div", { key: '78e720facdf3c124208ff8dbde18a056234e63ac', class: "map-layer-picker-container", style: style }, index.h("div", { key: '6bb47ccb7c28565b140d79b6af6399a235e3ccf9', class: "map-layer-picker", style: style }, !this._hasValidLayers ? this._getInvalidPlaceholder() :
    ...
    _getItem(id, itemType) {
        ...
        return this.type === "combobox" ? (index.h("calcite-combobox-item", { disabled: disabled, selected: selected, textLabel: name, value: id })) :
            this.type === "select" ? (index.h("calcite-option", { disabled: disabled, label: name, selected: selected, value: id })) : (index.h("calcite-dropdown-group", { class: disabled ? "disabled" : "", selectionMode: disabled ? "none" : "single" }, index.h("calcite-dropdown-item", { disabled: itemType === 'table' && this.showTablesDisabled, "icon-start": itemType, onClick: disabled ? undefined : () => void this._setSelectedLayer(id), selected: selected }, name)));
    }
    /**
