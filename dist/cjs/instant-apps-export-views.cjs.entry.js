...
const InstantAppsExportViews = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '52f53735afba2085f45bdd8ba64e8e37b48318bb' }, index.h("div", { key: 'ac8fc3e66ccc5f9c27e25642bbe640c3fc8c7d33', class: this.baseClass, onMouseEnter: this.handleWidgetCreation.bind(this), onFocusin: this.handleWidgetCreation.bind(this) }, mode)));
    }
    renderPopover() {
        var _a, _b, _c;
