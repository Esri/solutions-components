...
const InstantAppsExportViews = class {
    constructor(hostRef) {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1b0428743837a0f1c176cba3e58af38104f4ac7b' }, index.h("div", { key: '8d39535015a0e5ab498a66c8757c28ae556bd326', class: this.baseClass, onMouseEnter: this.handleWidgetCreation.bind(this), onFocusin: this.handleWidgetCreation.bind(this) }, mode)));
    }
    renderPopover() {
        var _a, _b, _c;
        const panel = this.renderPanel();
        return [
            index.h("calcite-popover", { referenceElement: "export-popover-btn", label: (_a = this.messages) === null || _a === void 0 ? void 0 : _a.exportPopover, overlayPositioning: this.popoverPositioning, placement: this.popoverPlacement, autoClose: true, ref: (el) => (this.popoverEl = el) }, panel),
            index.h("calcite-action", { id: "export-popover-btn", alignment: "center", icon: this.popoverIcon, scale: this.scale, title: (_b = this.messages) === null || _b === void 0 ? void 0 : _b.exportBtn, text: (_c = this.messages) === null || _c === void 0 ? void 0 : _c.exportBtn }),
        ];
    }
    renderPanel() {
        var _a;
        ...
        return (index.h("div", { class: panelClass }, includeMap, options, index.h("calcite-button", { width: "full", onClick: this.exportOnClick.bind(this), disabled: this.exportIsLoading }, (_a = this.messages) === null || _a === void 0 ? void 0 : _a.export), print));
    }
    ...
    renderMapOptions() {
        ...
        return (index.h("div", null, includeHeader, includeLegend, includePopup));
    }
    renderPrint() {
        var _a;
        return (index.h("div", { ref: (el) => (this.printContainerEl = el) }, index.h("div", { class: CSS.print.base, ref: (el) => (this.printEl = el) }, index.h("div", { class: CSS.print.viewsContainer }, (_a = this.exportViews) === null || _a === void 0 ? void 0 : _a.map(({ title, view }, index$1) => {
            var _a, _b;
            const mapId = (_b = (_a = view.map) === null || _a === void 0 ? void 0 : _a.portalItem) === null || _b === void 0 ? void 0 : _b.id;
            const printMap = this.includeMap ? this.renderPrintMap(title, index$1) : null;
            const legend = this.includeMap && this.showIncludeLegend ? this.renderLegend(index$1) : null;
            const popup = this.includeMap && this.showIncludePopup ? this.renderPopup(index$1) : null;
            return (index.h("div", { key: mapId, id: `print-${index$1}`, class: CSS.print.viewContent }, printMap, legend, popup));
        })))));
    }
    renderPrintMap(title, index$1) {
        return (index.h("div", { id: `view-container-${index$1}`, class: CSS.print.viewContainer }, index.h("div", { id: `view-wrapper-${index$1}`, class: CSS.print.viewWrapper }, this.includeHeader && title ? (index.h("div", { class: CSS.print.viewHeader }, index.h("h1", null, title))) : null, index.h("img", { id: `view-${index$1}`, class: CSS.print.view }), index.h("div", { id: `scalebar-container-${index$1}`, class: CSS.print.scaleBarContainer }))));
    }
    renderLegend(index$1) {
        return index.h("div", { id: `legend-${index$1}`, class: CSS.print.legendContainer });
    }
    renderCompass(index$1) {
        return index.h("div", { id: `compass-${index$1}`, class: CSS.print.compassContainer });
    }
    renderPopup(index$1) {
        return (index.h("div", { id: `popup-${index$1}`, class: CSS.print.popupContainer }, index.h("div", { id: `popup-title-${index$1}`, class: CSS.print.popupTitle }), index.h("div", { id: `popup-content-${index$1}`, class: CSS.print.popupContent })));
    }
    optionOnChange(e) {
    ...
    async updateLegend(view, index, legendContainerEl) {
        view === null || view === void 0 ? void 0 : view.when(async (view) => {
            if (this.legends[index] == null && legendContainerEl != null) {
                ...
                const [Legend] = await loadModules.loadModules(['esri/widgets/Legend']);
    ...
    updateCompass(view, index, compassContainerEl) {
        view === null || view === void 0 ? void 0 : view.when(async (view) => {
            ...
            const [Compass] = await loadModules.loadModules(['esri/widgets/Compass']);
...
InstantAppsExportViews.style = InstantAppsExportViewsStyle0;

exports.instant_apps_export_views = InstantAppsExportViews;
