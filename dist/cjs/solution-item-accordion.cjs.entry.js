...
const SolutionItemAccordion = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '9a940187b8b91f94346f51cd67cb3c9fd2d8f470' }, this._getAccordion()));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
     ...
     */
    _getAccordion() {
        return (index.h("calcite-accordion", { selectionMode: "single" }, this._sortedTemplateInfos.reduce((prev, cur) => {
    ...
    _getAccordionItem(templateInfo) {
        ...
        return (index.h("calcite-accordion-item", { description: `${_type} (${templateInfos.length})` }, index.h("solution-item-icon", { class: "padding-start-1", slot: "actions-start", type: templateInfo.type, typeKeywords: templateInfo.typeKeywords }), this._getList(templateInfos)));
    }
    /**
...
exports.solution_item_accordion = SolutionItemAccordion;
