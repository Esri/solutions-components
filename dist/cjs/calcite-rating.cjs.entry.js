...
const Rating = class {
  ...
  renderStars() {
    return [1, 2, 3, 4, 5].map((i) => {
      ...
      return (index.h("span", { class: { wrapper: true } }, index.h("label", { class: { star: true, focused, selected, average, hovered, partial }, htmlFor: `${this.guid}-${i}`, onPointerOver: () => {
          this.hoverValue = i;
