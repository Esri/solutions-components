...
const Stepper = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cf7174442aa44f3a2bd72893900a60bcbf7e1d5e', "aria-label": this.messages.label, role: "region" }, index.h("div", { key: '1036b66baff637f74ca2296c725f8ec091955c55', class: { container: true, [CSS$1.singleView]: this.layout === "horizontal-single" }, ref: this.setContainerEl }, this.layout === "horizontal-single" && (index.h("div", { key: '2ebc80f63ea8938538630181ac165712ce645b69', class: { [CSS$1.stepBarContainer]: true } }, this.items.map((item, index$1) => (index.h(StepBar, { active: index$1 === this.currentActivePosition, complete: item.complete && index$1 !== this.currentActivePosition && !item.error, disabled: item.disabled && index$1 !== this.currentActivePosition, error: item.error && index$1 !== this.currentActivePosition, key: index$1 }))))), this.layout === "horizontal-single" && (index.h("div", { key: 'c471f0b44071da745850a7a5910894f27eccce02', class: { [CSS$1.actionContainer]: true } }, this.renderAction("start"), this.renderAction("end"))), index.h("slot", { key: 'd7f6599abe59d4ed86e0deefe991a3556fe3e270', onSlotchange: this.handleDefaultSlotChange }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
