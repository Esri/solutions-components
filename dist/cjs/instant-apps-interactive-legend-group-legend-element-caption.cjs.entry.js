...
const InstantAppsInteractiveLegendGroupLegendElementCaption = class {
    ...
    render() {
        ...
        return (index.h("header", { key: '09f5ee7f348855813f75b775b87f2f9de12e3792', class: `${CSS.interacitveLegendHeader} ${helpers.getTheme(this.el)}`, style: {
                borderLeft: '1px solid var(--calcite-color-border-3)',
            } }, index.h("span", { key: '2a720ba9d488b06550ed955d84a150501aa03a2f' }, index.h("span", { key: '17c9b3a7e76ad853844d1c4cdbfd4aa74470a524', class: CSS.headerActionContainer }, index.h("calcite-action", { key: '7bc8909822ef97fe40721b80ce062abf93d825db', onClick: this.toggleExpanded(), icon: expanded ? 'chevron-down' : 'chevron-up', appearance: "transparent", text: expandCollapseText, label: expandCollapseText, scale: "s" }), index.h("h3", { key: '0a30cf8669b622aeb47c595f30df3a26202c5111', class: `${CSS.header} ${CSS.label}${isChild}`, title: (_c = this.activeLayerInfo) === null || _c === void 0 ? void 0 : _c.title }, (_d = this.activeLayerInfo) === null || _d === void 0 ? void 0 : _d.title)), this.featureCount && isInteractive ? (index.h("instant-apps-interactive-legend-count", { activeLayerInfo: this.activeLayerInfo, "show-total": true, messages: this.messages, legendvm: this.legendvm })) : null)));
    }
    toggleExpanded() {
        return () => {
