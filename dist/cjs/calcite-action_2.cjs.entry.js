...
const Loader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b84a28c551e2484735b2cb7bad89a7a1d608fe13', "aria-label": label, id: id, role: "progressbar", ...(isDeterminate ? hostAttributes : {}) }, index.h("div", { key: '7ea0d6f2a742c8950cff2196bc454cc8ec3be037', class: CSS.loaderParts }, [1, 2, 3].map((index$1) => (index.h("svg", { "aria-hidden": "true", class: {
                [CSS.loaderPart]: true,
                [CSS.loaderPartId(index$1)]: true,
            }, key: index$1, viewBox: viewbox, ...(index$1 === 3 && isDeterminate ? { style: determinateStyle } : {}) }, index.h("circle", { ...svgAttributes })))), isDeterminate && index.h("div", { key: '2732fc9cbbaade638eb6241776b2aecea6177ed5', class: CSS.loaderPercentage }, this.formatValue())), text && index.h("div", { key: '5050af5bb4d979e4f83ac997f0f98aa69be86f52', class: CSS.loaderText }, text)));
    }
