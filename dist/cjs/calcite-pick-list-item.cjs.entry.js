...
const resources$1 = require('./resources-7aaf489b.js');
...
const PickListItem = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: '34b2a65973c42d095c5ea0ca712afedaa58c5b63', disabled: this.disabled }, this.renderIcon(), this.renderActionsStart(), index.h("label", { key: '25476cd75bc12bebcbb7d52dc7fb19c268cf48bf', "aria-label": label, class: resources$1.CSS.label, onClick: this.pickListClickHandler, onKeyDown: this.pickListKeyDownHandler, ref: (focusEl) => (this.focusEl = focusEl), tabIndex: 0 }, index.h("div", { key: '2d619c384030ea848bea3f7d1b9d49afcad597ee', "aria-checked": dom.toAriaBoolean(this.selected), class: resources$1.CSS.textContainer, role: "menuitemcheckbox" }, index.h("span", { key: '667ae09cd87763d99a76bfaddc715192cd8f72c4', class: resources$1.CSS.title }, label), description ? index.h("span", { class: resources$1.CSS.description }, description) : null)), this.renderActionsEnd()));
    }
