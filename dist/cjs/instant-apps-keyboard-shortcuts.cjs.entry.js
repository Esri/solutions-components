...
const InstantAppsKeyboardShortcuts = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("calcite-block", { open: true, class: `${CSS.content}`, heading: (_c = (_b = this === null || this === void 0 ? void 0 : this.messages) === null || _b === void 0 ? void 0 : _b.generalShortcuts) === null || _c === void 0 ? void 0 : _c.label }, index.h("table", null, this.renderTableHeader(), index.h("tr", null, index.h("td", null, `${modifierKey} + M`), index.h("td", null, (_e = (_d = this === null || this === void 0 ? void 0 : this.messages) === null || _d === void 0 ? void 0 : _d.generalShortcuts) === null || _e === void 0 ? void 0 : _e.title))), index.h("calcite-label", null, (_g = (_f = this === null || this === void 0 ? void 0 : this.messages) === null || _f === void 0 ? void 0 : _f.generalShortcuts) === null || _g === void 0 ? void 0 : _g.title), index.h("table", null, this.renderTableHeader(), commands.map(command => {
