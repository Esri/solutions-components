...
const InstantAppsLanguageSwitcher = class {
    ...
    async componentWillLoad() {
        ...
        try {
            this.portalItemResource = (await languageSwitcher.getPortalItemResource(this.portalItem));
            const t9nData = await languageSwitcher.fetchResourceData(request, this.portalItemResource);
    ...
    async refresh() {
        try {
            const resource = (await languageSwitcher.getPortalItemResource(this.portalItem));
            const t9nData = await languageSwitcher.fetchResourceData(this.request, resource);
