...
const index$1 = require('./index-5f864f65.js');
...
const InstantAppsHeader = class {
    constructor(hostRef) {
        ...
        this.infoIsOpenChanged = index.createEvent(this, "infoIsOpenChanged", 6);
        this._sanitizer = new index$1.Sanitizer({
            whiteList: {
                h1: ['style'],
                h2: ['style'],
                h3: ['style'],
        ...
        this.mobileWidthBreakpoint = breakpoints.widthBreakpoints.medium[1];
        this.initialScale = 'm';
    }
    ...
    componentWillLoad() {
        this.dir = languageUtil.getElementDir(this.el);
    ...
    renderTitle() {
        return this.titleText && this.titleTextLink ? (index.h("a", { style: { color: this.textColor }, href: `${this.titleTextLink}`, rel: "noopener noreferrer", target: "_blank" }, index.h("h1", { style: { color: this.textColor } }, this.titleText))) : (index.h("h1", { style: { color: this.textColor } }, this.titleText));
    }
    toggleInfo() {
