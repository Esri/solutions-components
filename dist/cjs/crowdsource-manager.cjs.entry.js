...
const CrowdsourceManager = class {
    ...
    _getBody(layoutMode, panelOpen, hideTable) {
        ...
        return (index.h("calcite-panel", { class: "width-full height-full position-absolute" }, index.h("div", { class: `width-full height-full overflow-hidden ${contentClass}` }, this._getMapAndCard(layoutMode, panelOpen, hideTable), this._getTable(layoutMode, panelOpen, hideTable)), this.coverPageEnabled &&
   ...
   */
    ...
    _getPopupExpandNode() {
        ...
        return (index.h("div", { class: `${headerTheme} ${popupNodeClass} ${containerClass} ${tableViewClass} position-sticky`, style: {
            ...
            } }, index.h("calcite-panel", null, (!this._isPortraitMobile && this._showInformationHeader) || (this._numSelected > 0 && !this._isPortraitMobile) ? (index.h("div", { class: `display-flex align-items-center ${headerClass}`, slot: "header-content" }, index.h("calcite-icon", { icon: "information", scale: "s" }), index.h("div", { class: "padding-inline-start-75" }, this._translations.information))) : index.h("div", null), this._getCardNode())));
    }
    /**
     * Get the card node
     *
    ...
    _onResize() {
        ...
        this._layoutMode = this._isPortraitMobile ? interfaces.ELayoutMode.HORIZONTAL : interfaces.ELayoutMode.GRID;
    }
    /**
