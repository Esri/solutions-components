...
const CrowdsourceManager = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0abfec918880517059451fe7a8c1a321dd4a4136' }, index.h("calcite-shell", { key: '3be18a3470f15539a74b7b0d3359ebed9d0e56b4', class: "position-relative" }, index.h("calcite-panel", { key: '8d5df3c949d140945f39bea9bc2a02b06b6ba41c', class: `width-full height-full ${borderClass}` }, this._getBody(this._layoutMode, this._panelOpen, this._hideTable)), this._getFooter()), this._filterModal()));
    }
    /**
