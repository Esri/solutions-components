...
async function createInteractiveLegendDataForLayer(legendViewModel, activeLayerInfo, reactiveUtils) {
  ...
  try {
    ...
    const field = (_g = fLayer.renderer) === null || _g === void 0 ? void 0 : _g.get('field');
...
function checkPredominance(fLayerView) {
  const authoringInfoType = fLayerView === null || fLayerView === void 0 ? void 0 : fLayerView.get('layer.renderer.authoringInfo.type');
...
function validateInteractivity(activeLayerInfo, legendElement, legendElementIndex) {
  ...
  const layerView = activeLayerInfo.get('layerView');
  const classBreakInfos = layerView === null || layerView === void 0 ? void 0 : layerView.get('layer.renderer.classBreakInfos');
  const uniqueValueInfos = (layerView === null || layerView === void 0 ? void 0 : layerView.get('layer.renderer.uniqueValueInfos')) && field;
  ...
  const authoringInfoType = layerView === null || layerView === void 0 ? void 0 : layerView.get('layer.renderer.authoringInfo.type');
  ...
  const singleSymbol = ((_b = legendElement === null || legendElement === void 0 ? void 0 : legendElement.infos) === null || _b === void 0 ? void 0 : _b.length) === 1 && !field;
  ...
  const isFeatureLayer = (activeLayerInfo === null || activeLayerInfo === void 0 ? void 0 : activeLayerInfo.get('layer.type')) === 'feature';
  ...
  const validate = oneClassBreak ||
    ...
    ? true
    : false;
  const hasClustering = (activeLayerInfo === null || activeLayerInfo === void 0 ? void 0 : activeLayerInfo.get('layer.featureReduction')) && ((_c = activeLayerInfo === null || activeLayerInfo === void 0 ? void 0 : activeLayerInfo.legendElements[legendElementIndex]) === null || _c === void 0 ? void 0 : _c.type) === 'size-ramp';
  const isSingleSymbol = (legendElement === null || legendElement === void 0 ? void 0 : legendElement.type) === 'symbol-table' && ((_d = legendElement === null || legendElement === void 0 ? void 0 : legendElement.infos) === null || _d === void 0 ? void 0 : _d.length) === 1;
  ...
  const isUnclassifiedSizeRamp = (_e = legendElement === null || legendElement === void 0 ? void 0 : legendElement.infos) === null || _e === void 0 ? void 0 : _e.every(info => typeof info.value === 'number');
  const isBinning = ((_g = (_f = activeLayerInfo === null || activeLayerInfo === void 0 ? void 0 : activeLayerInfo.legendElements) === null || _f === void 0 ? void 0 : _f[0]) === null || _g === void 0 ? void 0 : _g.type) === 'symbol-table' && ((_j = (_h = activeLayerInfo === null || activeLayerInfo === void 0 ? void 0 : activeLayerInfo.legendElements) === null || _h === void 0 ? void 0 : _h[1]) === null || _j === void 0 ? void 0 : _j.type) === 'color-ramp';
  const isDotDensity = authoringInfoType === 'dot-density';
  const isValidated = isFeatureLayer && !hasClustering && !opacityRamp && !heatmapRamp && !singleSymbolColor && !singleSymbolSize && !isUnclassifiedSizeRamp && !isBinning && !isDotDensity
    ? classBreakInfos
...
async function zoomTo(data, view, nestedCategory) {
  ...
  try {
    const geometry = await ((_b = (_a = data === null || data === void 0 ? void 0 : data.fLayerView) === null || _a === void 0 ? void 0 : _a.layer) === null || _b === void 0 ? void 0 : _b.queryExtent(query));
...
async function handleFeatureCount(legendViewModel, data) {
  ...
  activeLayerInfos.forEach(async (activeLayerInfo) => {
    ...
    const field = (_c = fLayer.renderer) === null || _c === void 0 ? void 0 : _c.get('field');
    const counts = [];
...
function updateStore(layerData) {
  if (layerData.layerId && layerData.intLegendLayerData) {
    ...
    store.set('data', Object.assign(Object.assign({}, interactiveLegendState.data), { [layerId]: layerDataToSet }));
  }
}
...
function updateExistingFilterToFeatureEffect(filterMode, view) {
  ...
  (_a = view === null || view === void 0 ? void 0 : view.allLayerViews) === null || _a === void 0 ? void 0 : _a.filter((layerView) => { var _a; return ((_a = layerView === null || layerView === void 0 ? void 0 : layerView.layer) === null || _a === void 0 ? void 0 : _a.type) === 'feature'; }).forEach(async (fLayerView) => {
    if ((filterMode === null || filterMode === void 0 ? void 0 : filterMode.effect) && fLayerView) {
      const [FeatureEffect] = await loadModules.loadModules(['esri/layers/support/FeatureEffect']);
      const { includedEffect, excludedEffect } = filterMode.effect;
      const mergedExcludedEffect = await getMergedEffect(excludedEffect, fLayerView, 'excludedEffect');
      const mergedIncludedEffect = await getMergedEffect(includedEffect, fLayerView, 'includedEffect');
      const existingFilter = getExistingFilter(fLayerView);
...
exports.calculateTotalCount = calculateTotalCount;
exports.calculateTotalFeatureCountForNestedSymbols = calculateTotalFeatureCountForNestedSymbols;
exports.checkNestedUniqueSymbol = checkNestedUniqueSymbol;
exports.checkNestedUniqueSymbolLegendElement = checkNestedUniqueSymbolLegendElement;
exports.checkNoneSelected = checkNoneSelected;
exports.checkRelationshipRamp = checkRelationshipRamp;
exports.createInteractiveLegendDataForLayer = createInteractiveLegendDataForLayer;
exports.generateData = generateData;
exports.getCategoriesArray = getCategoriesArray;
exports.getCategoryData = getCategoryData;
exports.getIntLegendLayerData = getIntLegendLayerData;
exports.getMergedEffect = getMergedEffect;
exports.getNestedInfoData = getNestedInfoData;
exports.getParentLegendElementInfoData = getParentLegendElementInfoData;
exports.getTheme = getTheme;
exports.handleFeatureCount = handleFeatureCount;
exports.handleFilter = handleFilter;
exports.handleFilterChange = handleFilterChange;
exports.interactiveLegendState = interactiveLegendState;
exports.showAll = showAll;
exports.showAllNestedUniqueSymbol = showAllNestedUniqueSymbol;
exports.store = store;
exports.updateStore = updateStore;
exports.validateInteractivity = validateInteractivity;
