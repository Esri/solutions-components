...
const InstantAppsMeasurement = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, null, index.h("calcite-panel", { heading: (_a = this === null || this === void 0 ? void 0 : this.messages) === null || _a === void 0 ? void 0 : _a.label, closable: this.closable }, index.h("div", null, this.renderActionPad()), this.renderMeasureToolPanel())));
    }
