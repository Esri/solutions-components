...
const solutionStore = require('./solution-store-a3bee2a2.js');
...
const ShellPanel = class {
  constructor(hostRef) {
    ...
    this.calciteShellPanelToggle = index.createEvent(this, "calciteShellPanelToggle", 6);
    // --------------------------------------------------------------------------
    //
    //  Properties
    //
  ...
  renderHeader() {
    ...
    return hasHeader ? (index.h("div", { class: CSS$1.contentHeader, key: "header" }, index.h("slot", { name: SLOTS$2.header }))) : null;
  }
  render() {
    ...
    const contentNode = (index.h("div", { class: { [CSS$1.content]: true, [CSS$1.contentDetached]: detached }, hidden: collapsed, key: "content", ref: this.storeContentEl, style: allowResizing && contentWidth ? { width: `${contentWidth}px` } : null }, this.renderHeader(), index.h("div", { class: CSS$1.contentBody }, index.h("slot", null))));
    ...
    return index.h("div", { class: { [CSS$1.container]: true } }, mainNodes);
  }
  // --------------------------------------------------------------------------
  //
  //  private Methods
...
const Tabs = class {
  ...
  //--------------------------------------------------------------------------
  render() {
    return (index.h(index.Fragment, null, index.h("slot", { name: SLOTS$1.tabNav }), index.h("section", null, index.h("slot", null))));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
