...
const resources$2 = require('./resources-1d88e9d6.js');
const resources$1 = require('./resources-baef554d.js');
const locale$1 = require('./locale-3d0a4bc2.js');
const solutionStore = require('./solution-store-67bcf552.js');
const interfaces = require('./interfaces-7cd0a48a.js');
const solutionResource = require('./solution-resource-97186521.js');
...
require('./restHelpersGet-2ed729ab.js');
...
const ShellPanel = class {
    constructor(hostRef) {
        ...
        this.connectSeparator = (separatorEl) => {
            ...
            separatorEl === null || separatorEl === void 0 ? void 0 : separatorEl.addEventListener("pointerdown", this.separatorPointerDown);
        };
        this.disconnectSeparator = () => {
            var _a;
    ...
    render() {
        ...
        const separatorNode = !collapsed && allowResizing ? (index.h("div", { "aria-label": this.messages.resize, "aria-orientation": layout === "horizontal" ? "vertical" : "horizontal", "aria-valuemax": layout == "horizontal" ? contentHeightMax : contentWidthMax, "aria-valuemin": layout == "horizontal" ? contentHeightMin : contentWidthMin, "aria-valuenow": layout == "horizontal"
                ...
                : contentWidth !== null && contentWidth !== void 0 ? contentWidth : initialContentWidth, class: CSS$4.separator, key: "separator", onKeyDown: this.separatorKeyDown, role: "separator", tabIndex: 0, "touch-action": "none",
        ...
        const contentNode = (index.h("div", { class: {
                ...
                [CSS$4.contentFloat]: displayMode === "float",
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.storeContentEl }, this.renderHeader(), index.h("div", { class: CSS$4.contentBody }, index.h("slot", null)), separatorNode));
        ...
        return index.h("div", { class: { [CSS$4.container]: true } }, mainNodes);
    }
    // --------------------------------------------------------------------------
    //
    //  private Methods
...
const Tab = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { "aria-labelledby": this.labeledBy, id: id }, index.h("div", { class: { [CSS$3.container]: true, [`scale-${this.scale}`]: true }, role: "tabpanel", tabIndex: this.selected ? 0 : -1 }, index.h("section", { class: CSS$3.content }, index.h("slot", null)))));
    }
    connectedCallback() {
...
const TabTitle = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { class: { [CSS$1.titleIcon]: true, [CSS$1.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: component.getIconScale(this.scale) }));
        const iconEndEl = (index.h("calcite-icon", { class: { [CSS$1.titleIcon]: true, [CSS$1.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: component.getIconScale(this.scale) }));
        return (index.h(index.Host, { "aria-controls": this.controls, "aria-selected": dom.toAriaBoolean(this.selected), id: id, role: "tab", tabIndex: this.selected && !this.disabled ? 0 : -1 }, index.h(interactive.InteractiveContainer, { disabled: this.disabled }, index.h("div", { class: {
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => { var _a; return (_a = this.resizeObserver) === null || _a === void 0 ? void 0 : _a.observe(el); } }, index.h("div", { class: { [CSS$1.content]: true, [CSS$1.contentHasText]: this.hasText } }, this.iconStart ? iconStartEl : null, index.h("slot", null), this.iconEnd ? iconEndEl : null), this.renderCloseButton()))));
    }
    renderCloseButton() {
        const { closable, messages } = this;
        return closable ? (index.h("button", { "aria-label": messages.close, class: CSS$1.closeButton, disabled: false, key: CSS$1.closeButton, onClick: this.closeClickHandler, title: messages.close, type: "button",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.closeButtonEl = el) }, index.h("calcite-icon", { icon: ICONS$1.close, scale: component.getIconScale(this.scale) }))) : null;
    }
...
const ValueListItem = class {
    ...
    async setFocus() {
        var _a;
        await loadable.componentFocusable(this);
        return (_a = this.pickListItem) === null || _a === void 0 ? void 0 : _a.setFocus();
    }
    calciteListItemChangeHandler(event) {
