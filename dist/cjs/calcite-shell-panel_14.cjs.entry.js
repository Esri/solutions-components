...
const JsonEditor = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '2837e36dbd0f853f8e90423032c1a41ef9a308a7' }, index.h("div", { key: 'b52d703957beaf3f594caff502bfb8fe22fde00d', id: `${this.instanceid}-editor-container`, class: "editor-container padding-right" }, index.h("div", { key: '7f981a93a6099074759ade8dde0cb988318cf7b2', class: "editor-controls" }, index.h("div", { key: '843bcd23697cec929fa3d1baaacca4a177f69c7b', class: "editor-buttons" }, index.h("calcite-icon", { key: 'd51c74ed089a297c2bec0be2834c2aeda40356ac', id: `${this.instanceid}-errorFlag`, icon: "exclamation-mark-triangle", title: this._translations.errorFlag, scale: "s", class: "edit-error-flag" }), index.h("calcite-button", { key: 'ffbbaf222b6a28dc670d74330ec17a39d6925850', id: `${this.instanceid}-undo`, color: "blue", appearance: "solid", title: this._translations.undo, onClick: () => this._undo(), scale: "s", class: "edit-button" }, index.h("calcite-icon", { key: '50ce52a201dbe69d51f983b392a33a709aa84e69', icon: "undo", scale: "s" })), index.h("calcite-button", { key: '8ef640d273d9723dd5acc93158a60fad8d34e63f', id: `${this.instanceid}-redo`, color: "blue", appearance: "solid", title: this._translations.redo, onClick: () => this._redo(), scale: "s", class: "edit-button" }, index.h("calcite-icon", { key: '5e39cd7d607947431cc4bed50ba42433d26c062b', icon: "redo", scale: "s" })), index.h("calcite-button", { key: 'b90d5aded295212c82f68dcc1ec6232684504812', id: `${this.instanceid}-diff`, color: "blue", appearance: "solid", title: this._translations.diff, onClick: () => this._toggleEditor(), scale: "s", class: "edit-button" }, index.h("calcite-icon", { key: '4394c732ad16fd4fa8ab123c00e8933ff102d404', icon: "compare", scale: "s" })), index.h("calcite-button", { key: 'e95cb0c5f565240b131910aafefc3c5abb881737', id: `${this.instanceid}-search`, appearance: "outline", color: "blue", title: this._translations.search, onClick: () => this._search(), scale: "s", class: "edit-button" }, index.h("calcite-icon", { key: '70d3a36613e3b3777c2fe0a7ff55c18f4cf5b294', icon: "search", scale: "s" })), index.h("calcite-button", { key: 'a1247a17de35889ff1e79dc6b5c622ba7a872e41', id: `${this.instanceid}-reset`, color: "blue", appearance: "solid", disabled: true, title: this._translations.cancelEdits, onClick: () => this._reset(), scale: "s", class: "edit-button" }, index.h("calcite-icon", { key: '69fef27e172dad30365b01c755e0d13b894fc086', icon: "reset", scale: "s" })))), index.h("div", { key: '3cd8f5cef24598814e72499d71a1f0f77f4d989d', class: "edit-parent" }, index.h("div", { key: '465132b6c06c959fff63d14e593751973558622d', id: `${this.instanceid}-container`, class: "json-edit-container" }), index.h("div", { key: '42c5db0bf86cbe07feea1f4362752376db620498', id: `${this.instanceid}-diff-container`, class: "json-edit-container display-none" })))));
    }
    //--------------------------------------------------------------------------
    //
...
const SolutionItemDetails = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '8bbaae72e79226d287c33a6cc0945344707e0987' }, index.h("div", { key: '6836de1161eb31305af007f96265ef7501ff541c', class: "parent-container" }, index.h("div", { key: '355100a14f3ad3428c152eda17b9ecaf246d379f', class: "inputBottomSeparation" }, index.h("calcite-input", { key: 'b482414e952890e50191f4480a078a24db30b623', id: "item-title", value: this.itemDetails.title })), index.h("div", { key: '8fcd980eeab23e6d78a33bbb6750f5d70b2c1a13', class: "inputBottomSeparation" }, index.h("input", { key: '1702f46cf552f3f37f668382ad706748b1d8f7ad', accept: ".jpg,.gif,.png,image/jpg,image/gif,image/png", class: "display-none", onChange: (event) => (this._updateThumbnail(event)), ref: (el) => (this.browseForThumbnail = el), type: "file" }), index.h("button", { key: '6df15b3290788c84f58edda6d01ec22eb9e36a9a', class: "font-size--3 btn-link inline-block trailer-quarter", onClick: () => this._getThumbnail() }, index.h("svg", { key: '8169d5c98f632be94f7069eb204cc4b2c5159221', class: "icon-inline icon-inline--on-left", height: "16", viewBox: "0 0 16 16", width: "16" }, index.h("path", { key: '578094ee1e523cfaacecdab56793a219b260d1a7', d: "M14.792 2.666l-1.414-1.413a.965.965 0 0 0-1.385-.03l-1.444 1.444-8.763 8.72L.03 15.481a.371.371 0 0 0 .488.488l4.096-1.756 8.763-8.72-.001-.001.002.002 1.443-1.444a.965.965 0 0 0-.03-1.385zM1.569 14.431l.554-1.293.74.739zm2.338-.924l-1.414-1.414 7.963-7.92 1.414 1.415zm8.67-8.626l-1.413-1.414 1.29-1.29a.306.306 0 0 1 .433 0l.981.98a.306.306 0 0 1 0 .433z" })), this._translations.editThumbnail), index.h("div", { key: '8c4faf6d86712104387259c726c3fac6e6d6b10d', class: "flex" }, index.h("div", { key: '93d0f7b46c78ec30d46f7bc33b615836969d3f46', class: "img-container", ref: (el) => (this.thumbnailContainer = el) }, index.h("img", { key: 'd69a1331009d7d93acd3879ef80f5095ed6cdd0c', class: "scale-down", height: "133", id: "item-thumbnail", ref: (el) => (this.thumbnail = el), width: "200" })), index.h("div", { key: 'd191b1d72c04c81b8169253864af9b8ebb1c9602', class: "snippet-count-container" }, index.h("calcite-input", { key: 'f5515ddad63ea215d50f960277362c85836f7b8a', id: "item-snippet", maxLength: 250, type: "textarea", value: this.itemDetails.snippet }), index.h("label", { key: 'e02b85f8f62e7bd07d0648618887ca6e092446f2', class: "font-size--3", id: "item-snippet-count", ref: (el) => (this.itemSnippetCount = el) })))), index.h("calcite-label", { key: '04b42de584350140b65442cecd45930436bdef41' }, this._translations.description, index.h("label", { key: '2e46c44aaeb2480d72d38ee84316c3c2943fb366', id: "item-description-label" }, index.h("calcite-input", { key: 'b59b9c07bdd8712821cf552df4b2ffaeba24f749', id: "item-description", type: "textarea", value: this.itemDetails.description }))), index.h("calcite-label", { key: '24c52f549286a48bd156bcecafb4518fe09b33c0' }, this._translations.tags, index.h("label", { key: 'ed635dc95fb4d607a0d41debf5959debfbaa3139', id: "item-tags-label" }, index.h("calcite-input", { key: '6986aad2783942210f759f3573c52450c2d63c7c', id: "item-tags", value: (this.itemDetails.tags && Array.isArray(this.itemDetails.tags) ? this.itemDetails.tags : [this.itemDetails.tags]).join(",") }))), this.itemType !== "Group" ? index.h("calcite-label", null, this._translations.credits, index.h("label", { id: "item-credits-label" }, index.h("calcite-input", { id: "item-credits", value: this.itemDetails.accessInformation }))) : null, this.itemType !== "Group" ? index.h("calcite-label", null, index.h("label", { id: "item-terms-label" }, this._translations.termsOfUse, index.h("calcite-input", { id: "item-terms", type: "textarea", value: this.itemDetails.licenseInfo }))) : null)));
    }
    componentDidRender() {
        this._loadThumb();
    }
...
const SolutionItemSharing = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '211d5e7096e178ab077f63e7ee9289e1d286a4aa' }, index.h("div", { key: '191aad2e7c72134349364fbf1020aaf2b104be09', class: "container-border" }, index.h("calcite-label", { key: '590768adecc53b99c73293a118c8f7d7e63b4acb' }, this._translations.groupInfo), this._renderItems(this.sharing))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const SolutionOrganizationVariables = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '587896d0bc46f7af3414d51eca75626deb25c128' }, index.h("div", { key: '8377fc249d3769106f11666649cf7e70e6388553' }, index.h("h4", { key: 'c21c1242a68809f10a3c3297957a3767ef57d69f', class: "org-var-header" }, this._translations.orgVariables)), index.h("div", { key: '1d53770ddf75cf7a2475c3584092599103c2148d', class: "container-border" }, index.h("calcite-tree", { key: '48857da7785529abd0a8574e8f08964199313c81', id: "variable-label" }, this._renderHierarchy(this._organizationVariables)))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const SolutionResourceItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '31f5090ac98fc122b9ff55433fbfdf6cf9cf4021' }, index.h("div", { key: 'db3e91e5bf116cc61a2a1a48b2fa75301879cc6b', class: "resource-item" }, index.h("div", { key: '67e394b7011d37970932ca8660e2c85e0ef80a51', class: "margin-bottom-1" }, index.h("calcite-button", { key: '36ea4dc882a41043dbb3ebeb51be65cbb85d4cdd', appearance: "solid", class: "resource-button", color: "blue", onClick: () => this._addNewResource() }, this._translations.addResource), index.h("calcite-button", { key: '50b428bb2a75199bcfcb9d698c71faefabc3cbcc', appearance: "solid", color: "blue", disabled: !hasValidResources, onClick: () => this._downloadAll() }, this._translations.downloadAll)), index.h("div", { key: 'd12a8adbd0f9555536bca1e5c94585c3adf9279d', class: "resources-container", style: { display: hasValidResources ? "inherit" : "none" } }, this._renderResourceList()))));
    }
    _removedResources = {};
    //--------------------------------------------------------------------------
    //
...
const SolutionTemplateData = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '719601ce314da8b957f2eebb7c4a05489ae14d0e' }, index.h("div", { key: 'e712c532d0568494ae3dce6d08bfbb11d260fabb', class: "solution-data-container" }, index.h("calcite-shell", { key: '782031ce7fdf79fb51197988145524a5846e8388', class: "light var-container", dir: "ltr" }, index.h("calcite-panel", { key: '945a9f91f45e70279eea5f765fe76f2e835a4520', class: "json-editor" }, index.h("div", { key: '306980a78f84ba3ff3694314d5da9e1ced288f10', class: "solution-data-child-container calcite-match-height" }, index.h("json-editor", { key: 'df02c424a6abe7ca96e85063e947a072a8a147f3', class: "solution-data-editor-container", instanceid: this.itemId + "|" + this.instanceid, value: this.value }))), index.h("calcite-shell-panel", { key: '1dc03b9cdedecafa5393a9ae39767311618c697b', "height-scale": "l", position: "end", slot: "contextual-panel", "width-scale": "xs" }, index.h("div", { key: 'c860608f30e60529d990f10077aef88af7f97d18', class: this.varsOpen ? "solution-data-child-container" : "solution-data-child-container-collapsed" }, index.h("calcite-button", { key: '6a73213cbd8f5741434fa3ac6bf40c6912432a15', appearance: "transparent", class: "collapse-btn", "icon-start": this.varsOpen ? "chevrons-right" : "chevrons-left", id: "collapse-vars", onClick: () => this._toggleVars(), scale: "s", title: this.varsOpen ? this._translations.collapse : this._translations.expand }), index.h("div", { key: '9c343fe75a40e017ea8f63a3e0a2417ef444a319', class: this.varsOpen ? "org-vars" : "org-vars display-none", id: "orgVars" }, index.h("solution-organization-variables", { key: '5138e9cba2e3ad4ea9df59c0e2e74fbba2dc01be', value: this.organizationVariables })), index.h("div", { key: '402a0a71056acc4214f2376c5f64e7971322bf55', class: this.varsOpen ? "sol-vars" : "sol-vars display-none", id: "solVars" }, index.h("solution-variables", { key: '68753d13ad8ca0087359e371a11a0755ea43ebac', value: this.solutionVariables }))))))));
    }
    _initializing = false;
    //--------------------------------------------------------------------------
    //
...
const SolutionVariables = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '4e92cbf7b038e47064d115fa3acedc7c97740b74' }, index.h("div", { key: '0286eccf36b633f9136d41c91d294a08d9f422a9' }, index.h("h4", { key: 'c11b186149971f39226f5698cbd3655c410a2432', class: "org-var-header" }, this._translations.solVariables)), index.h("div", { key: '6396b897a2fca64b80c10e3fa4c199487173e6b0', class: "container-border" }, index.h("calcite-tree", { key: 'f041b9c84e8f73b6549c4668bef11c1c0633b38b', id: "variable-label" }, this._renderHierarchy(this._solutionVariables)))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
