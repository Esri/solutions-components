...
const resources$2 = require('./resources-e23d63db.js');
const resources$1 = require('./resources-3eec4ddc.js');
const locale$1 = require('./locale-a09603ee.js');
const solutionStore = require('./solution-store-1218246d.js');
const interfaces = require('./interfaces-09c4c40e.js');
const solutionResource = require('./solution-resource-16c7510c.js');
...
const Tab = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '781e0b82d69d7ea6b2bd6e15ed0d1c5248f24d05', "aria-labelledby": this.labeledBy, id: id }, index.h("div", { key: '58a6be23b29e8bee598ecf0cd97ef0578fd4e197', class: { [CSS$3.container]: true, [`scale-${this.scale}`]: true }, role: "tabpanel", tabIndex: this.selected ? 0 : -1 }, index.h("section", { key: 'fbff1dec6ca2494f2485528679c14b4b0741abd8', class: CSS$3.content }, index.h("slot", { key: 'fc52db6fd58bd87f137e887837df5c08772809a3' })))));
    }
    connectedCallback() {
...
const TabTitle = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: '20ea18dabdb4cabe8a032d0799f3c757bc90c91d', class: { [CSS$1.titleIcon]: true, [CSS$1.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: component.getIconScale(this.scale) }));
        const iconEndEl = (index.h("calcite-icon", { key: 'ebd3913a334a959e8962addd45e5077ee82f2ca8', class: { [CSS$1.titleIcon]: true, [CSS$1.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: component.getIconScale(this.scale) }));
        return (index.h(index.Host, { key: '58a72fa4a6e961c3414dfe224a4e235892784707', "aria-controls": this.controls, "aria-selected": dom.toAriaBoolean(this.selected), id: id, role: "tab", tabIndex: this.selected && !this.disabled ? 0 : -1 }, index.h(interactive.InteractiveContainer, { key: 'fe7662ade3001579b664772b4672d6bebd06a82b', disabled: this.disabled }, index.h("div", { key: 'ea226b71436922de6bae2e8e542ae0adf08add1b', class: {
            ...
            }, hidden: closed, ref: (el) => this.resizeObserver?.observe(el) }, index.h("div", { key: '737609daa04d9dc18b46872c49b82cf211ba9b5a', class: { [CSS$1.content]: true, [CSS$1.contentHasText]: this.hasText } }, this.iconStart ? iconStartEl : null, index.h("slot", { key: 'fb500a910e5c6bfcd8571e2d109331dd88f2544d' }), this.iconEnd ? iconEndEl : null), this.renderCloseButton(), index.h("div", { key: '3fd13c6f459e05cea88c40809b7220369866a2b9', class: CSS$1.selectedIndicator })))));
    }
    renderCloseButton() {
...
const Tabs = class {
    ...
    disconnectedCallback() { }
    render() {
        return (index.h(index.Fragment, { key: '300872682f4f969586b06b6bbfa5cccb5a005e03' }, index.h("slot", { key: '9b8c09c2f93725349a98d13fb0167c88b82ef413', name: SLOTS$1.titleGroup }), index.h("section", { key: 'bf1b19251ca8ab3ba4c3c3fa15995889d71d9355' }, index.h("slot", { key: 'e1008e065225b4f0cb1b4fbe2ec91ab761db1144', onSlotchange: this.defaultSlotChangeHandler, ref: this.setDefaultSlotRef }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const ValueList = class {
    ...
    render() {
        return (index.h(sharedListRender.List, { key: '226659128d8b783ff03fabc4ad086291d3ec749c', onBlur: this.handleBlur, onFocusin: this.handleFocusIn, onKeyDown: this.keyDownHandler, props: this }));
    }
    static get assetsDirs() { return ["assets"]; }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const JsonEditor = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '01ac5edcc26e82397316e8a01229a3d27d6902af' }, index.h("div", { key: '87e015e58f6a1822ba202f660655078b7f7c1a8c', id: `${this.instanceid}-editor-container`, class: "editor-container padding-right" }, index.h("div", { key: '90d98682605a514797da3dc11a9f68dad336759b', class: "editor-controls" }, index.h("div", { key: 'c5eca5a9750d8f010ce9d749cfe7529a0b5c95c6', class: "editor-buttons" }, index.h("calcite-icon", { key: '5cdea0dc714261c6fa454d43c5fd3ba3902d9eac', id: `${this.instanceid}-errorFlag`, icon: "exclamation-mark-triangle", title: this._translations.errorFlag, scale: "s", class: "edit-error-flag" }), index.h("calcite-button", { key: 'e7f8e33c62c98a887b06bf20d5a718849f1455c6', id: `${this.instanceid}-undo`, color: "blue", appearance: "solid", title: this._translations.undo, onClick: () => this._undo(), scale: "s", class: "edit-button" }, index.h("calcite-icon", { key: 'fb3e4ea4d2120bd2fce4541c6c90b1d16fe7da2f', icon: "undo", scale: "s" })), index.h("calcite-button", { key: 'ba214ef0fa2d27d4334dd4b10d7bf15c35b49407', id: `${this.instanceid}-redo`, color: "blue", appearance: "solid", title: this._translations.redo, onClick: () => this._redo(), scale: "s", class: "edit-button" }, index.h("calcite-icon", { key: 'da359a0692ff1dd777588ab657f2520ca62eeb93', icon: "redo", scale: "s" })), index.h("calcite-button", { key: '569955fc77faf069f66b3c7376973822cc17f038', id: `${this.instanceid}-diff`, color: "blue", appearance: "solid", title: this._translations.diff, onClick: () => this._toggleEditor(), scale: "s", class: "edit-button" }, index.h("calcite-icon", { key: 'e477c4ae6d3b2cda3bdcc56660739ffab9b271c1', icon: "compare", scale: "s" })), index.h("calcite-button", { key: 'a691eb75c7487c6b401f4d35a4e7e8ac84e0d8f9', id: `${this.instanceid}-search`, appearance: "outline", color: "blue", title: this._translations.search, onClick: () => this._search(), scale: "s", class: "edit-button" }, index.h("calcite-icon", { key: '7a0cc6c45b49fb6db3963e7325291dd36dbc95ac', icon: "search", scale: "s" })), index.h("calcite-button", { key: '1ac31fcbb93e38aff565559174b45a5ef286dc01', id: `${this.instanceid}-reset`, color: "blue", appearance: "solid", disabled: true, title: this._translations.cancelEdits, onClick: () => this._reset(), scale: "s", class: "edit-button" }, index.h("calcite-icon", { key: 'abcc13ccb46312d8169196af5336bf8d25882ac8', icon: "reset", scale: "s" })))), index.h("div", { key: 'd70a08eec3c817a38dafb6ed15085efbc3aed090', class: "edit-parent" }, index.h("div", { key: '6cdec935e00ba08af533c7b2ca565f9a6fefc268', id: `${this.instanceid}-container`, class: "json-edit-container" }), index.h("div", { key: '1611a95a808ba19133d4c3d5bec6def362771746', id: `${this.instanceid}-diff-container`, class: "json-edit-container display-none" })))));
    }
    //--------------------------------------------------------------------------
    //
...
const SolutionItemDetails = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '61d6e5f9703edfb6a936a8a467fc545878c5406f' }, index.h("div", { key: '377c29de7e5b8e4c06197aad502b167e44579b87', class: "parent-container" }, index.h("div", { key: '2d97166d07a7f41a8dc250bd749690aae4d94699', class: "inputBottomSeparation" }, index.h("calcite-input", { key: '144e82dd68c146d06d4c644c0f1476c58cb244fe', id: "item-title", value: this.itemDetails.title })), index.h("div", { key: 'ea25afac1fcc4428b39719df81e665b18e95a4fc', class: "inputBottomSeparation" }, index.h("input", { key: 'ab31fedf335a157f8c97eea5adb0eec09486bfb8', accept: ".jpg,.gif,.png,image/jpg,image/gif,image/png", class: "display-none", onChange: (event) => (this._updateThumbnail(event)), ref: (el) => (this.browseForThumbnail = el), type: "file" }), index.h("button", { key: '9e0365412096cdf99707d9d4c23855572912a1e6', class: "font-size--3 btn-link inline-block trailer-quarter", onClick: () => this._getThumbnail() }, index.h("svg", { key: '0f36a04f8b3202022b7898e9bb1c04e164832b18', class: "icon-inline icon-inline--on-left", height: "16", viewBox: "0 0 16 16", width: "16" }, index.h("path", { key: '59a63dc2a5c2062ae1e1d0e95a0aff3413bc2bf5', d: "M14.792 2.666l-1.414-1.413a.965.965 0 0 0-1.385-.03l-1.444 1.444-8.763 8.72L.03 15.481a.371.371 0 0 0 .488.488l4.096-1.756 8.763-8.72-.001-.001.002.002 1.443-1.444a.965.965 0 0 0-.03-1.385zM1.569 14.431l.554-1.293.74.739zm2.338-.924l-1.414-1.414 7.963-7.92 1.414 1.415zm8.67-8.626l-1.413-1.414 1.29-1.29a.306.306 0 0 1 .433 0l.981.98a.306.306 0 0 1 0 .433z" })), this._translations.editThumbnail), index.h("div", { key: 'c259fca582d40cfdaafbd09728037148af9210c9', class: "flex" }, index.h("div", { key: '6dea250611cca99f6b894540b8f67e6a7435c71d', class: "img-container", ref: (el) => (this.thumbnailContainer = el) }, index.h("img", { key: '026a0bb189eae1c835ad422168164e1675984c18', class: "scale-down", height: "133", id: "item-thumbnail", ref: (el) => (this.thumbnail = el), width: "200" })), index.h("div", { key: 'b228b6c0bba23ce7dd158e09314fb33b24c08c34', class: "snippet-count-container" }, index.h("calcite-input", { key: '77423fd69cb2dd13f935309b59e17b7a310ba202', id: "item-snippet", maxLength: 250, type: "textarea", value: this.itemDetails.snippet }), index.h("label", { key: '8d267b7f229c9e3810e593cd45410572e0a33b67', class: "font-size--3", id: "item-snippet-count", ref: (el) => (this.itemSnippetCount = el) })))), index.h("calcite-label", { key: '7762a94cc3594e528ede4e87f8c447fd01eeba1c' }, this._translations.description, index.h("label", { key: '6f0441fd754851951a85298bb693bd278996900b', id: "item-description-label" }, index.h("calcite-input", { key: '4211d2472265a2b3056329ee47b217dbceaaa93e', id: "item-description", type: "textarea", value: this.itemDetails.description }))), index.h("calcite-label", { key: '8e3e4b730a63b2d13ea038d8536a066dafc64898' }, this._translations.tags, index.h("label", { key: '3c5df3b00ce7f82cc123e0675ceca84287061cd4', id: "item-tags-label" }, index.h("calcite-input", { key: '0f5b324fecf86953c6e72abdf1d3330b654ae170', id: "item-tags", value: (this.itemDetails.tags && Array.isArray(this.itemDetails.tags) ? this.itemDetails.tags : [this.itemDetails.tags]).join(",") }))), this.itemType !== "Group" ? index.h("calcite-label", null, this._translations.credits, index.h("label", { id: "item-credits-label" }, index.h("calcite-input", { id: "item-credits", value: this.itemDetails.accessInformation }))) : null, this.itemType !== "Group" ? index.h("calcite-label", null, index.h("label", { id: "item-terms-label" }, this._translations.termsOfUse, index.h("calcite-input", { id: "item-terms", type: "textarea", value: this.itemDetails.licenseInfo }))) : null)));
    }
    componentDidRender() {
        this._loadThumb();
    }
...
const SolutionItemSharing = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '8e4b35f389636c179685f0447e536d0eeabdd7ec' }, index.h("div", { key: 'a87684b15a96e580f9a203bba479f4d3d2c8db45', class: "container-border" }, index.h("calcite-label", { key: 'b1b62e4887674de5b572c457a1adf2c2a1f977eb' }, this._translations.groupInfo), this._renderItems(this.sharing))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const SolutionOrganizationVariables = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: 'e84690899c2e378ddc30676d53c0199c52bcdbef' }, index.h("div", { key: '41599319f26d5348d3766e8208fcc22bd97741c5' }, index.h("h4", { key: 'ee898a64a72159101ab89b946679f7ada661a2ef', class: "org-var-header" }, this._translations.orgVariables)), index.h("div", { key: '091a202b8c710ff9bb7c03e868a00f79e756d201', class: "container-border" }, index.h("calcite-tree", { key: '6ff1bb7fe8f286852d01ccecf19d35c3e85fb5f6', id: "variable-label" }, this._renderHierarchy(this._organizationVariables)))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const SolutionResourceItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '45bc346197968e07be42cc16c1c792e0e4872547' }, index.h("div", { key: 'f57fe6d4cf7d54975d48a11927477e295eb06089', class: "resource-item" }, index.h("div", { key: '4d1903665522dee371f51002370775f3b004e2fd', class: "margin-bottom-1" }, index.h("calcite-button", { key: 'fae693d09c76a1b0fb379c6178b561d30e962fec', appearance: "solid", class: "resource-button", color: "blue", onClick: () => this._addNewResource() }, this._translations.addResource), index.h("calcite-button", { key: '3e07b0ee9ccc50aef57442a982816dd6bc376ecd', appearance: "solid", color: "blue", disabled: !hasValidResources, onClick: () => this._downloadAll() }, this._translations.downloadAll)), index.h("div", { key: '2e87fe655e7314299419ca97d7f1dae833e36426', class: "resources-container", style: { display: hasValidResources ? "inherit" : "none" } }, this._renderResourceList()))));
    }
    _removedResources = {};
    //--------------------------------------------------------------------------
    //
...
const SolutionTemplateData = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '2e0fd019cf024cccd287674fc47c8c7149c5896e' }, index.h("div", { key: 'f36da861eb0915300e6cfa66507bfa819c5175ca', class: "solution-data-container" }, index.h("calcite-shell", { key: '05f2abaa3e654c5098f1b0fa39540b8e1ba69414', class: "light var-container", dir: "ltr" }, index.h("calcite-panel", { key: '465260b700ea88b98e50b37cc1adf1815736c590', class: "json-editor" }, index.h("div", { key: '77828dc31fb4b3b556538a14660506dc0ce91c18', class: "solution-data-child-container calcite-match-height" }, index.h("json-editor", { key: 'cf7be387699d46e0efce1cc9d2bafa1ecd1bd54b', class: "solution-data-editor-container", instanceid: this.itemId + "|" + this.instanceid, value: this.value }))), index.h("calcite-shell-panel", { key: 'a0f2aedafaf8eb4376c8f90a230b5992392ca4ce', "height-scale": "l", position: "end", slot: "contextual-panel", "width-scale": "xs" }, index.h("div", { key: 'c6275b75e9f275fad1c5cbd420847d1876c0084b', class: this.varsOpen ? "solution-data-child-container" : "solution-data-child-container-collapsed" }, index.h("calcite-button", { key: '96329209db26f9acbfc5d8717fb9e09fba44a555', appearance: "transparent", class: "collapse-btn", "icon-start": this.varsOpen ? "chevrons-right" : "chevrons-left", id: "collapse-vars", onClick: () => this._toggleVars(), scale: "s", title: this.varsOpen ? this._translations.collapse : this._translations.expand }), index.h("div", { key: 'ab6dfc9c86fb7b6fdf67668589990d12a517e0c6', class: this.varsOpen ? "org-vars" : "org-vars display-none", id: "orgVars" }, index.h("solution-organization-variables", { key: '26a8b4bcedbe525cde504431549fb911f9987865', value: this.organizationVariables })), index.h("div", { key: 'f0900c1e28036dbb0a5af6fd7db0e8625340c458', class: this.varsOpen ? "sol-vars" : "sol-vars display-none", id: "solVars" }, index.h("solution-variables", { key: '4ec9c214341c65e4b03a9d83e0731545c56ef3dd', value: this.solutionVariables }))))))));
    }
    _initializing = false;
    //--------------------------------------------------------------------------
    //
...
const SolutionVariables = class {
     ...
     */
    render() {
        return (index.h(index.Host, { key: '51a1c5b70a98964bc4ffe33a94dc3555a959c82b' }, index.h("div", { key: '0dfa406bacb18becccc9a78bb191972d1c40141d' }, index.h("h4", { key: 'b0b8dcfd320cf44464c07fadf08121ee45f78ab5', class: "org-var-header" }, this._translations.solVariables)), index.h("div", { key: '01421759487d2a79a24fff4fbae2077ee00e0cd1', class: "container-border" }, index.h("calcite-tree", { key: 'a8952b2a7035122914cf62044d67f00261054548', id: "variable-label" }, this._renderHierarchy(this._solutionVariables)))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
