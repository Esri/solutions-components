...
const InputNumber = class {
  constructor(hostRef) {
    ...
    this.setNumberValue = ({ committing = false, nativeEvent, origin, previousValue, value }) => {
      ...
      const sanitizedValue = locale.sanitizeNumberString((this.numberingSystem && this.numberingSystem !== "latn") || locale.defaultNumberingSystem !== "latn"
      ...
      if (nativeEvent) {
        ...
        if (calciteInputNumberInputEvent.defaultPrevented) {
          const previousLocalizedValue = locale.numberStringFormatter.localize(this.previousValue);
  ...
  render() {
    ...
    return (index.h(index.Host, { onClick: this.inputNumberFocusHandler, onKeyDown: this.keyDownHandler }, index.h("div", { class: { [CSS.inputWrapper]: true, [resources.CSS_UTILITY.rtl]: dir === "rtl" } }, this.numberButtonType === "horizontal" && !this.readOnly
