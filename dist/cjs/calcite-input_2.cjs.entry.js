...
const Progress = class {
    ...
    render() {
        ...
        const dir = dom.getElementDir(this.el);
        return (index.h("div", { key: '92597fefec948e4494425db28cd87bfad3cc76f8', "aria-label": this.label || this.text, "aria-valuemax": 1, "aria-valuemin": 0, "aria-valuenow": this.value, role: "progressbar" }, index.h("div", { key: 'd2a8ec085909b4bd35f443d0e831d645fb159317', class: "track" }, index.h("div", { key: '2dd26e56a0f344d02f1b4068167f61d9da4d2cbd', class: {
                bar: true,
