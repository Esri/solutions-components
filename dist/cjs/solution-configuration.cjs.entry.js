...
const templates = require('./templates-2f44c01b.js');
...
const SolutionConfigurationStyle0 = solutionConfigurationCss;
...
const SolutionConfiguration = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8e1367e1eece3e041227d7ce27d9d2b239f37d9f' }, !this._solutionIsLoaded
            ? index.h("calcite-loader", { label: '' })
            : null, index.h("div", { key: 'fe29e56a188dfd92d8e2c78af7acaac028aedff7', class: "configuration-container" }, index.h("div", { key: '595e3465a33d1bd43e2b193f83b3684e7cd7f545', class: "configuration" }, index.h("calcite-tabs", { key: 'e3d4fa1daead62e3778f93461e801a8fe1fb6ce3', class: "config-tabs" }, index.h("calcite-tab-nav", { key: 'f69a08f3e13d96e2a72a4acc3140e9fecaf771fb', slot: "tab-nav" }, index.h("calcite-tab-title", { key: '617c4645ed329aeaec323c8fd71dd4f613bd1bb5' }, this._translations.definitionTab), hasServices ?
            index.h("calcite-tab-title", null, this._translations.spatialReferenceTab) :
            null), index.h("calcite-tab", { key: 'aea33a732954616500acd5121a61e9dcc3c0a45a', class: "config-tab", selected: true }, index.h("div", { key: '25b4054f837b0574ba6534e413e6efa176629320', class: "config-solution" }, index.h("div", { key: '575b193c54fd45559f5ab30710b88848650b8c38', class: this._treeOpen ? "config-inventory" : "config-inventory-hide" }, index.h("solution-contents", { id: "configInventory", key: `${this.solutionItemId}-contents`, ref: (el) => (this._solutionContentsComponent = el) })), index.h("calcite-button", { key: 'f7460ad785026cc2071df44a650858502a3ddca4', appearance: "transparent", class: "collapse-btn", "icon-start": this._treeOpen ? "chevrons-left" : "chevrons-right", id: "collapse-vars", onClick: () => this._toggleTree(), scale: "s", title: this._treeOpen ? this._translations.collapse : this._translations.expand }), index.h("div", { key: '8bdb812041f5d928dfd84b4fcbce6c0b952cf7c5', class: "config-item" }, index.h("solution-item", { authentication: this.authentication, "item-id": this._currentEditItemId, key: `${this.solutionItemId}-item`, "organization-variables": this._organizationVariables, "solution-item-id": this.solutionItemId, "solution-variables": this._solutionVariables })))), hasServices
    ...
    */
    async getSpatialReferenceInfo() {
        return Promise.resolve(solutionStore.state.getStoreInfo("spatialReferenceInfo"));
    }
    /*
    @Method()
    ...
    */
    async saveSolution() {
        this._solutionIsLoaded = false;
        await solutionStore.state.saveSolution();
    ...
    */
    ...
    _initProps() {
        const solutionData = solutionStore.state.getStoreInfo("solutionData");
        this._templateHierarchy = [...templates.getInventoryItems(solutionData.templates)];
    ...
    async _loadSolution(solutionItemId) {
        if (solutionItemId) {
            this._solutionIsLoaded = false;
            await solutionStore.state.loadSolution(solutionItemId, this.authentication);
            this._initProps();
            this._solutionIsLoaded = true;
        }
        else {
