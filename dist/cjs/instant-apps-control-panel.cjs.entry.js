...
const InstantAppsControlPanel = class {
    ...
    async componentWillLoad() {
        const [Expand] = await loadModules.loadModules(['esri/widgets/Expand']);
        this.Expand = Expand;
    ...
    render() {
        return (index.h(index.Host, { key: 'b4eb66870fea801441c2c4410fce060a7785b66a' }, index.h("slot", { key: '9fadbc49629b92b3ae909da5171f2f0ae87e2daf', name: SLOT_NAME })));
    }
    _handleComponents() {
...
exports.instant_apps_control_panel = InstantAppsControlPanel;
