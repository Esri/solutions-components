    ...
    constructor(hostRef) {
        ...
        this.renderRotationControl = () => {
            ...
            return (index.h("button", { "aria-label": text, class: {
                ...
                }, onClick: this.toggleRotation, title: text }, index.h("calcite-icon", { icon: this.playing ? ICONS.pause : ICONS.play, scale: "s" }), this.playing && (index.h("calcite-progress", { class: CSS.autoplayProgress, label: this.messages.carouselItemProgress, value: this.slideDurationRemaining }))));
        };
        ...
        this.renderPaginationItems = () => (index.h("div", { "aria-label": this.label, class: CSS.paginationItems, role: "tablist" }, this.items.map((item, index$1) => {
        ...
        this.renderArrow = (direction) => {
            ...
            return (index.h("button", { "aria-controls": this.containerId, class: { [CSS.paginationItem]: true, [css]: true }, "data-direction": direction, onClick: this.handleArrowClick, title: title }, index.h("calcite-icon", { flipRtl: dir === "rtl", icon: icon, scale: scale })));
        };
        this.autoplay = false;
