...
const index$1 = require('./index-4b68e4b4.js');
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
function n$3(){return [0,0,0]}function t$2(n){return [n[0],n[1],n[2]]}function r$2(n,t,r){return [n,t,r]}function e$4(n,t,r){return [n,t,r]}function u$4(t,r=n$3()){const e=Math.min(3,t.length);for(let n=0;n<e;++n)r[n]=t[n];return r}function o$4(n,t){return new Float64Array(n,t,3)}function c$5(){return n$3()}function i$3(){return r$2(1,1,1)}function f$3(){return r$2(1,0,0)}function a$2(){return r$2(0,1,0)}function l$4(){return r$2(0,0,1)}const _$1=c$5(),s$2=i$3(),m$3=f$3(),y$3=a$2(),N$2=l$4();Object.freeze(Object.defineProperty({__proto__:null,ONES:s$2,UNIT_X:m$3,UNIT_Y:y$3,UNIT_Z:N$2,ZEROS:_$1,clone:t$2,create:n$3,createView:o$4,freeze:e$4,fromArray:u$4,fromValues:r$2,ones:i$3,unitX:f$3,unitY:a$2,unitZ:l$4,zeros:c$5},Symbol.toStringTag,{value:"Module"}));
...
class InstantAppsTimeFilterViewModel {
    ...
    async initializeModules() {
        try {
            const [Handles, reactiveUtils, TimeSlider, TimeExtent, TimeInterval, FeatureFilter, FeatureEffect] = await loadModules.loadModules([
                'esri/core/Handles',
    ...
    async init(timeSliderRef) {
        ...
        try {
            await view.when();
            if (timeInfoConfigItems.length === 1 && ((_c = timeInfoConfigItems[0]) === null || _c === void 0 ? void 0 : _c.type) === 'map') {
    ...
    generateTimeInfoItem(layerView, { increments, rangeStart, rangeEnd, timeIntervalValue }) {
        var _a;
        ...
        return {
            layerView: layerView,
            unit: increments,
            timeIntervalValue: timeIntervalValue !== null && timeIntervalValue !== void 0 ? timeIntervalValue : 1,
    ...
    initTimeSlider(timeSliderRef, defaultItem) {
        var _a, _b;
    ...
    getTimeSliderConfig(timeSliderRef, defaultItem) {
        ...
        if (defaultItem) {
            ...
            return Object.assign(Object.assign({}, baseConfig), { fullTimeExtent: timeSlider === null || timeSlider === void 0 ? void 0 : timeSlider.fullTimeExtent, timeExtent: timeSlider === null || timeSlider === void 0 ? void 0 : timeSlider.currentTimeExtent, stops: ((_e = timeSlider === null || timeSlider === void 0 ? void 0 : timeSlider.stopInterval) === null || _e === void 0 ? void 0 : _e.unit) && ((_f = timeSlider === null || timeSlider === void 0 ? void 0 : timeSlider.stopInterval) === null || _f === void 0 ? void 0 : _f.value)
                    ? {
            ...
            return Object.assign(Object.assign({}, baseConfig), { fullTimeExtent: timeExtent, timeExtent: new TimeExtent({
                    start: rangeStart,
                    end: rangeEnd,
                }), stops: {
                    interval: new TimeInterval({
...
const InstantAppsTimeFilter = class {
    ...
    render() {
        return index$1.h(index$1.Host, { key: '9366ce36d85d1b97ff9dad8a93f5cfb93d12551b' }, this._renderBase());
    }
    _renderBase() {
    ...
    _renderLayerTitle() {
        ...
        return index$1.h("span", { class: CSS.layerTitle }, title);
    }
    _renderDropdown() {
        return (state.selectedTimeInfoItem && (index$1.h("calcite-dropdown", null, this._renderDropdownButton(), this._renderDropdownItems())));
    }
    _renderDropdownButton() {
        return (index$1.h("calcite-button", { slot: "trigger", appearance: "transparent", iconEnd: "chevron-down", width: "full", alignment: "space-between" }, viewModel.getLabel(state.selectedTimeInfoItem)));
    }
    ...
    _renderDropdownItem(timeInfoItem) {
        ...
        return (index$1.h("calcite-dropdown-item", { onCalciteDropdownItemSelect: () => viewModel.updateSelectedTimeInfoItem(timeInfoItem), selected: selected }, viewModel.getLabel(timeInfoItem)));
    }
...
exports.instant_apps_time_filter = InstantAppsTimeFilter;
