...
const locale$1 = require('./locale-da840314.js');
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
    ["ar", () => Promise.resolve().then(function () { return require('./ar-76c21e64.js'); })],
    ["bg", () => Promise.resolve().then(function () { return require('./bg-14c9b066.js'); })],
    ["bs", () => Promise.resolve().then(function () { return require('./bs-af03a828.js'); })],
    ["ca", () => Promise.resolve().then(function () { return require('./ca-ae8e24ac.js'); })],
    ["cs", () => Promise.resolve().then(function () { return require('./cs-5c693156.js'); })],
    ["da", () => Promise.resolve().then(function () { return require('./da-1a406d67.js'); })],
    ["de", () => Promise.resolve().then(function () { return require('./de-11376da8.js'); })],
    ["de-at", () => Promise.resolve().then(function () { return require('./de-at-a7437de2.js'); })],
    ["de-ch", () => Promise.resolve().then(function () { return require('./de-ch-862dfe8d.js'); })],
    ["el", () => Promise.resolve().then(function () { return require('./el-69fd471f.js'); })],
    ["en", () => Promise.resolve().then(function () { return en$1; })],
    ["en-au", () => Promise.resolve().then(function () { return require('./en-au-4af4c244.js'); })],
    ["en-ca", () => Promise.resolve().then(function () { return require('./en-ca-dd0f74b8.js'); })],
    ["en-gb", () => Promise.resolve().then(function () { return require('./en-gb-d9916a0a.js'); })],
    ["es", () => Promise.resolve().then(function () { return require('./es-b96f4aa7.js'); })],
    ["es-mx", () => Promise.resolve().then(function () { return require('./es-mx-7ce9a959.js'); })],
    ["et", () => Promise.resolve().then(function () { return require('./et-ed1f6381.js'); })],
    ["fi", () => Promise.resolve().then(function () { return require('./fi-16433386.js'); })],
    ["fr", () => Promise.resolve().then(function () { return require('./fr-32b252ad.js'); })],
    ["fr-ch", () => Promise.resolve().then(function () { return require('./fr-ch-368648e3.js'); })],
    ["he", () => Promise.resolve().then(function () { return require('./he-d139901b.js'); })],
    ["hi", () => Promise.resolve().then(function () { return require('./hi-ba5e377e.js'); })],
    ["hr", () => Promise.resolve().then(function () { return require('./hr-87b5a9d8.js'); })],
    ["hu", () => Promise.resolve().then(function () { return require('./hu-3b80d082.js'); })],
    ["id", () => Promise.resolve().then(function () { return require('./id-09dfbe6e.js'); })],
    ["it", () => Promise.resolve().then(function () { return require('./it-da71aa25.js'); })],
    ["it-ch", () => Promise.resolve().then(function () { return require('./it-ch-00a4c4b4.js'); })],
    ["ja", () => Promise.resolve().then(function () { return require('./ja-c3519ced.js'); })],
    ["ko", () => Promise.resolve().then(function () { return require('./ko-ea8cd08b.js'); })],
    ["lt", () => Promise.resolve().then(function () { return require('./lt-4e8161c8.js'); })],
    ["lv", () => Promise.resolve().then(function () { return require('./lv-b976ad37.js'); })],
    ["mk", () => Promise.resolve().then(function () { return require('./mk-e2ea18b4.js'); })],
    ["nl", () => Promise.resolve().then(function () { return require('./nl-7249cded.js'); })],
    ["nb", () => Promise.resolve().then(function () { return require('./nb-d81f921b.js'); })],
    ["pl", () => Promise.resolve().then(function () { return require('./pl-d93521bd.js'); })],
    ["pt", () => Promise.resolve().then(function () { return require('./pt-bf297919.js'); })],
    ["pt-br", () => Promise.resolve().then(function () { return require('./pt-br-2c9c4ba2.js'); })],
    ["ro", () => Promise.resolve().then(function () { return require('./ro-b770ba3d.js'); })],
    ["ru", () => Promise.resolve().then(function () { return require('./ru-f70d0afe.js'); })],
    ["sk", () => Promise.resolve().then(function () { return require('./sk-67e2fd96.js'); })],
    ["sl", () => Promise.resolve().then(function () { return require('./sl-cf79e6c6.js'); })],
    ["sr", () => Promise.resolve().then(function () { return require('./sr-02a5153e.js'); })],
    ["sv", () => Promise.resolve().then(function () { return require('./sv-1c32f9ba.js'); })],
    ["th", () => Promise.resolve().then(function () { return require('./th-ddd7073f.js'); })],
    ["tr", () => Promise.resolve().then(function () { return require('./tr-31fcd3f7.js'); })],
    ["uk", () => Promise.resolve().then(function () { return require('./uk-a0f9e2bc.js'); })],
    ["vi", () => Promise.resolve().then(function () { return require('./vi-d484e1b9.js'); })],
    ["zh-cn", () => Promise.resolve().then(function () { return require('./zh-cn-3d843268.js'); })],
    ["zh-hk", () => Promise.resolve().then(function () { return require('./zh-hk-4aacd6d2.js'); })],
    ["zh-tw", () => Promise.resolve().then(function () { return require('./zh-tw-cbd770ad.js'); })],
]);
...
const InputTimePicker = class {
    ...
    renderToggleIcon(open) {
        return (index.h("span", { class: CSS.toggleIcon, slot: "action" }, index.h("calcite-icon", { icon: open ? "chevron-up" : "chevron-down", scale: component.getIconScale(this.scale) })));
    }
