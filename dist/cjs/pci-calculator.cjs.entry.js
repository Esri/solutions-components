...
const PciCalculator = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e19ddd889fb0474b01a9b541a4440bcb6d27cd75' }, index.h("div", { key: '69dca34e21fd274f274786c43377286a8a24dc37', class: pciClass }, index.h("div", { key: 'a8c3f266e45041a2cbd0228ccce8e75fcdc9a690', class: "label-display" }, index.h("calcite-label", { key: 'aed5c516d15e33b4dfc10a13b0efa97f21ed679a', class: "label-display" }, "Enter comma delimited deduct values", this._getDeductValuesInput())), index.h("div", { key: '786c228e29f54ee493227b1c8e8bd6e110b037a3' }, this._getCalculateButton())), index.h("div", { key: '7cec1f54145ad7e886af0081ee38aed095e1e0a8', class: deductClass }, index.h("div", { key: '8bcf946c78d410766d1f59b7d0dc9a844fd9b589', class: "position-right" }, index.h("calcite-action", { key: 'c33a0aedaa859f19dea94da253cda27257b9c235', appearance: 'transparent', class: "float-end", icon: "x", onClick: () => this._toggleShowAddDeduct(), scale: "s", text: '' })), index.h("deduct-calculator", { key: '195dbb3fff25c1fbf2e20c785a48c25527abfa2a', class: "display-grid padding-top-1", onDeductValueComplete: (evt) => this._addDeductValue(evt) }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
