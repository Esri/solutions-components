...
const PciCalculator = class {
  ...
  _getDeductValuesInput() {
    return (index.h("div", { class: "display-flex" }, index.h("calcite-input", { class: "main-input", ref: (el) => { this._deductValuesElement = el; } }), index.h("calcite-action", { appearance: 'clear', icon: "plus-circle", onClick: () => this._toggleShowAddDeduct(), scale: "s", text: '' })));
  }
  /**
