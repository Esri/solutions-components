...
const InstantAppsExport = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd561a14661edad3e4ad5f0041537acdc1fb724a1' }, index.h("div", { key: '917848051ac8114c4ba527332c8688791a9c75d0', class: this.baseClass, onMouseEnter: this.handleWidgetCreation.bind(this), onFocusin: this.handleWidgetCreation.bind(this) }, mode, index.h("div", { key: '3421d8bde7ce6f91062b538f087c155946358e01', class: CSS.hidden }, compass))));
    }
    renderPopover() {
        var _a, _b, _c;
