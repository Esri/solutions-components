...
const InstantAppsExport = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { class: this.baseClass, onMouseEnter: this.handleWidgetCreation.bind(this), onFocusin: this.handleWidgetCreation.bind(this) }, mode, index.h("div", { class: CSS.hidden }, compass))));
    }
    renderPopover() {
        var _a, _b, _c;
    ...
    renderMapOptions() {
        ...
        return (index.h("div", null, includeLegend, includePopup));
    }
    renderPrint() {
    ...
    handleLegendCreation() {
        ...
        if (this.includeMap && this.view != null && this.showIncludeLegend && this.legendContainerEl != null) {
            ...
            const checkId = (map === null || map === void 0 ? void 0 : map.portalItem.id) === (legendMap === null || legendMap === void 0 ? void 0 : legendMap.portalItem.id);
            if (!checkId) {
                this.updateLegend();
            }
        }
    ...
    handleCompassCreation() {
        ...
        if (this.includeMap && this.view != null && this.compassContainerEl != null) {
            ...
            const checkId = (map === null || map === void 0 ? void 0 : map.portalItem.id) === (compassMap === null || compassMap === void 0 ? void 0 : compassMap.portalItem.id);
            if (!checkId) {
                this.updateCompass();
            }
        }
...
InstantAppsExport.style = instantAppsExportCss;

exports.instant_apps_export = InstantAppsExport;
