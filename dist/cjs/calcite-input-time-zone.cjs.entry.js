...
async function getNormalizer(mode) {
    ...
    const { normalize } = await Promise.resolve().then(function () { return require('./time-zones-a7e83971.js'); });
    return normalize;
}
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
    if (mode === "name") {
        const { groupByName } = await Promise.resolve().then(function () { return require('./index-0fb00064.js'); });
    ...
    if (mode === "region") {
        const [{ groupByRegion }, { getCountry, global: globalLabel }] = await Promise.all([
            Promise.resolve().then(function () { return require('./index-89a62dc9.js'); }),
            Promise.resolve().then(function () { return require('./region-26804632.js'); }),
        ]);
    ...
    const [{ groupByOffset }, { DateEngine }] = await Promise.all([
        Promise.resolve().then(function () { return require('./index-c134f2f6.js'); }),
        Promise.resolve().then(function () { return require('./index-c44fa2e4.js'); }),
    ]);
