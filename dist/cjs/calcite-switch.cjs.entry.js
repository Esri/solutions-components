...
const Switch = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (index.h(index.Host, { key: '7731df888262acc136e2099fe599c6290967fea7', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: '6bc3781eb46221cbe022c6e6b3e7bad267e4d2c6', disabled: this.disabled }, index.h("div", { key: '1670db00b1cdb4ad8f013ff0dae914683db2004c', "aria-checked": dom.toAriaBoolean(this.checked), "aria-label": label.getLabelText(this), class: CSS.container, ref: this.setSwitchEl, role: "switch", tabIndex: 0 }, index.h("div", { key: '3c6e6d5abc6df9d745e361a65d06f4e7c1a3da16', class: CSS.track }, index.h("div", { key: '0973b399396b9bd44ac9d2c17b374e2fbfe77b5e', class: CSS.handle })), index.h(form.HiddenFormInputSlot, { key: '7776a1881b7b6d43c543e4f388ae6cb4301b4181', component: this })))));
    }
