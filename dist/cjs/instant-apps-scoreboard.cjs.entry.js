...
const locale = require('./locale-dab3f46a.js');
...
const InstantAppsScoreboard = class {
    ...
    render() {
        ...
        return index.h(index.Host, { class: `${positionClass} ${styleClass}` }, isDisabled ? null : [progress, ((_b = this.items) === null || _b === void 0 ? void 0 : _b.length) > 0 ? this.renderBase() : null]);
    }
    renderBase() {
...
InstantAppsScoreboard.style = instantAppsScoreboardCss;
