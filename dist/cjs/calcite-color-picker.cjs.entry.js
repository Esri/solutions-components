...
const resources = require('./resources-02142b99.js');
const dom = require('./dom-c9c2c835.js');
const utils = require('./utils-cca83dd0.js');
...
const throttle = require('./throttle-aeeb1b4d.js');
...
const ColorPicker = class {
    constructor(hostRef) {
        ...
        this.handleHexInputChange = (event) => {
            ...
            if (hex !== normalizedHex) {
                this.internalColorSet(resources.color(hex));
            }
        };
        this.handleSavedColorSelect = (event) => {
            const swatch = event.currentTarget;
            this.internalColorSet(resources.color(swatch.color));
        };
        ...
        this.renderChannelsTabTitle = (channelMode) => {
            ...
            return (index.h("calcite-tab-title", { class: resources.CSS.colorMode, "data-color-mode": channelMode, key: channelMode, onCalciteTabsActivate: this.handleTabActivate, selected: selected }, label));
        };
        this.renderChannelsTab = (channelMode) => {
            ...
            return (index.h("calcite-tab", { class: resources.CSS.control, key: channelMode, selected: selected }, index.h("div", { class: resources.CSS.channels, dir: "ltr" }, channelsToRender.map((channelValue, index) => {
        ...
        this.renderChannel = (value, index$1, ariaLabel, direction, suffix) => {
            return (index.h("calcite-input-number", { class: resources.CSS.channel, "data-channel-index": index$1, dir: direction, key: index$1, label: ariaLabel, lang: this.effectiveLocale, numberButtonType: "none", numberingSystem: this.numberingSystem, onCalciteInputNumberChange: this.handleChannelChange, onCalciteInputNumberInput: this.handleChannelInput, onKeyDown: this.handleKeyDown, scale: this.scale === "l" ? "m" : "s",
        ...
        this.value = utils.normalizeHex(utils.hexify(resources.DEFAULT_COLOR, this.alphaChannel));
    ...
    handleValueChange(value, oldValue) {
        ...
        const color = allowEmpty && !value
            ? null
            : resources.color(value != null && typeof value === "object" && utils.alphaCompatible(this.mode)
    ...
    async componentWillLoad() {
        ...
        const initialColor = willSetNoColor ? null : valueIsCompatible ? resources.color(value) : color;
    ...
    render() {
        ...
        const hueLeft = hueScopeLeft !== null && hueScopeLeft !== void 0 ? hueScopeLeft : (sliderWidth * resources.DEFAULT_COLOR.hue()) / resources.HSV_LIMITS.h;
        const opacityTop = thumbRadius;
        const opacityLeft = opacityScopeLeft !== null && opacityScopeLeft !== void 0 ? opacityScopeLeft : (sliderWidth * utils.alphaToOpacity(resources.DEFAULT_COLOR.alpha())) / resources.OPACITY_LIMITS.max;
        ...
        return (index.h(interactive.InteractiveContainer, { disabled: this.disabled }, index.h("div", { class: resources.CSS.container }, index.h("div", { class: resources.CSS.controlAndScope }, index.h("canvas", { class: resources.CSS.colorField, onPointerDown: this.handleColorFieldPointerDown,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.initColorField }), index.h("div", { "aria-label": vertical ? messages.value : messages.saturation, "aria-valuemax": vertical ? resources.HSV_LIMITS.v : resources.HSV_LIMITS.s, "aria-valuemin": "0", "aria-valuenow": (vertical ? color === null || color === void 0 ? void 0 : color.saturationv() : color === null || color === void 0 ? void 0 : color.value()) || "0", class: { [resources.CSS.scope]: true, [resources.CSS.colorFieldScope]: true }, onKeyDown: this.handleColorFieldScopeKeyDown, role: "slider", style: {
                top: `${adjustedColorFieldScopeTop || 0}px`,
                left: `${adjustedColorFieldScopeLeft || 0}px`,
            }, tabindex: "0",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.storeColorFieldScope })), index.h("div", { class: resources.CSS.previewAndSliders }, index.h("calcite-color-picker-swatch", { class: resources.CSS.preview, color: selectedColorInHex, scale: "l" }), index.h("div", { class: resources.CSS.sliders }, index.h("div", { class: resources.CSS.controlAndScope }, index.h("canvas", { class: { [resources.CSS.slider]: true, [resources.CSS.hueSlider]: true }, onPointerDown: this.handleHueSliderPointerDown,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.initHueSlider }), index.h("div", { "aria-label": messages.hue, "aria-valuemax": resources.HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": (color === null || color === void 0 ? void 0 : color.round().hue()) || resources.DEFAULT_COLOR.round().hue(), class: { [resources.CSS.scope]: true, [resources.CSS.hueScope]: true }, onKeyDown: this.handleHueScopeKeyDown, role: "slider", style: {
                top: `${adjustedHueScopeTop}px`,
                left: `${adjustedHueScopeLeft}px`,
            }, tabindex: "0",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.storeHueScope })), alphaChannel ? (index.h("div", { class: resources.CSS.controlAndScope }, index.h("canvas", { class: { [resources.CSS.slider]: true, [resources.CSS.opacitySlider]: true }, onPointerDown: this.handleOpacitySliderPointerDown,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.initOpacitySlider }), index.h("div", { "aria-label": messages.opacity, "aria-valuemax": resources.OPACITY_LIMITS.max, "aria-valuemin": resources.OPACITY_LIMITS.min, "aria-valuenow": (color || resources.DEFAULT_COLOR).round().alpha(), class: { [resources.CSS.scope]: true, [resources.CSS.opacityScope]: true }, onKeyDown: this.handleOpacityScopeKeyDown, role: "slider", style: {
            ...
            } }, index.h("div", { class: resources.CSS.hexAndChannelsGroup }, noHex ? null : (index.h("div", { class: resources.CSS.hexOptions }, index.h("calcite-color-picker-hex-input", { allowEmpty: allowEmpty, alphaChannel: alphaChannel, class: resources.CSS.control, messages: messages, numberingSystem: this.numberingSystem, onCalciteColorPickerHexInputChange: this.handleHexInputChange, scale: scale, value: selectedColorInHex }))), noChannels ? null : (index.h("calcite-tabs", { class: {
                [resources.CSS.colorModeContainer]: true,
                [resources.CSS.splitSection]: true,
            }, scale: scale === "l" ? "m" : "s" }, index.h("calcite-tab-nav", { slot: "title-group" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv")))))), noSaved ? null : (index.h("div", { class: { [resources.CSS.savedColorsSection]: true, [resources.CSS.section]: true } }, index.h("div", { class: resources.CSS.header }, index.h("label", null, messages.saved), index.h("div", { class: resources.CSS.savedColorsButtons }, index.h("calcite-button", { appearance: "transparent", class: resources.CSS.deleteColor, disabled: noColor, iconStart: "minus", kind: "neutral", label: messages.deleteColor, onClick: this.deleteColor, scale: scale, type: "button" }), index.h("calcite-button", { appearance: "transparent", class: resources.CSS.saveColor, disabled: noColor, iconStart: "plus", kind: "neutral", label: messages.saveColor, onClick: this.saveColor, scale: scale, type: "button" }))), savedColors.length > 0 ? (index.h("div", { class: resources.CSS.savedColors }, [
            ...savedColors.map((color) => (index.h("calcite-color-picker-swatch", { class: resources.CSS.savedColor, color: color, key: color, onClick: this.handleSavedColorSelect, onKeyDown: this.handleSavedColorKeyDown, scale: scale, tabIndex: 0 }))),
        ])) : null)))));
    }
    // --------------------------------------------------------------------------
    //
    ...
    captureHueSliderColor(x) {
        ...
        const hue = (resources.HUE_LIMIT_CONSTRAINED / width) * x;
        this.internalColorSet(this.baseColorFieldColor.hue(hue), false);
    }
    captureOpacitySliderValue(x) {
        const { dimensions: { slider: { width }, }, } = this;
        const alpha = utils.opacityToAlpha((resources.OPACITY_LIMITS.max / width) * x);
    ...
    drawActiveHueSliderColor() {
        ...
        const x = hsvColor.hue() / (resources.HUE_LIMIT_CONSTRAINED / width);
        const y = radius;
    ...
    drawHueSlider() {
        ...
        hueSliderColorStopKeywords.forEach((keyword) => {
            gradient.addColorStop(currentOffset, resources.color(keyword).string());
    ...
    drawActiveOpacitySliderColor() {
        ...
        const { dimensions: { slider: { width }, thumb: { radius }, }, } = this;
        const x = utils.alphaToOpacity(hsvColor.alpha()) / (resources.OPACITY_LIMITS.max / width);
        const y = radius;
        const sliderBoundX = this.getSliderBoundX(x, width, radius);
        requestAnimationFrame(() => {
    ...
    updateColorFromChannels(channels) {
        this.internalColorSet(resources.color(channels, this.channelMode));
    }
    ...
    getAdjustedScopePosition(left, top) {
        return [left - resources.SCOPE_SIZE / 2, top - resources.SCOPE_SIZE / 2];
    }
