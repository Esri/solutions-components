...
const downloadUtils = require('./downloadUtils-c2bd7c80.js');
...
const PublicNotification = class {
    ...
    _getRefinePage() {
        ...
        return (index.h("calcite-panel", null, this._getLabel(this._translations.refineSelection), hasSelections ? (index.h("div", null, this._getNotice(this._translations.refineTip, "padding-sides-1"), index.h("refine-selection", { enabledLayerIds: this.selectionLayerIds, mapView: this.mapView, selectionSets: this._selectionSets, sketchLineSymbol: this.sketchLineSymbol, sketchPointSymbol: this.sketchPointSymbol, sketchPolygonSymbol: this.sketchPolygonSymbol }))) :
