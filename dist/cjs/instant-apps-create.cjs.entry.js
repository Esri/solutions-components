...
const InstantAppsCreate = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ee6a5076dce36a238288216de4cbd77d16347c15' }, index.h("div", { key: 'c22b60a05f5d0b430c76ab8edcf52577f1eecfaa', class: this.baseClass }, mode)));
    }
    ...
    renderPopover() {
        ...
        return [
            index.h("calcite-popover", { referenceElement: "create-popover-btn", overlayPositioning: this.popoverPositioning, placement: this.popoverPlacement, autoClose: true, ref: (el) => (this.popoverEl = el),
                // HARDCODED IN EN
