...
const CalciteNavigationUser = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (index.h(index.Host, { key: '71dafc89185ed082fa48f68f10620f680703edf7' }, index.h("button", { key: 'e175503f28873b42aa231f29077449da12696072', "aria-label": this.label, class: CSS.button }, index.h("calcite-avatar", { key: 'de83763dcb0811cd7abfdb32003e69fbaf580b6f', "full-name": this.fullName, label: this.label, thumbnail: this.thumbnail, "user-id": this.userId, username: this.username }), (this.fullName || this.username) && !this.textDisabled && (index.h("div", { key: 'a54fd497c59ef3ad171b2f35394a27f5dd060d64', class: CSS.textContainer }, this.fullName && (index.h("span", { class: CSS.fullName, key: CSS.fullName }, this.fullName)), this.username && (index.h("span", { class: CSS.username, key: CSS.username }, this.username)))))));
    }
