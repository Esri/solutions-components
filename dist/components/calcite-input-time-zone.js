...
import { d as defineCustomElement$3 } from './combobox-item-group.js';
...
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
    if (mode === "name") {
        const { groupByName } = await import('./index4.js');
...
function defineCustomElement$1() {
    ...
    const components = ["calcite-input-time-zone", "calcite-chip", "calcite-combobox", "calcite-combobox-item", "calcite-combobox-item-group", "calcite-icon"];
