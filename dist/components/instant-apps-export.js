...
const InstantAppsExport$1 = /*@__PURE__*/ proxyCustomElement(class InstantAppsExport extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        return (h(Host, null, h("div", { class: this.baseClass, onMouseEnter: this.handleWidgetCreation.bind(this), onFocusin: this.handleWidgetCreation.bind(this) }, mode, h("div", { class: CSS.hidden }, compass))));
    }
    renderPopover() {
        var _a, _b, _c;
    ...
    static get style() { return instantAppsExportCss; }
        ...
        "scale": [1],
        "showHeaderTitle": [4, "show-header-title"],
        ...
        "view": [16],
        "maskBackground": [1, "mask-background"],
    ...
    components.forEach(tagName => { switch (tagName) {
        case "instant-apps-export":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, InstantAppsExport$1);
            }
            break;
        case "calcite-action":
            if (!customElements.get(tagName)) {
...
const InstantAppsExport = InstantAppsExport$1;
const defineCustomElement = defineCustomElement$1;

export { InstantAppsExport, defineCustomElement };
