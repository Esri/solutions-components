...
const SolutionContents = /*@__PURE__*/ proxyCustomElement(class SolutionContents extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return SolutionContentsStyle0; }
}, [0, "solution-contents", {
...
function defineCustomElement() {
    ...
    const components = ["solution-contents", "calcite-icon", "calcite-tree", "calcite-tree-item", "solution-item-icon"];
