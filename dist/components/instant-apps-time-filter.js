...
const InstantAppsTimeFilter$1 = /*@__PURE__*/ proxyCustomElement(class InstantAppsTimeFilter extends HTMLElement$1 {
    constructor() {
        super();
        this.__registerHost();
    ...
    render() {
        return h$2(Host, { key: '9366ce36d85d1b97ff9dad8a93f5cfb93d12551b' }, this._renderBase());
    }
    _renderBase() {
...
function defineCustomElement$1() {
    ...
    const components = ["instant-apps-time-filter", "calcite-button", "calcite-dropdown", "calcite-dropdown-item", "calcite-icon", "calcite-loader"];
    components.forEach(tagName => { switch (tagName) {
        case "instant-apps-time-filter":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, InstantAppsTimeFilter$1);
            }
            break;
        case "calcite-button":
            if (!customElements.get(tagName)) {
...
const InstantAppsTimeFilter = InstantAppsTimeFilter$1;
const defineCustomElement = defineCustomElement$1;

export { InstantAppsTimeFilter, defineCustomElement };
