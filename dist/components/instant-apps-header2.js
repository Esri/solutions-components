...
import { g as getElementDir } from './languageUtil.js';
...
const InstantAppsHeader = /*@__PURE__*/ proxyCustomElement(class InstantAppsHeader extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return InstantAppsHeaderStyle0; }
}, [1, "instant-apps-header", {
        "titleText": [1, "title-text"],
        "titleTextLink": [1, "title-text-link"],
        "backgroundColor": [1, "background-color"],
        "textColor": [1, "text-color"],
        "logoImage": [1, "logo-image"],
        "logoScale": [1537, "logo-scale"],
        "logoImageAltText": [1, "logo-image-alt-text"],
        "logoLink": [1, "logo-link"],
        "infoButton": [1540, "info-button"],
        "infoIsOpen": [516, "info-is-open"],
        "infoTitleText": [1, "info-title-text"],
        "customHeaderHtml": [1025, "custom-header-html"],
        "headerAlignment": [1025, "header-alignment"],
        "customHeaderCss": [1025, "custom-header-css"],
        "fontFamily": [513, "font-family"],
        "mobileWidthBreakpoint": [2, "mobile-width-breakpoint"],
        "dir": [32],
        "initialScale": [32],
        "toggleInfo": [64]
    }, undefined, {
...
function defineCustomElement() {
    ...
    const components = ["instant-apps-header", "calcite-button", "calcite-icon", "calcite-loader"];
    components.forEach(tagName => { switch (tagName) {
        case "instant-apps-header":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, InstantAppsHeader);
            }
            break;
        case "calcite-button":
            if (!customElements.get(tagName)) {
...
export { InstantAppsHeader as I, defineCustomElement as d };
