...
const InstantAppsInteractiveLegendGroupLegendElement = /*@__PURE__*/ proxyCustomElement(class InstantAppsInteractiveLegendGroupLegendElement extends HTMLElement {
    ...
    render() {
        return (h("div", { style: {
            ...
            }, class: `${CSS.service} ${CSS.groupLayer}` }, h("instant-apps-interactive-legend-layer-element-caption", { ref: node => (this.layerCaption = node), class: getTheme(this.el), legendvm: this.legendvm, "feature-count": this.featureCount, activeLayerInfo: this.activeLayerInfo, messages: this.messages, isChild: this.isChild }), h("div", { class: `${CSS.groupContent} ${this.expanded === false ? 'hide' : 'show'}` }, h("slot", { name: "content" }))));
    }
    get el() { return this; }
    static get style() { return instantAppsInteractiveLegendGroupLegendElementCss; }
