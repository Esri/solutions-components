...
import { z as getElementWidth, A as getTextWidth, i as isPrimaryPointerButton, t as toAriaBoolean } from './dom.js';
...
const Combobox = /*@__PURE__*/ proxyCustomElement(class Combobox extends HTMLElement {
    constructor() {
        ...
        this.clickHandler = (event) => {
            ...
            if (composedPath.some((node) => { var _a; return (_a = node.classList) === null || _a === void 0 ? void 0 : _a.contains(CSS.button); })) {
                this.clearValue();
                event.preventDefault();
                return;
            }
