...
const InstantAppsInteractiveLegendClassic = /*@__PURE__*/ proxyCustomElement(class InstantAppsInteractiveLegendClassic extends HTMLElement {
    ...
    async createDataForLayer(fLayer) {
        ...
        const ALIs = getAllActiveLayerInfos((_a = this.legendvm) === null || _a === void 0 ? void 0 : _a.activeLayerInfos);
        ...
        if (!dataForLayer && ali) {
            const dataForLayer = (await createInteractiveLegendDataForLayer(this.legendvm, ali, this.reactiveUtils));
    ...
    static get style() { return InstantAppsInteractiveLegendClassicStyle0; }
