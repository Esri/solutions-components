...
import { d as defineCustomElement$7 } from './instant-apps-interactive-legend-count2.js';
import { d as defineCustomElement$6 } from './instant-apps-interactive-legend-group-legend-element2.js';
import { d as defineCustomElement$5 } from './instant-apps-interactive-legend-layer-element2.js';
import { d as defineCustomElement$4 } from './instant-apps-interactive-legend-layer-element-caption2.js';
import { d as defineCustomElement$3 } from './instant-apps-interactive-legend-legend-element2.js';
import { d as defineCustomElement$2 } from './instant-apps-interactive-legend-legend-element-caption2.js';
import { d as defineCustomElement$1 } from './instant-apps-interactive-legend-relationship2.js';
...
const projector = maquette_umd.createProjector();
...
function renderSeparator(rampAlignment = 'vertical') {
  ...
  return rampAlignment === 'vertical' ? (h("svg", { height: "4", width: "10" }, h("line", { x1: "0", y1: "2", x2: "10", y2: "2", style: style }))) : (h("svg", { height: "10", width: "10" }, h("line", { x1: "5", y1: "0", x2: "5", y2: "10", style: style })));
}
...
const InstantAppsInteractiveLegendClassic = /*@__PURE__*/ proxyCustomElement(class InstantAppsInteractiveLegendClassic extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    async componentDidLoad() {
        try {
            ...
            this.legendvm.view.when(async () => {
                var _a, _b;
                try {
                    await ((_b = (_a = this.legendvm) === null || _a === void 0 ? void 0 : _a.view) === null || _b === void 0 ? void 0 : _b.map).loadAll();
                    await this.reactiveUtils.whenOnce(() => { var _a, _b; return ((_b = (_a = this.legendvm) === null || _a === void 0 ? void 0 : _a.view) === null || _b === void 0 ? void 0 : _b.updating) === false; });
                    // Initial data setup
    ...
    renderLegendForLayer(activeLayerInfo, isChild) {
        ...
        if (hasChildren) {
            ...
            return (h("instant-apps-interactive-legend-group-legend-element", { class: getTheme(this.el), legendvm: this.legendvm, featureCount: this.featureCount, activeLayerInfo: activeLayerInfo, isChild: isChild }, h("div", { style: {
                    paddingLeft: '20px',
        ...
        return (h("instant-apps-interactive-legend-layer-element", { class: getTheme(this.el), legendvm: this.legendvm, featureCount: this.featureCount, activeLayerInfo: activeLayerInfo, messages: this.messages, isChild: isChild }, h("div", { slot: "content", id: `${(_b = activeLayerInfo === null || activeLayerInfo === void 0 ? void 0 : activeLayerInfo.layer) === null || _b === void 0 ? void 0 : _b.id}-legend-layer`, class: CSS.layer }, filteredElements)));
    }
    renderLegendForElement(legendElement, layer, effectList, activeLayerInfo, legendElementIndex, isChild, parentLegendElementInfo) {
        ...
        if (legendElement.type === 'symbol-table' || isSizeRamp) {
            const rows = legendElement.infos
                ...
                .filter((row) => !!row);
            if (rows.length) {
                content = h("div", { class: CSS.layerBody }, rows);
            }
        }
            ...
            content = (h("instant-apps-interactive-legend-relationship", { class: getTheme(this.el), key: "relationship-ramp", filterMode: this.filterMode, activeLayerInfo: activeLayerInfo, legendElement: legendElement, messages: this.messages }));
        }
        ...
        return (h("instant-apps-interactive-legend-legend-element", { class: getTheme(this.el), activeLayerInfo: activeLayerInfo, isSizeRamp: isSizeRamp, isChild: isChild, isColorRamp: isColorRamp, isRelationshipRamp: isRelationshipRamp, isInteractive: isInteractive, zoomTo: this.zoomTo, legendElement: legendElement, titleText: title, legendvm: this.legendvm, legendElementIndex: legendElementIndex, messages: this.messages }, h("div", { slot: "content" }, content)));
    }
    renderPieChartRamp(legendElement) {
        var _a;
        return h("div", { innerHTML: `${(_a = legendElement.preview) === null || _a === void 0 ? void 0 : _a.outerHTML}` });
    }
    async renderUnivariateAboveAndBelowRamp(legendElement, opacity, effectList) {
        ...
        const aboveRampLabels = labels.map((label, index) => {
            ...
            return isStartLabel ? h("div", { class: label ? (colorRampAbovePreview ? CSS.univariateAboveAndBelowLabel : CSS.rampLabel) : '' }, label) : isMidLabel ? h("div", null) : null;
        });
        ...
        const belowRampLabels = labels.map((label, index) => {
            ...
            return isMidLabel || isEndLabel ? h("div", { class: label ? (colorRampAbovePreview ? CSS.univariateAboveAndBelowLabel : CSS.rampLabel) : '' }, label) : null;
        });
        ...
        return (h("div", { key: "univariate-above-and-below-ramp-preview", style: univariateRampContainerStyles }, h("div", { class: CSS.layerBody }, sizeRampElement.infos.map((info, i) => (h("div", { class: `${CSS.layerRow} ${CSS.sizeRamp}` }, h("div", { class: CSS.symbol, style: sizeRampPreviewStyles, innerHTML: `${info.preview.outerHTML}` }), !colorRampAbovePreview && i % 2 === 0 ? h("div", { class: CSS.layerInfo }, labels[i]) : null)))), colorRampAbovePreview ? (h("div", { style: colorRampPreviewStyles, key: "color-ramp-preview" }, h("div", { style: univariateColorRampContainerStyles }, h("div", { style: univariateColorRampStyles }, h("div", { class: CSS.rampContainer }, colorRampAbovePreview)), h("div", { style: univariateColorRampStyles }, h("div", { class: CSS.rampLabelsContainer, style: colorRampAboveLabelStyles }, aboveRampLabels))), h("div", { style: univariateColorRampContainerStyles }, h("div", { style: univariateColorRampStyles }, h("div", { class: CSS.rampContainer }, colorRampBelowPreview)), h("div", { style: univariateColorRampStyles }, h("div", { class: CSS.rampLabelsContainer, style: colorRampBelowLabelStyles }, belowRampLabels))))) : null));
    }
    renderUnivariateColorSizeRamp(legendElement, opacity, effectList) {
        ...
        const labels = sizeRampElement.infos.map((stop, index) => index === 0 || index === endIndex ? h("div", { class: stop.label ? (colorRampElement ? CSS.univariateAboveAndBelowLabel : CSS.rampLabel) : '' }, stop.label) : null);
        const sizeRampPreviewStyles = { display: 'table-cell', verticalAlign: 'middle' };
        const colorRampPreviewStyles = { marginTop: `${colorRampTopMargin}px` };
        const colorRampLabelStyles = { height: `${colorRampHeight}px` };
        return (h("div", { key: "univariate-above-and-below-ramp-preview", style: univariateRampContainerStyles }, h("div", { class: CSS.layerBody }, sizeRampElement.infos.map(info => (h("div", { class: `${CSS.layerRow} ${CSS.sizeRamp}` }, h("div", { class: CSS.symbol, style: sizeRampPreviewStyles, innerHTML: `${info.preview.outerHTML}` }))))), h("div", { style: colorRampPreviewStyles, key: "color-ramp-preview" }, h("div", { style: univariateColorRampContainerStyles }, h("div", { style: univariateColorRampStyles }, h("div", { class: CSS.rampContainer }, colorRampPreview)), h("div", { style: univariateColorRampStyles }, h("div", { class: CSS.rampLabelsContainer, style: colorRampLabelStyles }, labels))))));
    }
    renderLegendForRamp(legendElement, opacity) {
        ...
        const labelsContent = rampStops.map(stop => (h("div", { class: stop.label ? CSS.rampLabel : '' }, isHeatmapRamp ? this.messages[stop.label] || stop.label : isStretchRamp ? this.getStretchStopLabel(stop) : stop.label)));
        ...
        return (h("div", { class: CSS.layerRow }, h("div", { class: CSS.symbolContainer, style: Object.assign({}, symbolContainerStyles) }, h("div", { ref: el => {
                var _a;
            ...
            }, class: CSS.rampContainer })), h("div", { class: CSS.layerInfo }, h("div", { class: CSS.rampLabelsContainer, style: Object.assign({}, rampLabelsContainerStyles) }, labelsContent))));
    }
    ...
    renderLegendForElementInfo(elementInfo, layer, effectList, isSizeRamp, legendElement, activeLayerInfo, legendElementIndex, infoIndex, isInteractive, parentLegendElementInfo) {
        ...
        if (elementInfo.preview) {
            content = h("div", { class: CSS.symbol, innerHTML: `${elementInfo.preview.outerHTML}` });
        }
        ...
        let selected;
        const data = getIntLegendLayerData(layer);
    ...
    renderImage(elementInfo, layer, isStretched) {
        ...
        return (h("img", { alt: this.getTitle(this.messages, label, false), src: src,
            // border={0}
    ...
    isRamp) {
        ...
        return bundleKey
            ? (_a = this.intl) === null || _a === void 0 ? void 0 : _a.substitute(bundleKey === 'showField' ? '{field}' : messages[bundleKey], {
    ...
    async createDataForLayer(fLayer) {
        ...
        const acl = (_b = (_a = this.legendvm) === null || _a === void 0 ? void 0 : _a.activeLayerInfos) === null || _b === void 0 ? void 0 : _b.find(acl => { var _a; return ((_a = acl === null || acl === void 0 ? void 0 : acl.layer) === null || _a === void 0 ? void 0 : _a.id) === (fLayer === null || fLayer === void 0 ? void 0 : fLayer.id); });
        if (!dataForLayer && acl) {
            const dataForLayer = (await createInteractiveLegendDataForLayer(this.legendvm, acl, this.reactiveUtils));
            updateStore({ intLegendLayerData: dataForLayer, layerId: fLayer === null || fLayer === void 0 ? void 0 : fLayer.id });
    ...
    applyFilter(elementInfo, layer, infoIndex, parentLegendElementInfo) {
        return async () => {
            var _a;
            const dataFromActiveLayerInfo = Object.assign({}, (_a = interactiveLegendState.data) === null || _a === void 0 ? void 0 : _a[layer === null || layer === void 0 ? void 0 : layer.id]);
            ...
            updateStore({ intLegendLayerData: dataFromActiveLayerInfo, layerId: layer === null || layer === void 0 ? void 0 : layer.id });
        };
    }
    get el() { return this; }
    ...
    static get style() { return instantAppsInteractiveLegendClassicCss; }
}, [2, "instant-apps-interactive-legend-classic", {
        "legendvm": [16],
        "zoomTo": [4, "zoom-to"],
...
export { InstantAppsInteractiveLegendClassic as I, defineCustomElement as d };
