...
import { d as defineCustomElement$8 } from './block.js';
...
const InstantAppsKeyboardShortcuts$1 = /*@__PURE__*/ proxyCustomElement(class InstantAppsKeyboardShortcuts extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        return (h(Host, { key: 'f8e209f996c4743ad1bfc91deef5952c8ac34f90' }, h("calcite-block", { key: 'b0a69ae1ba6c989c344daa2d2fa51e6943ff6e49', open: true, class: `${CSS.content}`, heading: (_c = (_b = this === null || this === void 0 ? void 0 : this.messages) === null || _b === void 0 ? void 0 : _b.generalShortcuts) === null || _c === void 0 ? void 0 : _c.label }, h("table", { key: '5820bb1e99ba3ffc926dea0c60ae6cba9fb71461' }, this.renderTableHeader(), h("tr", { key: 'b3664317e370d732f405325f6094f5ed2baad197' }, h("td", { key: '3e3367b5fe5e8e5f3deddbb850acdf8c6eae9841' }, `${modifierKey} + M`), h("td", { key: 'a426d5c5514d99dec89e8d8298b00cfb7addfb06' }, (_e = (_d = this === null || this === void 0 ? void 0 : this.messages) === null || _d === void 0 ? void 0 : _d.generalShortcuts) === null || _e === void 0 ? void 0 : _e.title))), h("calcite-label", { key: 'b33865ff795dac7277db16c128abc4b8667b2faf' }, (_g = (_f = this === null || this === void 0 ? void 0 : this.messages) === null || _f === void 0 ? void 0 : _f.generalShortcuts) === null || _g === void 0 ? void 0 : _g.title), h("table", { key: '72cbeee022de4c2c895eb78a94cf708d3f2f653c' }, this.renderTableHeader(), commands.map(command => {
    ...
    get el() { return this; }
    static get style() { return InstantAppsKeyboardShortcutsStyle0; }
}, [1, "instant-apps-keyboard-shortcuts", {
        "view": [16],
        "messages": [32]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["instant-apps-keyboard-shortcuts", "calcite-action", "calcite-action-menu", "calcite-block", "calcite-handle", "calcite-icon", "calcite-label", "calcite-loader", "calcite-popover", "calcite-scrim"];
    components.forEach(tagName => { switch (tagName) {
        case "instant-apps-keyboard-shortcuts":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, InstantAppsKeyboardShortcuts$1);
            }
            break;
        case "calcite-action":
            if (!customElements.get(tagName)) {
...
const InstantAppsKeyboardShortcuts = InstantAppsKeyboardShortcuts$1;
const defineCustomElement = defineCustomElement$1;

export { InstantAppsKeyboardShortcuts, defineCustomElement };
