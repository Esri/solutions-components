...
import { g as getSolutionVariables, a as getOrganizationVariables, b as getInventoryItems } from './templates.js';
...
import { d as defineCustomElement$u } from './label2.js';
...
import { r as request, N as NODEJS_DEFAULT_REFERER_HEADER, c as cleanUrl, e as encodeQueryString, A as ArcGISAuthError } from './restHelpersGet.js';
...
const SolutionConfiguration$1 = /*@__PURE__*/ proxyCustomElement(class SolutionConfiguration extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '2711b1daac68d8b061f72837f8db2aec3917741a' }, !this._solutionIsLoaded
            ? h("calcite-loader", { label: '' })
            : null, h("div", { key: 'a5ceb588322ed02e9108f6382d33303cc63ba5be', class: "configuration-container" }, h("div", { key: '65d23237d5a8e85eab125aee3d81b84cc1ddc8d7', class: "configuration" }, h("calcite-tabs", { key: '702e76542f97faf03df149fb4381ac11a01b2d2f', class: "config-tabs" }, h("calcite-tab-nav", { key: 'd6d2a465be5d46776c7f0bab746caf14572c2465', slot: "tab-nav" }, h("calcite-tab-title", { key: '642fe7233ec4d2cdd7f84d1082ab15deacdc7933' }, this._translations.definitionTab), hasServices ?
            h("calcite-tab-title", null, this._translations.spatialReferenceTab) :
            null), h("calcite-tab", { key: 'ed3ab07b25d220e2ccb970f7766bdef64f090285', class: "config-tab", selected: true }, h("div", { key: '138657ca570ca6ec3f168bde1d557345181c28eb', class: "config-solution" }, h("div", { key: 'f2faf13331a060957f3eef0fc6115781ae54650f', class: this._treeOpen ? "config-inventory" : "config-inventory-hide" }, h("solution-contents", { id: "configInventory", key: `${this.solutionItemId}-contents`, ref: (el) => (this._solutionContentsComponent = el) })), h("calcite-button", { key: 'e5bdb4b794ec65874fac81d3b7e6ddc616cae310', appearance: "transparent", class: "collapse-btn", "icon-start": this._treeOpen ? "chevrons-left" : "chevrons-right", id: "collapse-vars", onClick: () => this._toggleTree(), scale: "s", title: this._treeOpen ? this._translations.collapse : this._translations.expand }), h("div", { key: '72196cee63ccde29b7c5ba816a1a569e1fed7220', class: "config-item" }, h("solution-item", { authentication: this.authentication, "item-id": this._currentEditItemId, key: `${this.solutionItemId}-item`, "organization-variables": this._organizationVariables, "solution-item-id": this.solutionItemId, "solution-variables": this._solutionVariables })))), hasServices
