...
const InstantAppsLandingPage$1 = /*@__PURE__*/ proxyCustomElement(class InstantAppsLandingPage extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        return h(Host, { key: '0e372fb26b6581751f19368cd778a05c22f04587' }, content);
    }
    ...
    static get style() { return InstantAppsLandingPageStyle0; }
}, [1, "instant-apps-landing-page", {
        "titleText": [1, "title-text"],
        "subtitleText": [1, "subtitle-text"],
        "descriptionText": [1, "description-text"],
        "entryButtonText": [1, "entry-button-text"],
        "iconImage": [1, "icon-image"],
        "iconImageScale": [1, "icon-image-scale"],
        "iconImageAltText": [1, "icon-image-alt-text"],
        "alignment": [1],
...
const InstantAppsLandingPage = InstantAppsLandingPage$1;
const defineCustomElement = defineCustomElement$1;

export { InstantAppsLandingPage, defineCustomElement };
