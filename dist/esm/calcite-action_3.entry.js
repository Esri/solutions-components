 ...
 */
import { r as registerInstance, h, H as Host, g as getElement, f as forceUpdate, c as createEvent, F as Fragment } from './index-d298aca9.js';
import { t as toAriaBoolean, i as isPrimaryPointerButton, h as focusElement, m as focusFirstTabbable, q as queryElementRoots } from './dom-0fc13266.js';
...
import { C as CSS$2, I as ICONS, S as SLOTS$1 } from './resources-1a9e5dd1.js';
import { f as filterComputedPlacements, c as connectFloatingUI, b as defaultOffsetDistance, u as updateAfterClose, a as disconnectFloatingUI, r as reposition, F as FloatingCSS } from './floating-ui-0f62bf89.js';
...
const ActionMenu = class {
  ...
  renderMenuButton() {
    ...
    const menuButtonSlot = (h("slot", { name: SLOTS$1.trigger, onSlotchange: this.setMenuButtonEl }, h("calcite-action", { class: CSS$2.defaultTrigger, icon: ICONS.menu, scale: scale, text: label, textEnabled: expanded,
      // eslint-disable-next-line react/jsx-sort-props
...
export { Action as calcite_action, ActionMenu as calcite_action_menu, Popover as calcite_popover };
