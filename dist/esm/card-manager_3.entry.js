 ...
 */
import { r as registerInstance, g as getElement, h, H as Host, c as createEvent, F as Fragment } from './index-b793d9aa.js';
...
import { d as downloadCSV } from './downloadUtils-74bc82ae.js';
...
const LayerTable = class {
   ...
   */
    ...
    render() {
        ...
        return (h(Host, { key: 'bf3550621554a425226ef1b9d41f3cb1ae8691bf' }, h("calcite-shell", { key: '286e94a267d352c202c48ac946dba00c0d530e65' }, this._getTableControlRow("header"), h("div", { key: 'bd41989fb4957479c9841ee9aae12a462090178b', class: `width-full ${tableHeightClass}` }, h("calcite-panel", { key: 'd5ed0b971fed25592064e0b0601c7e1c3a760246', class: "height-full width-full" }, h("calcite-loader", { key: '91cea660ef303345e8c64e8b50456283b28cf7d9', class: loadingClass, label: this._translations.fetchingData, scale: "l" }), h("div", { key: '7a61c51f748667a4f55882008c781c2f491184d3', class: tableNodeClass, ref: this.onTableNodeCreate })), !this.isMobile ? (h("div", { class: "bottom-left text-color height-19" }, this._translations.recordsSelected
            .replace("{{total}}", total)
