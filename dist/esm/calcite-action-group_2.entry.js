 ...
 */
import { r as registerInstance, h, F as Fragment, g as getElement, c as createEvent } from './index-c246d90e.js';
import { S as SLOTS, I as ICONS, T as TEXT } from './resources-3d641588.js';
import { a as getSlotted, t as toAriaBoolean, i as isPrimaryPointerButton, f as focusElement } from './dom-3bdc69ee.js';
import { S as SLOTS$1, C as CSS, I as ICONS$1 } from './resources-d60362c3.js';
...
const ActionMenu = class {
  ...
  renderMenuButton() {
    ...
    const menuButtonSlot = (h("slot", { name: SLOTS$1.trigger, onSlotchange: this.setMenuButtonEl }, h("calcite-action", { class: CSS.defaultTrigger, icon: ICONS$1.menu, ref: this.setDefaultMenuButtonEl, scale: scale, text: label, textEnabled: expanded })));
  ...
  render() {
    return (h(Fragment, null, this.renderMenuButton(), this.renderMenuItems(), h("slot", { name: SLOTS$1.tooltip, onSlotchange: this.updateTooltip })));
  }
...
export { ActionGroup as calcite_action_group, ActionMenu as calcite_action_menu };
