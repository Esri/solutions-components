...
import { b as getLocaleComponentStrings } from './locale-bd9034e1.js';
...
const InstantAppsScoreboard = class {
    ...
    render() {
        ...
        return h(Host, { class: `${positionClass} ${styleClass}` }, isDisabled ? null : [progress, ((_b = this.items) === null || _b === void 0 ? void 0 : _b.length) > 0 ? this.renderBase() : null]);
    }
    renderBase() {
...
export { InstantAppsScoreboard as instant_apps_scoreboard };
