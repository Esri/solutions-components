 ...
 */
import { r as registerInstance, c as createEvent, h, H as Host } from './index-164d485a.js';
...
const cookieTestCss = ":host{display:block}.consent-panel{position:fixed;display:block;z-index:5000;bottom:0;left:0;width:100%;height:auto;text-align:center}.cookie-consent-popup-container{position:relative;display:block;bottom:0;left:0;width:100%;margin:0;padding-top:1rem;padding-bottom:1rem;transition:transform 0.5s ease-out 0s;background-color:rgba(51, 51, 51, 0.95);color:#fff}.button-container{position:static;margin-bottom:1rem;display:flex;justify-content:center;flex-wrap:wrap}.padding-end-1{padding-inline-end:1rem}.link-text{--calcite-color-text-link:var(--calcite-color-text-inverse);--calcite-color-brand-underline:var(--calcite-color-text-inverse);--calcite-color-brand:var(--calcite-color-text-inverse)}";
...
const CookieTest = class {
    ...
    render() {
        ...
        return this._shouldRender && !this._loaded ? (h(Host, null, h("calcite-panel", { class: "consent-panel", id: "cookie-policy" }, h("div", { class: "cookie-consent-popup-container" }, h("div", { id: "cookie-policy-description-top", tabindex: "-1" }, h("p", null, "Dear visitor,"), h("p", null, "We use analytics cookies to offer you a better browsing experience. You have the choice to refuse or accept them.")), h("div", { class: "button-container" }, h("calcite-button", { appearance: "solid", class: "padding-end-1", kind: "brand", onClick: () => this._refuse() }, "I refuse analytics cookies"), h("calcite-button", { appearance: "solid", kind: "brand", onClick: () => this._accept() }, "I accept analytics cookies")), h("div", null, h("p", null, "For any information on the other cookies and server logs we use, we invite you to read our\u00A0", h("calcite-link", { class: "link-text", href: "https://www.europarl.europa.eu/privacy-policy/en/data-protection", rel: "noopener noreferrer", target: "_blank" }, "data protection policy"), " , our\u00A0", h("calcite-link", { class: "link-text", href: "https://www.europarl.europa.eu/privacy-policy/en/cookies-policy", rel: "noopener noreferrer", target: "_blank" }, "cookies policy"), "and our\u00A0", h("calcite-link", { class: "link-text", href: "https://www.europarl.europa.eu/privacy-policy/en/cookies-inventory", rel: "noopener noreferrer", target: "_blank" }, "cookies inventory."))))))) : undefined;
    }
    async _init() {
        var _a;
...
export { CookieTest as cookie_test };
