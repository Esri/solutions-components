 ...
 */
import { r as registerInstance, c as createEvent, h, H as Host, F as Fragment, g as getElement } from './index-164d485a.js';
import { g as getMessages, a as generateUIData, s as store, E as EIcons, b as getLocales, l as languageTranslatorState, c as getUIDataKeys } from './utils-28d0a086.js';
import { l as loadModules } from './loadModules-877bbb89.js';
import { c as getComponentClosestLanguage } from './locale-bd9034e1.js';
import { g as getPortalItemResource, f as fetchResourceData } from './languageSwitcher-4faa659f.js';
...
const InstantAppsLanguageTranslator = class {
    ...
    render() {
        return (h(Host, null, this.renderModal(), this.renderPopoverTip()));
    }
    renderModal() {
        return (h("calcite-modal", { open: this.open, scale: "l", fullscreen: true, onCalciteModalClose: this.close.bind(this) }, this.renderHeader(), this.renderContent(), this.renderPrimaryButton()));
    }
    renderPopoverTip() {
        var _a;
    ...
    renderHeader() {
        ...
        return (h("header", { class: CSS.header, slot: "header" }, this.renderHeaderText(), saving ? this.renderSavingIndicator() : null));
    }
    renderHeaderText() {
        const { messages } = this;
    ...
    renderSavingIndicator() {
        ...
        return (h("div", { class: CSS.savingIndicator }, saving ? h("calcite-loader", { label: t9n, inline: true }) : null, h("span", null, t9n)));
    }
    renderContent() {
    ...
    renderUserLocale() {
        ...
        const localeFlag = getComponentClosestLanguage(this.el);
    ...
    renderTranslatedLangOptions() {
        ...
        return localeFlags === null || localeFlags === void 0 ? void 0 : localeFlags.map(locale => {
            ...
            const translatedLanguageName = translatedLanguageNames === null || translatedLanguageNames === void 0 ? void 0 : translatedLanguageNames[locale];
            const enLanguageName = enLanguageNames === null || enLanguageNames === void 0 ? void 0 : enLanguageNames[locale];
    ...
    renderUIDataItem(key, keyIndex, uiDataKeysLen) {
        ...
        return (h("instant-apps-language-translator-item", { key: `${key}-${keyIndex}`, class: isLast, fieldName: key, translatedLanguageLabels: translatedLanguageLabels, setting: setting, userLocaleInputOnChangeCallback: this.userLocaleInputOnChangeCallback, translatedLocaleInputOnChangeCallback: this.translatedLocaleInputOnChangeCallback }));
    }
    renderPrimaryButton() {
        var _a;
        return (h("calcite-button", { onClick: () => (this.open = false), slot: "primary", class: CSS.closeButton }, (_a = this.messages) === null || _a === void 0 ? void 0 : _a.close));
    }
...
InstantAppsLanguageTranslator.style = instantAppsLanguageTranslatorCss;
