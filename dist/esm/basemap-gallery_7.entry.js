...
const MapTools = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e0995a03a8fb9cb887f8815f97c74aa9ba559df5' }, h("div", { key: 'e915bd8b78b67a59607c2deb6061d13225fa840a', class: containerClass }, this.enableSingleExpand ? (h("div", { class: "box-shadow" }, this._getActionGroup(toggleIcon, false, expandTip, () => this._toggleTools()))) : undefined, h("div", { key: '000ebbb0b2de46b441998158fc6d69e0a2320f79', class: `${toolMarginClass} ${shadowClass} ${toolsClass}` }, this._getMapWidgets(toolOrder))), h("basemap-gallery", { key: '3c503c3d7947fc803f3991ccf51f87e433597259', basemapConfig: this.basemapConfig, class: basemapClass, mapView: this.mapView, ref: (el) => { this._basemapElement = el; } }), h("map-search", { key: '96ba814dc1f86584e87836c5e494daade397e2d1', class: searchClass, mapView: this.mapView, ref: (el) => { this._searchElement = el; }, resultGraphicEnabled: true, searchConfiguration: this.searchConfiguration }), h("map-legend", { key: '0d05fb6d15c26f8b7158c6d2ee64170609b5a9d4', class: legendClass, mapView: this.mapView, ref: (el) => { this._legendElement = el; } }), h("map-fullscreen", { key: '92e9c07ed0961572e4305c62706fbac34e231b89', class: fullscreenClass, mapView: this.mapView, onFullscreenStateChange: (evt) => this._fullscreenStateChange(evt.detail), ref: (el) => { this._fullscreenElement = el; } }), h("floor-filter", { key: 'ac614a82eeeecdfb9dc04f6621553000681b3e68', class: floorFilterClass, enabled: this.enableFloorFilter, mapView: this.mapView, ref: (el) => { this._floorFilterElement = el; } })));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
