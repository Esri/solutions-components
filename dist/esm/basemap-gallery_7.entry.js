 ...
 */
import { r as registerInstance, g as getElement, h, H as Host, c as createEvent } from './index-b793d9aa.js';
...
const MapTools = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'd4774c7ae6c327804d092b4b81f7e3523820726d' }, h("div", { key: '35363080c21040b94276b4362632dc2d46c8eb58', class: containerClass }, this.enableSingleExpand ? (h("div", { class: "box-shadow" }, this._getActionGroup(toggleIcon, false, expandTip, () => this._toggleTools()))) : undefined, h("div", { key: 'd7e547203dfd373e031f424499af9b15193ee76c', class: `${toolMarginClass} ${shadowClass} ${toolsClass}` }, this._getMapWidgets(toolOrder))), h("basemap-gallery", { key: '7518c0e1378bf2343f681677d849535a2ae363ab', basemapConfig: this.basemapConfig, class: basemapClass, mapView: this.mapView, ref: (el) => { this._basemapElement = el; } }), h("map-search", { key: '0c0d5497546a8ab8afd4169134c7689f964bcf65', class: searchClass, mapView: this.mapView, ref: (el) => { this._searchElement = el; }, resultGraphicEnabled: true, searchConfiguration: this.searchConfiguration }), h("map-legend", { key: 'cf29e237446037731a2b4214634cb7aa3102f6d1', class: legendClass, mapView: this.mapView, ref: (el) => { this._legendElement = el; } }), h("map-fullscreen", { key: '3dbc331ed548e13e86cfbc916439b7cf09bb5f10', class: fullscreenClass, mapView: this.mapView, onFullscreenStateChange: (evt) => this._fullscreenStateChange(evt.detail), ref: (el) => { this._fullscreenElement = el; } }), h("floor-filter", { key: '2738d4f1dda01ffb4f71708fdac76be82f36e037', class: floorFilterClass, enabled: this.enableFloorFilter, mapView: this.mapView, ref: (el) => { this._floorFilterElement = el; } })));
    }
    //--------------------------------------------------------------------------
    //
    //  Functions (protected)
