...
import { n as numberStringFormatter, g as getSupportedLocale, c as connectLocalized, d as disconnectLocalized } from './locale-904407bf.js';
import { d as deactivateFocusTrap, a as activateFocusTrap, c as connectFocusTrap } from './focusTrapComponent-47ddce58.js';
import { l as localizeTimeString, t as toISOTimeString, i as isValidTime, f as formatTimeString, a as formatTimePart } from './time-29001694.js';
...
import { d as decimalPlaces } from './math-efada7a9.js';
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
    ["ar", () => import('./ar-7633f382.js')],
    ["bg", () => import('./bg-5ccf3b3b.js')],
    ["bs", () => import('./bs-59e59ad4.js')],
    ["ca", () => import('./ca-d8d2bc89.js')],
    ["cs", () => import('./cs-3d744598.js')],
    ["da", () => import('./da-ad0f6f82.js')],
    ["de", () => import('./de-d6966c3f.js')],
    ["de-at", () => import('./de-at-8de8843c.js')],
    ["de-ch", () => import('./de-ch-03a1c027.js')],
    ["el", () => import('./el-7130c722.js')],
    ["en", () => Promise.resolve().then(function () { return en$1; })],
    ["en-au", () => import('./en-au-005d4093.js')],
    ["en-ca", () => import('./en-ca-1b54d10b.js')],
    ["en-gb", () => import('./en-gb-ac1ad784.js')],
    ["es", () => import('./es-d6f91b06.js')],
    ["es-mx", () => import('./es-mx-26a8411a.js')],
    ["et", () => import('./et-1f7ea62f.js')],
    ["fi", () => import('./fi-df7f8ad0.js')],
    ["fr", () => import('./fr-14ad3cd0.js')],
    ["fr-ch", () => import('./fr-ch-328d9a38.js')],
    ["he", () => import('./he-a30ddc93.js')],
    ["hi", () => import('./hi-5d914f70.js')],
    ["hr", () => import('./hr-232bce19.js')],
    ["hu", () => import('./hu-cb9fa8dc.js')],
    ["id", () => import('./id-28662048.js')],
    ["it", () => import('./it-7fd85aa4.js')],
    ["it-ch", () => import('./it-ch-ab98adcc.js')],
    ["ja", () => import('./ja-eaf04e42.js')],
    ["ko", () => import('./ko-d029100b.js')],
    ["lt", () => import('./lt-4c10b6c4.js')],
    ["lv", () => import('./lv-d2afd652.js')],
    ["mk", () => import('./mk-ee9a3d11.js')],
    ["nl", () => import('./nl-8e5bf9af.js')],
    ["nb", () => import('./nb-b9ec8eb4.js')],
    ["pl", () => import('./pl-1379aa6d.js')],
    ["pt", () => import('./pt-8494ce08.js')],
    ["pt-br", () => import('./pt-br-54686d6b.js')],
    ["ro", () => import('./ro-63586962.js')],
    ["ru", () => import('./ru-ec1f486a.js')],
    ["sk", () => import('./sk-d7d87eb9.js')],
    ["sl", () => import('./sl-2a7d999b.js')],
    ["sr", () => import('./sr-a3be308c.js')],
    ["sv", () => import('./sv-890688fe.js')],
    ["th", () => import('./th-ae3d67ae.js')],
    ["tr", () => import('./tr-260f6f88.js')],
    ["uk", () => import('./uk-d84b6056.js')],
    ["vi", () => import('./vi-f3eb25b9.js')],
    ["zh-cn", () => import('./zh-cn-d6fc0582.js')],
    ["zh-hk", () => import('./zh-hk-285977d0.js')],
    ["zh-tw", () => import('./zh-tw-d83c5c9d.js')],
]);
...
const InputTimePicker = class {
    ...
    render() {
        ...
        return (h(Host, { onBlur: this.hostBlurHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { disabled: this.disabled }, h("div", { class: "input-wrapper", onClick: this.onInputWrapperClick }, h("calcite-input-text", { "aria-autocomplete": "none", "aria-haspopup": "dialog", disabled: disabled, icon: "clock", id: this.referenceElementId, label: getLabelText(this), lang: this.effectiveLocale, onCalciteInputTextInput: this.calciteInternalInputInputHandler, onCalciteInternalInputTextFocus: this.calciteInternalInputFocusHandler, readOnly: readOnly, role: "combobox", scale: this.scale, status: this.status,
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setCalciteTimePickerEl })), h(HiddenFormInputSlot, { component: this }), this.validationMessage ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
