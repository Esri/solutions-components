 ...
 */
import { h, r as registerInstance, c as createEvent, H as Host, d as readTask, g as getElement } from './index-164d485a.js';
import { s as slotChangeGetAssignedElements, d as focusElementInGroup } from './dom-38c6f027.js';
...
const Stepper = class {
    constructor(hostRef) {
        ...
        this.handleDefaultSlotChange = (event) => {
            const items = slotChangeGetAssignedElements(event).filter((el) => (el === null || el === void 0 ? void 0 : el.tagName) === "CALCITE-STEPPER-ITEM");
            this.items = items;
