...
import { i as isValidNumber, c as connectLocalized, d as disconnectLocalized } from './locale-904407bf.js';
import { u as updateMessages, c as connectMessages, s as setUpMessages, d as disconnectMessages } from './t9n-436fb2b1.js';
import { a as formatTimePart, p as parseTimeString, i as isValidTime, b as localizeTimeStringToParts, g as getMeridiem, c as getTimeParts, d as getLocalizedTimePartSuffix, e as getLocalizedDecimalSeparator, h as localizeTimePart, j as getLocaleHourCycle, m as maxTenthForMinuteAndSecond } from './time-29001694.js';
...
import { d as decimalPlaces, g as getDecimals } from './math-efada7a9.js';
    ...
    constructor(hostRef) {
        ...
        this.setValuePart = (key, value) => {
            ...
            if (this.hour && this.minute) {
                ...
                if (this.showSecond) {
                    newValue = `${newValue}:${(_a = this.second) !== null && _a !== void 0 ? _a : "00"}`;
            ...
            this.localizedMeridiem = this.value
                ? ((_b = localizeTimeStringToParts({ value: this.value, locale, numberingSystem })) === null || _b === void 0 ? void 0 : _b.localizedMeridiem) || null
