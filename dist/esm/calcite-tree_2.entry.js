...
import { e as focusElement, n as nodeListToArray, g as getSlotted, u as slotChangeHasAssignedElement, a as getElementDir, t as toAriaBoolean, y as filterDirectChildren } from './dom-38c6f027.js';
    ...
    constructor(hostRef) {
        ...
        this.keyDownHandler = (event) => {
            ...
            if (event.key === "ArrowUp") {
                ...
                previousItem === null || previousItem === void 0 ? void 0 : previousItem.focus();
                event.preventDefault();
                return;
            }
            if (event.key === "ArrowLeft") {
                ...
                parentItem === null || parentItem === void 0 ? void 0 : parentItem.focus();
                event.preventDefault();
                return;
            }
