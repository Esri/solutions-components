...
import { d as ESettingType, i as isCalciteModeDark, e as ECalciteMode, s as store, f as EInputType, E as EIcons, l as languageTranslatorState, h as getT9nData, c as getUIDataKeys } from './utils-b46c535b.js';
import './locale-c7d9e9aa.js';
...
const InstantAppsLanguageTranslatorSearch = class {
    ...
    render() {
        return (h(Host, null, this.renderSearchInput(), this.renderSuggestions()));
    }
    renderSearchInput() {
...
InstantAppsLanguageTranslatorSearch.style = instantAppsLanguageTranslatorSearchCss;
