...
import { d as focusElementInGroup } from './dom-38c6f027.js';
...
const TableRow = class {
    ...
    render() {
        return (h(Host, null, h(InteractiveContainer, { disabled: this.disabled }, h("tr", { "aria-disabled": this.disabled, "aria-rowindex": this.positionAll + 1, "aria-selected": this.selected, class: { [CSS.lastVisibleRow]: this.lastVisibleRow }, onKeyDown: (event) => this.keyDownHandler(event),
