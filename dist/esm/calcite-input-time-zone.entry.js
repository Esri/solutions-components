...
import { u as updateHostInteraction, I as InteractiveContainer } from './interactive-742ba555.js';
import { a as getDateTimeFormat, c as connectLocalized, d as disconnectLocalized } from './locale-21e40b0c.js';
...
import { c as connectForm, d as disconnectForm, a as afterConnectDefaultValueSet, H as HiddenFormInputSlot } from './form-ba965042.js';
...
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
    if (mode === "name") {
        const { groupByName } = await import('./index-f8c935d6.js');
    ...
    if (mode === "region") {
        const [{ groupByRegion }, { getCountry }] = await Promise.all([
            import('./index-f5d562b1.js'),
            import('./country-2d5661ee.js'),
        ]);
    ...
    const [{ groupByOffset }, { DateEngine }] = await Promise.all([
        import('./index-ad182a71.js'),
        import('./index-87ec7c0a.js'),
    ]);
