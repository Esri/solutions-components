 ...
 */
import { g as getRoundRobinIndex } from './array-dd6e2c7d.js';
import { e as focusElement, g as getSlotted, t as toAriaBoolean } from './dom-b5c50286.js';
import { S as SLOTS } from './resources-2d6e35cf.js';
import { d as debounce } from './debounce-6e9ade8c.js';
import { h, H as Host } from './index-b793d9aa.js';
import { I as InteractiveContainer } from './interactive-742ba555.js';
import { C as CSS, S as SLOTS$1 } from './resources-30b747d4.js';
...
const List = ({ props: { disabled, loading, filterEnabled, dataForFilter, handleFilterEvent, filterPlaceholder, filterText, setFilterEl, dragEnabled, storeAssistiveEl, }, ...rest }) => {
    ...
    return (h(Host, { "aria-busy": toAriaBoolean(loading), role: "menu", ...rest }, h(InteractiveContainer, { disabled: disabled }, h("section", null, dragEnabled ? (h("span", { "aria-live": "assertive", class: "assistive-text", ref: storeAssistiveEl })) : null, h("header", { class: { [CSS.sticky]: true } }, filterEnabled ? (h("calcite-filter", { "aria-label": filterPlaceholder, disabled: disabled, items: dataForFilter, onCalciteFilterChange: handleFilterEvent, placeholder: filterPlaceholder, ref: setFilterEl, value: filterText })) : null, h("slot", { name: SLOTS$1.menuActions })), loading ? h("calcite-scrim", { loading: loading }) : null, defaultSlot))));
};
