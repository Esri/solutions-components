...
const InstantAppsInteractiveLegendGroupLegendElement = class {
    ...
    render() {
        return (h("div", { style: {
            ...
            }, class: `${CSS$4.service} ${CSS$4.groupLayer}` }, h("instant-apps-interactive-legend-layer-element-caption", { ref: node => (this.layerCaption = node), class: getTheme(this.el), legendvm: this.legendvm, "feature-count": this.featureCount, activeLayerInfo: this.activeLayerInfo, messages: this.messages, isChild: this.isChild }), h("div", { class: `${CSS$4.groupContent} ${this.expanded === false ? 'hide' : 'show'}` }, h("slot", { name: "content" }))));
    }
...
const InstantAppsInteractiveLegendLegendElement = class {
    ...
    render() {
        ...
        return (h("div", { class: `${tableClass}${tableClasses}${nonInteractiveClass}${nestedUniqueSymbolClass}` }, h("div", { id: `${(_g = (_f = this.activeLayerInfo) === null || _f === void 0 ? void 0 : _f.layer) === null || _g === void 0 ? void 0 : _g.id}-legend-element-caption`, class: `${this.isRelationshipRamp || (!this.titleText && !this.zoomTo && singleSymbol) ? 'hide' : 'show'}` }, h("instant-apps-interactive-legend-legend-element-caption", { ref: node => (this.legendLayerCaption = node), legendvm: this.legendvm, activeLayerInfo: this.activeLayerInfo, layer: this.activeLayerInfo.layer, titleText: this.titleText, legendElement: this.legendElement, legendElementIndex: this.legendElementIndex, zoomTo: this.zoomTo, isInteractive: this.isInteractive, messages: this.messages })), h("div", { key: "content", id: `${(_j = (_h = this.activeLayerInfo) === null || _h === void 0 ? void 0 : _h.layer) === null || _j === void 0 ? void 0 : _j.id}-legend-element-content-${this.legendElementIndex}`, class: `${expanded === false ? 'hide' : 'show'}` }, h("slot", { name: "content" }))));
    }
};
    ...
    render() {
        ...
        return (h("div", { ref: (node) => {
          ...
          `;
            ...
            } }, h("span", { class: CSS.instructionalText }, (_b = (_a = this.messages) === null || _a === void 0 ? void 0 : _a.relationship) === null || _b === void 0 ? void 0 : _b.instructionalText), this.renderRelationshipRamp()));
    }
