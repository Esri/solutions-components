 ...
 */
import { r as registerInstance, h, g as getElement, F as Fragment } from './index-904bc599.js';
...
const ShellCenterRow = class {
    ...
    render() {
        const { el } = this;
        const contentNode = (h("div", { key: '31239015e9582ebbe43f3fe7a6b8fb6b2750b0d7', class: CSS.content }, h("slot", { key: 'eee4b393dfa79405d9a48e6c2db016017a6e9a1f' })));
        ...
        return h(Fragment, { key: 'ab4be18f37ab916e222faa0339bede7d01f6f08a' }, children);
    }
