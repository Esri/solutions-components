...
import { u as slotChangeHasAssignedElement, t as toAriaBoolean, g as getSlotted } from './dom-38c6f027.js';
...
import { g as getAncestors, i as isSingleLike, a as getDepth } from './utils-ef0ff036.js';
...
const Chip = class {
    ...
    //--------------------------------------------------------------------------
    renderChipImage() {
        return (h("div", { class: CSS$1.imageContainer }, h("slot", { name: SLOTS.image, onSlotchange: this.handleSlotImageChange })));
    }
    renderSelectionIcon() {
    ...
    renderCloseButton() {
        return (h("button", { "aria-label": this.messages.dismissLabel, class: CSS$1.close, onClick: this.close, onKeyDown: this.closeButtonKeyDownHandler, tabIndex: this.disabled ? -1 : 0,
    ...
    render() {
        ...
        return (h(Host, null, h(InteractiveContainer, { disabled: disabled }, h("div", { "aria-checked": this.selectionMode !== "none" && this.interactive
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.containerEl = el) }, this.selectionMode !== "none" && this.renderSelectionIcon(), this.renderChipImage(), this.icon && this.renderIcon(), h("span", { class: CSS$1.title }, h("slot", null)), this.closable && this.renderCloseButton()))));
    }
