 ...
 */
import { r as registerInstance, h, f as forceUpdate, g as getElement, c as createEvent, H as Host, F as Fragment } from './index-d298aca9.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-d3eebe7f.js';
import { b as getElementDir, i as isPrimaryPointerButton, a as getSlotted, n as nodeListToArray, j as focusElementInGroup, l as filterDirectChildren, g as getElementProp, t as toAriaBoolean } from './dom-0fc13266.js';
...
const ShellPanel = class {
  ...
  renderHeader() {
    ...
    return hasHeader ? (h("div", { class: CSS$2.contentHeader, key: "header" }, h("slot", { name: SLOTS$2.header }))) : null;
  }
  render() {
    const { collapsed, detached, position, initialContentWidth, contentWidth, contentWidthMax, contentWidthMin, resizable } = this;
    const allowResizing = !detached && resizable;
    const contentNode = (h("div", { class: { [CSS$2.content]: true, [CSS$2.contentDetached]: detached }, hidden: collapsed, key: "content", style: allowResizing && contentWidth ? { width: `${contentWidth}px` } : null,
      // eslint-disable-next-line react/jsx-sort-props
      ref: this.storeContentEl }, this.renderHeader(), h("div", { class: CSS$2.contentBody }, h("slot", null))));
    ...
    return h("div", { class: { [CSS$2.container]: true } }, mainNodes);
  }
  // --------------------------------------------------------------------------
  //
  //  private Methods
...
const TabTitle = class {
  ...
  render() {
    const id = this.el.id || this.guid;
    const iconStartEl = (h("calcite-icon", { class: { [CSS$1.titleIcon]: true, [CSS$1.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: this.scale === "l" ? "m" : "s" }));
    const iconEndEl = (h("calcite-icon", { class: { [CSS$1.titleIcon]: true, [CSS$1.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: this.scale === "l" ? "m" : "s" }));
...
const ValueListItem = class {
  ...
  renderHandle() {
    ...
    if (icon === ICON_TYPES$1.grip) {
      return (h("span", { class: {
          [CSS$3.handle]: true,
          [CSS$3.handleActivated]: this.handleActivated
