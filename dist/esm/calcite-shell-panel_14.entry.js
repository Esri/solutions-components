 ...
 */
import { r as registerInstance, c as createEvent, h, f as forceUpdate, g as getElement, H as Host, d as readTask, F as Fragment } from './index-b793d9aa.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-60e775f3.js';
import { a as getElementDir, i as isPrimaryPointerButton, h as slotChangeGetAssignedElements, s as slotChangeHasAssignedElement, y as nodeListToArray, d as focusElementInGroup, B as filterDirectChildren, t as toAriaBoolean, C as getSlotAssignedElements, e as focusElement, g as getSlotted } from './dom-b5c50286.js';
import { c as connectLocalized, d as disconnectLocalized } from './locale-21e40b0c.js';
import { c as clamp } from './math-8c04292e.js';
...
import { c as connectInteractive, d as disconnectInteractive, I as InteractiveContainer, u as updateHostInteraction } from './interactive-742ba555.js';
...
import { q as getItemIndex, m as mutationObserverCallback, d as deselectRemovedItems, a as deselectSiblingItems, s as selectSiblings, h as handleFilter, b as handleFilterEvent, g as getItemData, k as keyDownHandler, t as moveItemIndex, i as initialize, c as initializeObserver, f as handleInitialFilter, e as cleanUpObserver, n as calciteListFocusOutHandler, r as removeItem, j as calciteListItemChangeHandler, l as calciteInternalListItemValueChangeHandler, o as setUpItems, p as setFocus, L as List } from './shared-list-render-4053f1dc.js';
import { d as disconnectSortableComponent, c as connectSortableComponent } from './sortableComponent-3f9e9322.js';
import { l as logger } from './logger-0d6e5bfe.js';
import { C as CSS$5, S as SLOTS$3 } from './resources-896b6b00.js';
import { I as ICON_TYPES$1 } from './resources-30b747d4.js';
...
import { E as EFileType } from './solution-resource-966f8511.js';
...
const SolutionResourceItem = class {
    ...
    render() {
        ...
        return (h(Host, { key: '45bc346197968e07be42cc16c1c792e0e4872547' }, h("div", { key: 'f57fe6d4cf7d54975d48a11927477e295eb06089', class: "resource-item" }, h("div", { key: '4d1903665522dee371f51002370775f3b004e2fd', class: "margin-bottom-1" }, h("calcite-button", { key: 'fae693d09c76a1b0fb379c6178b561d30e962fec', appearance: "solid", class: "resource-button", color: "blue", onClick: () => this._addNewResource() }, this._translations.addResource), h("calcite-button", { key: '3e07b0ee9ccc50aef57442a982816dd6bc376ecd', appearance: "solid", color: "blue", disabled: !hasValidResources, onClick: () => this._downloadAll() }, this._translations.downloadAll)), h("div", { key: '2e87fe655e7314299419ca97d7f1dae833e36426', class: "resources-container", style: { display: hasValidResources ? "inherit" : "none" } }, this._renderResourceList()))));
    }
    _removedResources = {};
    //--------------------------------------------------------------------------
    //
