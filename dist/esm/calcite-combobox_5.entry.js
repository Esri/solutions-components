...
import { i as isSingleLike, h as hasActiveChildren, C as CSS$2, b as ComboboxChildSelector, c as getItemAncestors, d as getItemChildren, e as ComboboxItem, f as ComboboxItemGroup } from './utils-ef0ff036.js';
...
function XButton({ disabled, key, label, onClick, ref, scale, }) {
    return (h("button", { "aria-label": label, class: CSS$1.button, disabled: disabled, key: key, onClick: onClick, tabIndex: -1, type: "button",
